...
func TestProductfeedupload_post_error_report_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/error_report",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductfeedupload_post_error_report(accessToken, tt.args, skipParams...)
...
func TestProductfeedupload_post_error_report_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsProductfeedupload_post_error_report(tt.args, skipParams...)
...
func buildBodyParamsProductfeedupload_post_error_report(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsProductfeedupload_post_error_report(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
