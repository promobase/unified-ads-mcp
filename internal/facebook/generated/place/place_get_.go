...
// ToolPlace_get_ returns the MCP tool definition for place_get_
func ToolPlace_get_() mcp.Tool {
	// Available fields for Place: id, location, name, overall_rating

	return mcp.NewTool("place_get_",
...
func HandlePlace_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Place_get_(accessToken, args)
	if err != nil {
...
// Place_get_ performs GET  for Place
func Place_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
