...
// ToolAreffect_get_ returns the MCP tool definition for areffect_get_
func ToolAreffect_get_() mcp.Tool {
	// Available fields for AREffect: creation_time, id, last_modified_time, name, status, surfaces

	return mcp.NewTool("areffect_get_",
...
func HandleAreffect_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Areffect_get_(accessToken, args)
	if err != nil {
...
// Areffect_get_ performs GET  for AREffect
