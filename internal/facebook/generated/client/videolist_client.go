...
// VideoListClient represents a client for VideoList operations
type VideoListClient struct {
	accessToken string
}

// NewVideoListClient creates a new VideoList client
func NewVideoListClient(accessToken string) *VideoListClient {
