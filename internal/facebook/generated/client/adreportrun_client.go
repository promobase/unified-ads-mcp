...
// AdReportRunClient represents a client for AdReportRun operations
type AdReportRunClient struct {
	accessToken string
}

// NewAdReportRunClient creates a new AdReportRun client
func NewAdReportRunClient(accessToken string) *AdReportRunClient {
	return &AdReportRunClient{
