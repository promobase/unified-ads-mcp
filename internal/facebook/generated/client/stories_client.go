...
// StoriesClient represents a client for Stories operations
type StoriesClient struct {
	accessToken string
}

// NewStoriesClient creates a new Stories client
func NewStoriesClient(accessToken string) *StoriesClient {
