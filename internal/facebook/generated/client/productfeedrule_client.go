...
// ProductFeedRuleClient represents a client for ProductFeedRule operations
type ProductFeedRuleClient struct {
	accessToken string
}

// NewProductFeedRuleClient creates a new ProductFeedRule client
func NewProductFeedRuleClient(accessToken string) *ProductFeedRuleClient {
	return &ProductFeedRuleClient{
