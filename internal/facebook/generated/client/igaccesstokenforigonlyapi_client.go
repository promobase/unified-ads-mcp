...
// facebook_igaccesstokenforigonlyapi_get_ GET  for IGAccessTokenForIGOnlyAPI
func (c *IGAccessTokenForIGOnlyAPIClient) Facebook_igaccesstokenforigonlyapi_get_(args map[string]interface{}) (interface{}, error) {
	// Extract parameters
