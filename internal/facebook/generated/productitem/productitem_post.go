...
// ToolProductitem_post returns the MCP tool definition for productitem_post
func ToolProductitem_post() mcp.Tool {
	...
	return mcp.NewTool("productitem_post",
...
// HandleProductitem_post handles the productitem_post tool with context-based auth
func HandleProductitem_post(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productitem_post(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute productitem_post: %v", err)), nil
	}
...
// Productitem_post performs POST  for ProductItem
func Productitem_post(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
