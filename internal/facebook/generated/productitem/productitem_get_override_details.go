...
// ToolProductitem_get_override_details returns the MCP tool definition for productitem_get_override_details
func ToolProductitem_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("productitem_get_override_details",
...
func HandleProductitem_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productitem_get_override_details(accessToken, args)
	if err != nil {
...
// Productitem_get_override_details performs GET override_details for ProductItem
func Productitem_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
