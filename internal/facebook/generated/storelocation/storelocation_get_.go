...
// ToolStorelocation_get_ returns the MCP tool definition for storelocation_get_
func ToolStorelocation_get_() mcp.Tool {
	// Available fields for StoreLocation: full_address, hours, id, phone_number, pickup_options, price_range, store_code, zip_code
	
	return mcp.NewTool("storelocation_get_",
...
func HandleStorelocation_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Storelocation_get_(accessToken, args)
	if err != nil {
...
func Storelocation_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
