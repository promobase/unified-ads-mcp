...
// ToolProductgroup_get_ returns the MCP tool definition for productgroup_get_
func ToolProductgroup_get_() mcp.Tool {
	// Available fields for ProductGroup: id, product_catalog, retailer_id, variants

	return mcp.NewTool("productgroup_get_",
...
func HandleProductgroup_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productgroup_get_(accessToken, args)
	if err != nil {
...
// Productgroup_get_ performs GET  for ProductGroup
func Productgroup_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
