...
func TestProductgroup_post_products_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductgroup_post_products(accessToken, tt.args, skipParams...)
...
func TestProductgroup_post_products_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsProductgroup_post_products(tt.args, skipParams...)
...
func buildBodyParamsProductgroup_post_products(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsProductgroup_post_products(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
