...
// ToolMailingaddress_get_ returns the MCP tool definition for mailingaddress_get_
func ToolMailingaddress_get_() mcp.Tool {
	// Available fields for MailingAddress: city, city_page, country, id, postal_code, region, street1, street2

	return mcp.NewTool("mailingaddress_get_",
...
func HandleMailingaddress_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Mailingaddress_get_(accessToken, args)
	if err != nil {
...
// Mailingaddress_get_ performs GET  for MailingAddress
func Mailingaddress_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
