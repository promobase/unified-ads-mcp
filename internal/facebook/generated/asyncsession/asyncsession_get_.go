...
// ToolAsyncsession_get_ returns the MCP tool definition for asyncsession_get_
func ToolAsyncsession_get_() mcp.Tool {
	...
	return mcp.NewTool("asyncsession_get_",
...
func HandleAsyncsession_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Asyncsession_get_(accessToken, args)
	if err != nil {
...
func Asyncsession_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
