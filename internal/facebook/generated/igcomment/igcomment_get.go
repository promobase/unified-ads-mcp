...
// ToolIgcomment_get returns the MCP tool definition for igcomment_get
func ToolIgcomment_get() mcp.Tool {
	...
	return mcp.NewTool("igcomment_get",
...
// HandleIgcomment_get handles the igcomment_get tool with context-based auth
func HandleIgcomment_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igcomment_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute igcomment_get: %v", err)), nil
	}
...
// Igcomment_get performs GET  for IGComment
func Igcomment_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
