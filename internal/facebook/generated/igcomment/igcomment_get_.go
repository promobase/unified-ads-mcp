...
// ToolIgcomment_get_ returns the MCP tool definition for igcomment_get_
func ToolIgcomment_get_() mcp.Tool {
	...
	return mcp.NewTool("igcomment_get_",
...
func HandleIgcomment_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igcomment_get_(accessToken, args)
	if err != nil {
...
func Igcomment_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
