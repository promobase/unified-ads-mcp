...
func TestAdsconversiongoal_get_conversion_events_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/conversion_events",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdsconversiongoal_get_conversion_events(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdsconversiongoal_get_conversion_events(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
