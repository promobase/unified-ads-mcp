...
func TestWhatsappbusinesspreverifiedphonenumber_post_verify_code_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/verify_code",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinesspreverifiedphonenumber_post_verify_code(accessToken, tt.args, skipParams...)
...
func TestWhatsappbusinesspreverifiedphonenumber_post_verify_code_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsWhatsappbusinesspreverifiedphonenumber_post_verify_code(tt.args, skipParams...)
...
func buildBodyParamsWhatsappbusinesspreverifiedphonenumber_post_verify_code(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsWhatsappbusinesspreverifiedphonenumber_post_verify_code(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
