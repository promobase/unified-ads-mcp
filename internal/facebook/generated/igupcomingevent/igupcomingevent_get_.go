...
// ToolIgupcomingevent_get_ returns the MCP tool definition for igupcomingevent_get_
func ToolIgupcomingevent_get_() mcp.Tool {
	// Available fields for IGUpcomingEvent: end_time, id, notification_subtypes, notification_target_time, start_time, title
	
	return mcp.NewTool("igupcomingevent_get_",
...
func HandleIgupcomingevent_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igupcomingevent_get_(accessToken, args)
	if err != nil {
...
func Igupcomingevent_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
