...
// ToolBusinessownedobjectonbehalfofrequest_get_ returns the MCP tool definition for businessownedobjectonbehalfofrequest_get_
func ToolBusinessownedobjectonbehalfofrequest_get_() mcp.Tool {
	...
	return mcp.NewTool("businessownedobjectonbehalfofrequest_get_",
...
func HandleBusinessownedobjectonbehalfofrequest_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessownedobjectonbehalfofrequest_get_(accessToken, args)
	if err != nil {
...
func Businessownedobjectonbehalfofrequest_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
