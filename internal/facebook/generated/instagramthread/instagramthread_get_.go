...
// ToolInstagramthread_get_ returns the MCP tool definition for instagramthread_get_
func ToolInstagramthread_get_() mcp.Tool {
	// Available fields for InstagramThread: folder, id, participants, updated_time

	return mcp.NewTool("instagramthread_get_",
...
func HandleInstagramthread_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Instagramthread_get_(accessToken, args)
	if err != nil {
...
// Instagramthread_get_ performs GET  for InstagramThread
func Instagramthread_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
