...
func TestAdaccount_get_tracking_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_get_tracking(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_get_tracking(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
