...
func TestToolAdaccount_get_adrules_history_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_adrules_history()
	if tool.Name != "adaccount_get_adrules_history" {
		t.Errorf("expected tool name adaccount_get_adrules_history, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_adrules_history_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_adrules_history",
			...
			// Call handler
			result, err := HandleAdaccount_get_adrules_history(ctx, request)
