...
// ToolAdaccount_get_applications returns the MCP tool definition for adaccount_get_applications
func ToolAdaccount_get_applications() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_applications",
...
func HandleAdaccount_get_applications(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_applications(accessToken, args)
	if err != nil {
...
func Adaccount_get_applications(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%sapplications", accountId)
