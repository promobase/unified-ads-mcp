...
func TestAdaccount_post_assigned_users_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_post_assigned_users(accessToken, tt.args, skipParams...)
