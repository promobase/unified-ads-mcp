...
func TestAdaccount_post_subscribed_apps_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/subscribed_apps",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/subscribed_apps", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_post_subscribed_apps(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_subscribed_apps_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_subscribed_apps(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_subscribed_apps(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_subscribed_apps(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
