...
// ToolAdaccount_get_businessprojects returns the MCP tool definition for adaccount_get_businessprojects
func ToolAdaccount_get_businessprojects() mcp.Tool {
	// Available fields for BusinessProject: business, created_time, creator, id, name
	// Params object accepts: business (string)
	return mcp.NewTool("adaccount_get_businessprojects",
...
func HandleAdaccount_get_businessprojects(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_businessprojects(accessToken, args)
	if err != nil {
...
func Adaccount_get_businessprojects(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%sbusinessprojects", accountId)
