...
// ToolAdaccount_get_promote_pages returns the MCP tool definition for adaccount_get_promote_pages
func ToolAdaccount_get_promote_pages() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_promote_pages",
...
func HandleAdaccount_get_promote_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_promote_pages(accessToken, args)
	if err != nil {
...
func Adaccount_get_promote_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("%s/act_%s/promote_pages", FacebookGraphAPIBaseURL, accountId)
