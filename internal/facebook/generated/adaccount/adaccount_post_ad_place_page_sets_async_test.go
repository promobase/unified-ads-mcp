...
func TestAdaccount_post_ad_place_page_sets_async_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/ad_place_page_sets_async",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/ad_place_page_sets_async", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_post_ad_place_page_sets_async(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_ad_place_page_sets_async_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_ad_place_page_sets_async(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_ad_place_page_sets_async(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_ad_place_page_sets_async(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
