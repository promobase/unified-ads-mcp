...
// ToolAdaccount_get_insights returns the MCP tool definition for adaccount_get_insights
func ToolAdaccount_get_insights() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_insights",
...
func HandleAdaccount_get_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_insights(accessToken, args)
	if err != nil {
...
func Adaccount_get_insights(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
