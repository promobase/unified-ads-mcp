...
func TestToolAdaccount_get_targetingsearch_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_targetingsearch()
	if tool.Name != "adaccount_get_targetingsearch" {
		t.Errorf("expected tool name adaccount_get_targetingsearch, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_targetingsearch_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_targetingsearch",
			...
			// Call handler
			result, err := HandleAdaccount_get_targetingsearch(ctx, request)
