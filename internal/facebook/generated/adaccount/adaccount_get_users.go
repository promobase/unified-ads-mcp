...
// ToolAdaccount_get_users returns the MCP tool definition for adaccount_get_users
func ToolAdaccount_get_users() mcp.Tool {
	// Available fields for AdAccountUser: id, name, tasks

	return mcp.NewTool("adaccount_get_users",
...
func HandleAdaccount_get_users(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_users(accessToken, args)
	if err != nil {
...
func Adaccount_get_users(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%susers", accountId)
