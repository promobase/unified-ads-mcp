...
// ToolAdaccount_get_adcreatives returns the MCP tool definition for adaccount_get_adcreatives
func ToolAdaccount_get_adcreatives() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_adcreatives",
...
func HandleAdaccount_get_adcreatives(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_adcreatives(accessToken, args)
	if err != nil {
...
func Adaccount_get_adcreatives(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
