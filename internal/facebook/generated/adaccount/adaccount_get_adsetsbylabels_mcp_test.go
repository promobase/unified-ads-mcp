...
func TestToolAdaccount_get_adsetsbylabels_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_adsetsbylabels()
	if tool.Name != "adaccount_get_adsetsbylabels" {
		t.Errorf("expected tool name adaccount_get_adsetsbylabels, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_adsetsbylabels_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_adsetsbylabels",
			...
			// Call handler
			result, err := HandleAdaccount_get_adsetsbylabels(ctx, request)
