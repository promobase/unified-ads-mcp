...
func TestToolAdaccount_get_customaudiences_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_customaudiences()
	if tool.Name != "adaccount_get_customaudiences" {
		t.Errorf("expected tool name adaccount_get_customaudiences, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_customaudiences_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_customaudiences",
			...
			// Call handler
			result, err := HandleAdaccount_get_customaudiences(ctx, request)
