...
func TestToolAdaccount_delete_advideos_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_delete_advideos()
	if tool.Name != "adaccount_delete_advideos" {
		t.Errorf("expected tool name adaccount_delete_advideos, got %s", tool.Name)
	}
}

func TestToolAdaccount_delete_advideos_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_delete_advideos",
			...
			// Call handler
			result, err := HandleAdaccount_delete_advideos(ctx, request)
