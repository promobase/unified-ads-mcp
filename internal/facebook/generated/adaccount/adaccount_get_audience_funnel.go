...
// ToolAdaccount_get_audience_funnel returns the MCP tool definition for adaccount_get_audience_funnel
func ToolAdaccount_get_audience_funnel() mcp.Tool {
	// Available fields for AudienceFunnel: audience_type_param_name, audience_type_param_tags, custom_audience_groups_info

	return mcp.NewTool("adaccount_get_audience_funnel",
...
func HandleAdaccount_get_audience_funnel(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_audience_funnel(accessToken, args)
	if err != nil {
...
func Adaccount_get_audience_funnel(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("%s/act_%s/audience_funnel", FacebookGraphAPIBaseURL, accountId)
