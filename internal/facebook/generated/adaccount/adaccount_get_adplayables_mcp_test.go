...
func TestToolAdaccount_get_adplayables_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_adplayables()
	if tool.Name != "adaccount_get_adplayables" {
		t.Errorf("expected tool name adaccount_get_adplayables, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_adplayables_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_adplayables",
			...
			// Call handler
			result, err := HandleAdaccount_get_adplayables(ctx, request)
