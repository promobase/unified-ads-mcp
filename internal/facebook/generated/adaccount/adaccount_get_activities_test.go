...
func TestAdaccount_get_activities_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/activities",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/activities", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_get_activities(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_get_activities(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
