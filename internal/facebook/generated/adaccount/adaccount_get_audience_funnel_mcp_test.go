...
func TestToolAdaccount_get_audience_funnel_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_audience_funnel()
	if tool.Name != "adaccount_get_audience_funnel" {
		t.Errorf("expected tool name adaccount_get_audience_funnel, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_audience_funnel_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_audience_funnel",
			...
			// Call handler
			result, err := HandleAdaccount_get_audience_funnel(ctx, request)
