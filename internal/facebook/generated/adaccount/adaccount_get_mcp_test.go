...
func TestToolAdaccount_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get()
	if tool.Name != "adaccount_get" {
		t.Errorf("expected tool name adaccount_get, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdaccount_get(ctx, request)
