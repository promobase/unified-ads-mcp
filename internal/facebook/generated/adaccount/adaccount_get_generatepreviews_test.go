...
func TestAdaccount_get_generatepreviews_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/generatepreviews",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/generatepreviews", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_get_generatepreviews(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_get_generatepreviews(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
