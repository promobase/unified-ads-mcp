...
// ToolAdaccount_get_subscribed_apps returns the MCP tool definition for adaccount_get_subscribed_apps
func ToolAdaccount_get_subscribed_apps() mcp.Tool {
	// Available fields for AdAccountSubscribedApps: app_id, app_name

	return mcp.NewTool("adaccount_get_subscribed_apps",
...
func HandleAdaccount_get_subscribed_apps(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_subscribed_apps(accessToken, args)
	if err != nil {
...
func Adaccount_get_subscribed_apps(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
