...
func TestToolAdaccount_post_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_post()
	if tool.Name != "adaccount_post" {
		t.Errorf("expected tool name adaccount_post, got %s", tool.Name)
	}
}

func TestToolAdaccount_post_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdaccount_post(ctx, request)
