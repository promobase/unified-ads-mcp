...
func TestToolAdaccount_get_max_bid_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_max_bid()
	if tool.Name != "adaccount_get_max_bid" {
		t.Errorf("expected tool name adaccount_get_max_bid, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_max_bid_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdaccount_get_max_bid(ctx, request)
