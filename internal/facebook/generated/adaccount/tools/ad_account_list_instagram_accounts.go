...
// ad_account_list_instagram_accountsArgs defines the typed arguments for ad_account_list_instagram_accounts
type ad_account_list_instagram_accountsArgs struct {
...
// RegisterAdAccountListInstagramAccountsHandler registers the ad_account_list_instagram_accounts tool
func RegisterAdAccountListInstagramAccountsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_instagram_accounts",
	...
	s.AddTool(tool, AdAccountListInstagramAccountsHandler)
	return nil
}

// AdAccountListInstagramAccountsHandler handles the ad_account_list_instagram_accounts tool
func AdAccountListInstagramAccountsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_instagram_accountsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/instagram_accounts", args.ID)
