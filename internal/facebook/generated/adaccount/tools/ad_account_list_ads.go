...
// ad_account_list_adsArgs defines the typed arguments for ad_account_list_ads
type ad_account_list_adsArgs struct {
...
// RegisterAdAccountListAdsHandler registers the ad_account_list_ads tool
func RegisterAdAccountListAdsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_ads",
		"List ads for this AdAccount Returns Ad.",
		json.RawMessage(`{"additionalProperties":false,"properties":{"after":{"description":"Cursor for pagination (next page)","type":"string"},"before":{"description":"Cursor for pagination (previous page)","type":"string"},"date_preset":{"description":"Date Preset (enum: adaccountads_date_preset_enum_param)","enum":["data_maximum","last_14d","last_28d","last_30d","last_3d","last_7d","last_90d","last_month","last_quarter","last_week_mon_sun","last_week_sun_sat","last_year","maximum","this_month","this_quarter","this_week_mon_today","this_week_sun_today","this_year","today","yesterday"],"type":"string"},"effective_status":{"description":"Effective Status","items":{"type":"string"},"type":"array"},"fields":{"description":"Fields to return","items":{"type":"string"},"type":"array"},"id":{"description":"AdAccount ID","pattern":"^[0-9]+$","type":"string"},"limit":{"description":"Maximum number of results","maximum":100,"minimum":1,"type":"integer"},"time_range":{"description":"Time Range","type":"string"},"updated_since":{"description":"When last updated","type":"integer"}},"required":["id"],"type":"object"}`),
	)

	s.AddTool(tool, AdAccountListAdsHandler)
	return nil
}

// AdAccountListAdsHandler handles the ad_account_list_ads tool
func AdAccountListAdsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_adsArgs
