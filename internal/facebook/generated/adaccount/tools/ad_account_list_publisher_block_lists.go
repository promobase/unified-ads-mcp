...
// ad_account_list_publisher_block_listsArgs defines the typed arguments for ad_account_list_publisher_block_lists
type ad_account_list_publisher_block_listsArgs struct {
...
// RegisterAdAccountListPublisherBlockListsHandler registers the ad_account_list_publisher_block_lists tool
func RegisterAdAccountListPublisherBlockListsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_publisher_block_lists",
	...
	s.AddTool(tool, AdAccountListPublisherBlockListsHandler)
	return nil
}

// AdAccountListPublisherBlockListsHandler handles the ad_account_list_publisher_block_lists tool
func AdAccountListPublisherBlockListsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_publisher_block_listsArgs
