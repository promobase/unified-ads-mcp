...
// ad_account_list_businessprojectsArgs defines the typed arguments for ad_account_list_businessprojects
type ad_account_list_businessprojectsArgs struct {
...
// RegisterAdAccountListBusinessprojectsHandler registers the ad_account_list_businessprojects tool
func RegisterAdAccountListBusinessprojectsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_businessprojects",
	...
	s.AddTool(tool, AdAccountListBusinessprojectsHandler)
	return nil
}

// AdAccountListBusinessprojectsHandler handles the ad_account_list_businessprojects tool
func AdAccountListBusinessprojectsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_businessprojectsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/businessprojects", args.ID)
