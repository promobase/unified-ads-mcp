...
// ad_account_list_agenciesArgs defines the typed arguments for ad_account_list_agencies
type ad_account_list_agenciesArgs struct {
...
// RegisterAdAccountListAgenciesHandler registers the ad_account_list_agencies tool
func RegisterAdAccountListAgenciesHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_agencies",
	...
	s.AddTool(tool, AdAccountListAgenciesHandler)
	return nil
}

// AdAccountListAgenciesHandler handles the ad_account_list_agencies tool
func AdAccountListAgenciesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_agenciesArgs
