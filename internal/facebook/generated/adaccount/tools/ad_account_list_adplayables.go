...
// ad_account_list_adplayablesArgs defines the typed arguments for ad_account_list_adplayables
type ad_account_list_adplayablesArgs struct {
...
// RegisterAdAccountListAdplayablesHandler registers the ad_account_list_adplayables tool
func RegisterAdAccountListAdplayablesHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_adplayables",
	...
	s.AddTool(tool, AdAccountListAdplayablesHandler)
	return nil
}

// AdAccountListAdplayablesHandler handles the ad_account_list_adplayables tool
func AdAccountListAdplayablesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_adplayablesArgs
