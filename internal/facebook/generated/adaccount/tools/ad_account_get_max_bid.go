...
// ad_account_get_max_bidArgs defines the typed arguments for ad_account_get_max_bid
type ad_account_get_max_bidArgs struct {
...
// RegisterAdAccountGetMaxBidHandler registers the ad_account_get_max_bid tool
func RegisterAdAccountGetMaxBidHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_get_max_bid",
	...
	s.AddTool(tool, AdAccountGetMaxBidHandler)
	return nil
}

// AdAccountGetMaxBidHandler handles the ad_account_get_max_bid tool
func AdAccountGetMaxBidHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_get_max_bidArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/max_bid", args.ID)
