...
// ad_account_list_adcreativesArgs defines the typed arguments for ad_account_list_adcreatives
type ad_account_list_adcreativesArgs struct {
...
// RegisterAdAccountListAdcreativesHandler registers the ad_account_list_adcreatives tool
func RegisterAdAccountListAdcreativesHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_adcreatives",
	...
	s.AddTool(tool, AdAccountListAdcreativesHandler)
	return nil
}

// AdAccountListAdcreativesHandler handles the ad_account_list_adcreatives tool
func AdAccountListAdcreativesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_adcreativesArgs
