...
// ad_account_list_conversion_goalsArgs defines the typed arguments for ad_account_list_conversion_goals
type ad_account_list_conversion_goalsArgs struct {
...
// RegisterAdAccountListConversionGoalsHandler registers the ad_account_list_conversion_goals tool
func RegisterAdAccountListConversionGoalsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_conversion_goals",
	...
	s.AddTool(tool, AdAccountListConversionGoalsHandler)
	return nil
}

// AdAccountListConversionGoalsHandler handles the ad_account_list_conversion_goals tool
func AdAccountListConversionGoalsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_conversion_goalsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/conversion_goals", args.ID)
