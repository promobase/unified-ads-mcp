...
// ad_account_list_ad_saved_keywordsArgs defines the typed arguments for ad_account_list_ad_saved_keywords
type ad_account_list_ad_saved_keywordsArgs struct {
...
// RegisterAdAccountListAdSavedKeywordsHandler registers the ad_account_list_ad_saved_keywords tool
func RegisterAdAccountListAdSavedKeywordsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_ad_saved_keywords",
	...
	s.AddTool(tool, AdAccountListAdSavedKeywordsHandler)
	return nil
}

// AdAccountListAdSavedKeywordsHandler handles the ad_account_list_ad_saved_keywords tool
func AdAccountListAdSavedKeywordsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_ad_saved_keywordsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/ad_saved_keywords", args.ID)
