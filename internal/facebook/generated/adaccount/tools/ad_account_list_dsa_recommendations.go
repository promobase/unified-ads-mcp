...
// ad_account_list_dsa_recommendationsArgs defines the typed arguments for ad_account_list_dsa_recommendations
type ad_account_list_dsa_recommendationsArgs struct {
...
// RegisterAdAccountListDsaRecommendationsHandler registers the ad_account_list_dsa_recommendations tool
func RegisterAdAccountListDsaRecommendationsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_dsa_recommendations",
	...
	s.AddTool(tool, AdAccountListDsaRecommendationsHandler)
	return nil
}

// AdAccountListDsaRecommendationsHandler handles the ad_account_list_dsa_recommendations tool
func AdAccountListDsaRecommendationsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_dsa_recommendationsArgs
