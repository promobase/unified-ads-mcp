...
// ad_account_getArgs defines the typed arguments for ad_account_get
type ad_account_getArgs struct {
...
// RegisterAdAccountGetHandler registers the ad_account_get tool
func RegisterAdAccountGetHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, AdAccountGetHandler)
	return nil
}

// AdAccountGetHandler handles the ad_account_get tool
func AdAccountGetHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_getArgs
