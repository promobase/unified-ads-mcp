...
// ad_account_list_ad_studiesArgs defines the typed arguments for ad_account_list_ad_studies
type ad_account_list_ad_studiesArgs struct {
...
// RegisterAdAccountListAdStudiesHandler registers the ad_account_list_ad_studies tool
func RegisterAdAccountListAdStudiesHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_ad_studies",
	...
	s.AddTool(tool, AdAccountListAdStudiesHandler)
	return nil
}

// AdAccountListAdStudiesHandler handles the ad_account_list_ad_studies tool
func AdAccountListAdStudiesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_ad_studiesArgs
