...
// ad_account_list_usersArgs defines the typed arguments for ad_account_list_users
type ad_account_list_usersArgs struct {
...
// RegisterAdAccountListUsersHandler registers the ad_account_list_users tool
func RegisterAdAccountListUsersHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_users",
	...
	s.AddTool(tool, AdAccountListUsersHandler)
	return nil
}

// AdAccountListUsersHandler handles the ad_account_list_users tool
func AdAccountListUsersHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_usersArgs
