...
// ad_account_get_ads_volumeArgs defines the typed arguments for ad_account_get_ads_volume
type ad_account_get_ads_volumeArgs struct {
...
func AdAccountGetAdsVolumeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	if args.PageId != "" {
		params["page_id"] = args.PageId
	}
	if args.RecommendationType != "" {
		params["recommendation_type"] = args.RecommendationType
	}
	params["show_breakdown_by_actor"] = fmt.Sprintf("%v", args.ShowBreakdownByActor)
