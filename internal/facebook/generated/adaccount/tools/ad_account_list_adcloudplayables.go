...
// ad_account_list_adcloudplayablesArgs defines the typed arguments for ad_account_list_adcloudplayables
type ad_account_list_adcloudplayablesArgs struct {
...
// RegisterAdAccountListAdcloudplayablesHandler registers the ad_account_list_adcloudplayables tool
func RegisterAdAccountListAdcloudplayablesHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_adcloudplayables",
	...
	s.AddTool(tool, AdAccountListAdcloudplayablesHandler)
	return nil
}

// AdAccountListAdcloudplayablesHandler handles the ad_account_list_adcloudplayables tool
func AdAccountListAdcloudplayablesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_adcloudplayablesArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/adcloudplayables", args.ID)
