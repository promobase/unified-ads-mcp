...
// ad_account_get_trackingArgs defines the typed arguments for ad_account_get_tracking
type ad_account_get_trackingArgs struct {
...
// RegisterAdAccountGetTrackingHandler registers the ad_account_get_tracking tool
func RegisterAdAccountGetTrackingHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_get_tracking",
	...
	s.AddTool(tool, AdAccountGetTrackingHandler)
	return nil
}

// AdAccountGetTrackingHandler handles the ad_account_get_tracking tool
func AdAccountGetTrackingHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_get_trackingArgs
