...
// ad_account_get_audience_funnelArgs defines the typed arguments for ad_account_get_audience_funnel
type ad_account_get_audience_funnelArgs struct {
...
// RegisterAdAccountGetAudienceFunnelHandler registers the ad_account_get_audience_funnel tool
func RegisterAdAccountGetAudienceFunnelHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_get_audience_funnel",
	...
	s.AddTool(tool, AdAccountGetAudienceFunnelHandler)
	return nil
}

// AdAccountGetAudienceFunnelHandler handles the ad_account_get_audience_funnel tool
func AdAccountGetAudienceFunnelHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_get_audience_funnelArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/audience_funnel", args.ID)
