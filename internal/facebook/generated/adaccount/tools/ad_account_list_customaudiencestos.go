...
// ad_account_list_customaudiencestosArgs defines the typed arguments for ad_account_list_customaudiencestos
type ad_account_list_customaudiencestosArgs struct {
...
// RegisterAdAccountListCustomaudiencestosHandler registers the ad_account_list_customaudiencestos tool
func RegisterAdAccountListCustomaudiencestosHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_customaudiencestos",
	...
	s.AddTool(tool, AdAccountListCustomaudiencestosHandler)
	return nil
}

// AdAccountListCustomaudiencestosHandler handles the ad_account_list_customaudiencestos tool
func AdAccountListCustomaudiencestosHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_customaudiencestosArgs
