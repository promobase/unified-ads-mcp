...
// ad_account_create_campaignArgs defines the typed arguments for ad_account_create_campaign
type ad_account_create_campaignArgs struct {
...
// RegisterAdAccountCreateCampaignHandler registers the ad_account_create_campaign tool
func RegisterAdAccountCreateCampaignHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_create_campaign",
		"Create or update campaigns for this AdAccount Returns Campaign. Required: special_ad_categories",
		json.RawMessage(`{"additionalProperties":false,"properties":{"adlabels":{"description":"Adlabels","items":{"additionalProperties":true,"type":"object"},"type":"array"},"bid_strategy":{"description":"Bid Strategy (enum: adaccountcampaigns_bid_strategy_enum_param)","enum":["COST_CAP","LOWEST_COST_WITHOUT_CAP","LOWEST_COST_WITH_BID_CAP","LOWEST_COST_WITH_MIN_ROAS"],"type":"string"},"buying_type":{"description":"Buying Type","type":"string"},"daily_budget":{"description":"Daily Budget","type":"integer"},"execution_options":{"description":"Execution Options","items":{"type":"string"},"type":"array"},"id":{"description":"AdAccount ID","pattern":"^[0-9]+$","type":"string"},"is_skadnetwork_attribution":{"description":"Is Skadnetwork Attribution","type":"boolean"},"iterative_split_test_configs":{"description":"Iterative Split Test Configs","items":{"additionalProperties":true,"type":"object"},"type":"array"},"lifetime_budget":{"description":"Lifetime Budget","type":"integer"},"name":{"description":"Name","type":"string"},"objective":{"description":"Objective (enum: adaccountcampaigns_objective_enum_param)","enum":["APP_INSTALLS","BRAND_AWARENESS","CONVERSIONS","EVENT_RESPONSES","LEAD_GENERATION","LINK_CLICKS","LOCAL_AWARENESS","MESSAGES","OFFER_CLAIMS","OUTCOME_APP_PROMOTION","OUTCOME_AWARENESS","OUTCOME_ENGAGEMENT","OUTCOME_LEADS","OUTCOME_SALES","OUTCOME_TRAFFIC","PAGE_LIKES","POST_ENGAGEMENT","PRODUCT_CATALOG_SALES","REACH","STORE_VISITS","VIDEO_VIEWS"],"type":"string"},"pacing_type":{"description":"Pacing Type","items":{"type":"string"},"type":"array"},"promoted_object":{"additionalProperties":true,"description":"Promoted Object","type":"object"},"smart_promotion_type":{"description":"Smart Promotion Type (enum: adaccountcampaigns_smart_promotion_type_enum_param)","enum":["GUIDED_CREATION","SMART_APP_PROMOTION"],"type":"string"},"source_campaign_id":{"description":"ID of the Source Campaign","pattern":"^[0-9]+$","type":"string"},"special_ad_categories":{"description":"Special Ad Categories","items":{"type":"string"},"type":"array"},"special_ad_category_country":{"description":"Special Ad Category Country","items":{"type":"string"},"type":"array"},"spend_cap":{"description":"Spend Cap","type":"integer"},"start_time":{"description":"Start Time","type":"string"},"status":{"description":"Status (enum: adaccountcampaigns_status_enum_param)","enum":["ACTIVE","ARCHIVED","DELETED","PAUSED"],"type":"string"},"stop_time":{"description":"Stop Time","type":"string"},"topline_id":{"description":"ID of the Topline","pattern":"^[0-9]+$","type":"string"}},"required":["id","special_ad_categories"],"type":"object"}`),
	)

	s.AddTool(tool, AdAccountCreateCampaignHandler)
	return nil
}

// AdAccountCreateCampaignHandler handles the ad_account_create_campaign tool
func AdAccountCreateCampaignHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_create_campaignArgs
