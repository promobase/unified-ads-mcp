...
// ad_account_list_subscribed_appsArgs defines the typed arguments for ad_account_list_subscribed_apps
type ad_account_list_subscribed_appsArgs struct {
...
// RegisterAdAccountListSubscribedAppsHandler registers the ad_account_list_subscribed_apps tool
func RegisterAdAccountListSubscribedAppsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_subscribed_apps",
	...
	s.AddTool(tool, AdAccountListSubscribedAppsHandler)
	return nil
}

// AdAccountListSubscribedAppsHandler handles the ad_account_list_subscribed_apps tool
func AdAccountListSubscribedAppsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_subscribed_appsArgs
