...
// ad_account_list_customconversionsArgs defines the typed arguments for ad_account_list_customconversions
type ad_account_list_customconversionsArgs struct {
...
// RegisterAdAccountListCustomconversionsHandler registers the ad_account_list_customconversions tool
func RegisterAdAccountListCustomconversionsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_customconversions",
	...
	s.AddTool(tool, AdAccountListCustomconversionsHandler)
	return nil
}

// AdAccountListCustomconversionsHandler handles the ad_account_list_customconversions tool
func AdAccountListCustomconversionsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_customconversionsArgs
