...
// ad_account_list_applicationsArgs defines the typed arguments for ad_account_list_applications
type ad_account_list_applicationsArgs struct {
...
// RegisterAdAccountListApplicationsHandler registers the ad_account_list_applications tool
func RegisterAdAccountListApplicationsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_applications",
	...
	s.AddTool(tool, AdAccountListApplicationsHandler)
	return nil
}

// AdAccountListApplicationsHandler handles the ad_account_list_applications tool
func AdAccountListApplicationsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_applicationsArgs
