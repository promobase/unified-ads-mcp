...
// ad_account_list_promote_pagesArgs defines the typed arguments for ad_account_list_promote_pages
type ad_account_list_promote_pagesArgs struct {
...
// RegisterAdAccountListPromotePagesHandler registers the ad_account_list_promote_pages tool
func RegisterAdAccountListPromotePagesHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_promote_pages",
	...
	s.AddTool(tool, AdAccountListPromotePagesHandler)
	return nil
}

// AdAccountListPromotePagesHandler handles the ad_account_list_promote_pages tool
func AdAccountListPromotePagesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_promote_pagesArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/promote_pages", args.ID)
