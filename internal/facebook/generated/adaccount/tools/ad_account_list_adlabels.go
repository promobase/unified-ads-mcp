...
// ad_account_list_adlabelsArgs defines the typed arguments for ad_account_list_adlabels
type ad_account_list_adlabelsArgs struct {
...
// RegisterAdAccountListAdlabelsHandler registers the ad_account_list_adlabels tool
func RegisterAdAccountListAdlabelsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_adlabels",
	...
	s.AddTool(tool, AdAccountListAdlabelsHandler)
	return nil
}

// AdAccountListAdlabelsHandler handles the ad_account_list_adlabels tool
func AdAccountListAdlabelsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_adlabelsArgs
