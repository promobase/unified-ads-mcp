...
// ad_account_list_mcmeconversionsArgs defines the typed arguments for ad_account_list_mcmeconversions
type ad_account_list_mcmeconversionsArgs struct {
...
// RegisterAdAccountListMcmeconversionsHandler registers the ad_account_list_mcmeconversions tool
func RegisterAdAccountListMcmeconversionsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_mcmeconversions",
	...
	s.AddTool(tool, AdAccountListMcmeconversionsHandler)
	return nil
}

// AdAccountListMcmeconversionsHandler handles the ad_account_list_mcmeconversions tool
func AdAccountListMcmeconversionsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_mcmeconversionsArgs
