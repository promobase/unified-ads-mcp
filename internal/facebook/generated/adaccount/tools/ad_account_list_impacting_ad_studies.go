...
// ad_account_list_impacting_ad_studiesArgs defines the typed arguments for ad_account_list_impacting_ad_studies
type ad_account_list_impacting_ad_studiesArgs struct {
...
// RegisterAdAccountListImpactingAdStudiesHandler registers the ad_account_list_impacting_ad_studies tool
func RegisterAdAccountListImpactingAdStudiesHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_impacting_ad_studies",
	...
	s.AddTool(tool, AdAccountListImpactingAdStudiesHandler)
	return nil
}

// AdAccountListImpactingAdStudiesHandler handles the ad_account_list_impacting_ad_studies tool
func AdAccountListImpactingAdStudiesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_impacting_ad_studiesArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/impacting_ad_studies", args.ID)
