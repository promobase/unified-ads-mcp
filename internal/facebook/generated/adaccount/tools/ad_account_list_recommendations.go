...
// ad_account_list_recommendationsArgs defines the typed arguments for ad_account_list_recommendations
type ad_account_list_recommendationsArgs struct {
...
// RegisterAdAccountListRecommendationsHandler registers the ad_account_list_recommendations tool
func RegisterAdAccountListRecommendationsHandler(s *server.MCPServer) error {
	tool := mcp.NewToolWithRawSchema(
		"ad_account_list_recommendations",
	...
	s.AddTool(tool, AdAccountListRecommendationsHandler)
	return nil
}

// AdAccountListRecommendationsHandler handles the ad_account_list_recommendations tool
func AdAccountListRecommendationsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_account_list_recommendationsArgs
