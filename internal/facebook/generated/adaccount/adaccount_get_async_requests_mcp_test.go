...
func TestToolAdaccount_get_async_requests_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_async_requests()
	if tool.Name != "adaccount_get_async_requests" {
		t.Errorf("expected tool name adaccount_get_async_requests, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_async_requests_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_async_requests",
			...
			// Call handler
			result, err := HandleAdaccount_get_async_requests(ctx, request)
