...
// ToolAdaccount_get_agencies returns the MCP tool definition for adaccount_get_agencies
func ToolAdaccount_get_agencies() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_agencies",
...
func HandleAdaccount_get_agencies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_agencies(accessToken, args)
	if err != nil {
...
func Adaccount_get_agencies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
