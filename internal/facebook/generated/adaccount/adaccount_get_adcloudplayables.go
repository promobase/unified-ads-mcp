...
// ToolAdaccount_get_adcloudplayables returns the MCP tool definition for adaccount_get_adcloudplayables
func ToolAdaccount_get_adcloudplayables() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_adcloudplayables",
...
func HandleAdaccount_get_adcloudplayables(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_adcloudplayables(accessToken, args)
	if err != nil {
...
func Adaccount_get_adcloudplayables(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%sadcloudplayables", accountId)
