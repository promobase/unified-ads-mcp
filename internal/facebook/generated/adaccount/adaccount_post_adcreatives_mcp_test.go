...
func TestToolAdaccount_post_adcreatives_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_post_adcreatives()
	if tool.Name != "adaccount_post_adcreatives" {
		t.Errorf("expected tool name adaccount_post_adcreatives, got %s", tool.Name)
	}
}

func TestToolAdaccount_post_adcreatives_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_post_adcreatives",
			...
			// Call handler
			result, err := HandleAdaccount_post_adcreatives(ctx, request)
