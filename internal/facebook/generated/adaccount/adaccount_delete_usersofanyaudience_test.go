...
func TestAdaccount_delete_usersofanyaudience_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/usersofanyaudience",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_delete_usersofanyaudience(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_delete_usersofanyaudience(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
