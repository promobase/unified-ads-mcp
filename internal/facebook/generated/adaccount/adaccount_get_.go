...
// ToolAdaccount_get_ returns the MCP tool definition for adaccount_get_
func ToolAdaccount_get_() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_",
...
func HandleAdaccount_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_(accessToken, args)
	if err != nil {
...
func Adaccount_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
