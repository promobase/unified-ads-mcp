...
func TestAdaccount_post_customaudiencestos_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/customaudiencestos",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/customaudiencestos", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_post_customaudiencestos(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_customaudiencestos_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_customaudiencestos(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_customaudiencestos(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_customaudiencestos(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
