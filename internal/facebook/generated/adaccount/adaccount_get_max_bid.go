...
// ToolAdaccount_get_max_bid returns the MCP tool definition for adaccount_get_max_bid
func ToolAdaccount_get_max_bid() mcp.Tool {
	// Available fields for AdAccountMaxBid: max_bid
	
	return mcp.NewTool("adaccount_get_max_bid",
...
func HandleAdaccount_get_max_bid(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_max_bid(accessToken, args)
	if err != nil {
...
func Adaccount_get_max_bid(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%smax_bid", accountId)
