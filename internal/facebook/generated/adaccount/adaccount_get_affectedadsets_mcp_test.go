...
func TestToolAdaccount_get_affectedadsets_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_affectedadsets()
	if tool.Name != "adaccount_get_affectedadsets" {
		t.Errorf("expected tool name adaccount_get_affectedadsets, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_affectedadsets_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_affectedadsets",
			...
			// Call handler
			result, err := HandleAdaccount_get_affectedadsets(ctx, request)
