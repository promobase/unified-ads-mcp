...
func TestToolAdaccount_get_applications_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_applications()
	if tool.Name != "adaccount_get_applications" {
		t.Errorf("expected tool name adaccount_get_applications, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_applications_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_applications",
			...
			// Call handler
			result, err := HandleAdaccount_get_applications(ctx, request)
