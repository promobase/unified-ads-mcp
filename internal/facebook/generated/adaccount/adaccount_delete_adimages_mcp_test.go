...
func TestToolAdaccount_delete_adimages_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_delete_adimages()
	if tool.Name != "adaccount_delete_adimages" {
		t.Errorf("expected tool name adaccount_delete_adimages, got %s", tool.Name)
	}
}

func TestToolAdaccount_delete_adimages_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_delete_adimages",
			...
			// Call handler
			result, err := HandleAdaccount_delete_adimages(ctx, request)
