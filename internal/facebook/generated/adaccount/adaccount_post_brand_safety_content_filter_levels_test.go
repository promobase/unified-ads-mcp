...
func TestAdaccount_post_brand_safety_content_filter_levels_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/brand_safety_content_filter_levels",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_post_brand_safety_content_filter_levels(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_brand_safety_content_filter_levels_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_brand_safety_content_filter_levels(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_brand_safety_content_filter_levels(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_brand_safety_content_filter_levels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
