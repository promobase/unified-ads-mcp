...
// ToolAdaccount_get returns the MCP tool definition for adaccount_get
func ToolAdaccount_get() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get",
...
// HandleAdaccount_get handles the adaccount_get tool with context-based auth
func HandleAdaccount_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute adaccount_get: %v", err)), nil
	}
...
// Adaccount_get performs GET  for AdAccount
func Adaccount_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string

	// Extract account_id for URL construction
	accountId, ok := args["account_id"].(string)
	if !ok {
		return nil, fmt.Errorf("account_id is required for adaccount_get")
	}
