...
// ToolAdaccount_get_impacting_ad_studies returns the MCP tool definition for adaccount_get_impacting_ad_studies
func ToolAdaccount_get_impacting_ad_studies() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_impacting_ad_studies",
...
func HandleAdaccount_get_impacting_ad_studies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_impacting_ad_studies(accessToken, args)
	if err != nil {
...
func Adaccount_get_impacting_ad_studies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%simpacting_ad_studies", accountId)
