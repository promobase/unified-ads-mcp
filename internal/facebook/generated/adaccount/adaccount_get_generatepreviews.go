...
// ToolAdaccount_get_generatepreviews returns the MCP tool definition for adaccount_get_generatepreviews
func ToolAdaccount_get_generatepreviews() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_generatepreviews",
