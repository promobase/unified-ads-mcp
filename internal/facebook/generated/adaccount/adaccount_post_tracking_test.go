...
func TestAdaccount_post_tracking_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/tracking",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_post_tracking(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_tracking_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_tracking(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_tracking(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_tracking(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
