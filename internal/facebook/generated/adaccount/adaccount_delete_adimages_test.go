...
func TestAdaccount_delete_adimages_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_delete_adimages(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_delete_adimages(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
