...
func TestToolAdaccount_get_adsets_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_adsets()
	if tool.Name != "adaccount_get_adsets" {
		t.Errorf("expected tool name adaccount_get_adsets, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_adsets_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdaccount_get_adsets(ctx, request)
