...
func TestAdaccount_post_insights_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/insights",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/insights", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_post_insights(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_insights_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_insights(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_insights(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
