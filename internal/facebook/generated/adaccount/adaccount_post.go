...
// ToolAdaccount_post returns the MCP tool definition for adaccount_post
func ToolAdaccount_post() mcp.Tool {
	...
	return mcp.NewTool("adaccount_post",
...
// HandleAdaccount_post handles the adaccount_post tool with context-based auth
func HandleAdaccount_post(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_post(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute adaccount_post: %v", err)), nil
	}
...
// Adaccount_post performs POST  for AdAccount
func Adaccount_post(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string

	// Extract account_id for URL construction
	accountId, ok := args["account_id"].(string)
	if !ok {
		return nil, fmt.Errorf("account_id is required for adaccount_post")
	}
