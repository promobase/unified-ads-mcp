...
// ToolAdaccount_get_dsa_recommendations returns the MCP tool definition for adaccount_get_dsa_recommendations
func ToolAdaccount_get_dsa_recommendations() mcp.Tool {
	// Available fields for AdAccountDsaRecommendations: recommendations

	return mcp.NewTool("adaccount_get_dsa_recommendations",
...
func HandleAdaccount_get_dsa_recommendations(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_dsa_recommendations(accessToken, args)
	if err != nil {
...
func Adaccount_get_dsa_recommendations(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%sdsa_recommendations", accountId)
