...
// ToolAdaccount_get_recommendations returns the MCP tool definition for adaccount_get_recommendations
func ToolAdaccount_get_recommendations() mcp.Tool {
	// Available fields for AdAccountRecommendations: recommendations

	return mcp.NewTool("adaccount_get_recommendations",
...
func HandleAdaccount_get_recommendations(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_recommendations(accessToken, args)
	if err != nil {
...
func Adaccount_get_recommendations(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
