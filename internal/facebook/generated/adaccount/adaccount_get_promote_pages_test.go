...
func TestAdaccount_get_promote_pages_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_get_promote_pages(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_get_promote_pages(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
