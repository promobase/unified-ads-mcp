...
func TestAdaccount_get_targetingsuggestions_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/targetingsuggestions",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/targetingsuggestions", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_get_targetingsuggestions(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_get_targetingsuggestions(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
