...
func TestAdaccount_get_ad_saved_keywords_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/ad_saved_keywords",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdaccount_get_ad_saved_keywords(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_get_ad_saved_keywords(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
