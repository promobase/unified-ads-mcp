...
// ToolAdaccount_get_minimum_budgets returns the MCP tool definition for adaccount_get_minimum_budgets
func ToolAdaccount_get_minimum_budgets() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_minimum_budgets",
...
func HandleAdaccount_get_minimum_budgets(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_minimum_budgets(accessToken, args)
	if err != nil {
...
func Adaccount_get_minimum_budgets(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%sminimum_budgets", accountId)
