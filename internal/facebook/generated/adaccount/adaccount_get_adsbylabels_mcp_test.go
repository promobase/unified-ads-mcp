...
func TestToolAdaccount_get_adsbylabels_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_adsbylabels()
	if tool.Name != "adaccount_get_adsbylabels" {
		t.Errorf("expected tool name adaccount_get_adsbylabels, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_adsbylabels_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_adsbylabels",
			...
			// Call handler
			result, err := HandleAdaccount_get_adsbylabels(ctx, request)
