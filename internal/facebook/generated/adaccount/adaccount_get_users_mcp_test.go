...
func TestToolAdaccount_get_users_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_users()
	if tool.Name != "adaccount_get_users" {
		t.Errorf("expected tool name adaccount_get_users, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_users_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdaccount_get_users(ctx, request)
