...
func TestAdaccount_post_publisher_block_lists_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/publisher_block_lists",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/publisher_block_lists", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_post_publisher_block_lists(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_publisher_block_lists_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_publisher_block_lists(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_publisher_block_lists(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_publisher_block_lists(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
