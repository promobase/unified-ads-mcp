...
// ToolAdaccount_post_publisher_block_lists returns the MCP tool definition for adaccount_post_publisher_block_lists
func ToolAdaccount_post_publisher_block_lists() mcp.Tool {

	// Params object accepts: name (string)
	return mcp.NewTool("adaccount_post_publisher_block_lists",
...
func HandleAdaccount_post_publisher_block_lists(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_post_publisher_block_lists(accessToken, args)
	if err != nil {
...
func Adaccount_post_publisher_block_lists(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
