...
// ToolAdaccount_get_instagram_accounts returns the MCP tool definition for adaccount_get_instagram_accounts
func ToolAdaccount_get_instagram_accounts() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_instagram_accounts",
...
func HandleAdaccount_get_instagram_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccount_get_instagram_accounts(accessToken, args)
	if err != nil {
...
func Adaccount_get_instagram_accounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/act_%sinstagram_accounts", accountId)
