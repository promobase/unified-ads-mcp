...
func TestAdaccount_get_adsetsbylabels_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/adsetsbylabels",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/adsetsbylabels", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_get_adsetsbylabels(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdaccount_get_adsetsbylabels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
