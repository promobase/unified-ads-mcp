...
func TestAdaccount_post_product_audiences_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/act_123456789/product_audiences",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/act_%s/product_audiences", FacebookGraphAPIBaseURL, accountId)
			...
			urlParams := buildURLParamsAdaccount_post_product_audiences(accessToken, tt.args, skipParams...)
...
func TestAdaccount_post_product_audiences_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdaccount_post_product_audiences(tt.args, skipParams...)
...
func buildBodyParamsAdaccount_post_product_audiences(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdaccount_post_product_audiences(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
