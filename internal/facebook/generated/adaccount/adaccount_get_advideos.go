...
// ToolAdaccount_get_advideos returns the MCP tool definition for adaccount_get_advideos
func ToolAdaccount_get_advideos() mcp.Tool {
	...
	return mcp.NewTool("adaccount_get_advideos",
