...
func TestToolAdaccount_get_adcreatives_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdaccount_get_adcreatives()
	if tool.Name != "adaccount_get_adcreatives" {
		t.Errorf("expected tool name adaccount_get_adcreatives, got %s", tool.Name)
	}
}

func TestToolAdaccount_get_adcreatives_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adaccount_get_adcreatives",
			...
			// Call handler
			result, err := HandleAdaccount_get_adcreatives(ctx, request)
