...
// ToolAdasyncrequestset_get_ returns the MCP tool definition for adasyncrequestset_get_
func ToolAdasyncrequestset_get_() mcp.Tool {
	...
	return mcp.NewTool("adasyncrequestset_get_",
...
func HandleAdasyncrequestset_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adasyncrequestset_get_(accessToken, args)
	if err != nil {
...
// Adasyncrequestset_get_ performs GET  for AdAsyncRequestSet
func Adasyncrequestset_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
