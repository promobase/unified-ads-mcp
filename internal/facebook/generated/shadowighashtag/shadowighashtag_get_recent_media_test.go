...
func TestShadowighashtag_get_recent_media_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/recent_media",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsShadowighashtag_get_recent_media(accessToken, tt.args, skipParams...)
...
func buildURLParamsShadowighashtag_get_recent_media(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
