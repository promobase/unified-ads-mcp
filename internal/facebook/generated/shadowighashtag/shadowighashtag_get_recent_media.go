...
// ToolShadowighashtag_get_recent_media returns the MCP tool definition for shadowighashtag_get_recent_media
func ToolShadowighashtag_get_recent_media() mcp.Tool {
	...
	return mcp.NewTool("shadowighashtag_get_recent_media",
...
func HandleShadowighashtag_get_recent_media(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Shadowighashtag_get_recent_media(accessToken, args)
	if err != nil {
