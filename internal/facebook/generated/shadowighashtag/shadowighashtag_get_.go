...
// ToolShadowighashtag_get_ returns the MCP tool definition for shadowighashtag_get_
func ToolShadowighashtag_get_() mcp.Tool {
	// Available fields for ShadowIGHashtag: id, name

	return mcp.NewTool("shadowighashtag_get_",
...
func HandleShadowighashtag_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Shadowighashtag_get_(accessToken, args)
	if err != nil {
...
func Shadowighashtag_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
