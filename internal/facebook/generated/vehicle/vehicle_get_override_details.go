...
// ToolVehicle_get_override_details returns the MCP tool definition for vehicle_get_override_details
func ToolVehicle_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("vehicle_get_override_details",
...
func HandleVehicle_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Vehicle_get_override_details(accessToken, args)
	if err != nil {
...
// Vehicle_get_override_details performs GET override_details for Vehicle
func Vehicle_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
