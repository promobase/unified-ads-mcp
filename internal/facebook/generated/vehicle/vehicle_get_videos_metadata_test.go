...
func TestVehicle_get_videos_metadata_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsVehicle_get_videos_metadata(accessToken, tt.args, skipParams...)
...
func buildURLParamsVehicle_get_videos_metadata(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
