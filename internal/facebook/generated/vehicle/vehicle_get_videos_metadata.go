...
// ToolVehicle_get_videos_metadata returns the MCP tool definition for vehicle_get_videos_metadata
func ToolVehicle_get_videos_metadata() mcp.Tool {
	// Available fields for DynamicVideoMetadata: id, tags, url, video
	
	return mcp.NewTool("vehicle_get_videos_metadata",
...
func HandleVehicle_get_videos_metadata(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Vehicle_get_videos_metadata(accessToken, args)
	if err != nil {
...
// Vehicle_get_videos_metadata performs GET videos_metadata for Vehicle
func Vehicle_get_videos_metadata(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
