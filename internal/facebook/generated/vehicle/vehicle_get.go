...
// ToolVehicle_get returns the MCP tool definition for vehicle_get
func ToolVehicle_get() mcp.Tool {
	...
	return mcp.NewTool("vehicle_get",
...
// HandleVehicle_get handles the vehicle_get tool with context-based auth
func HandleVehicle_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Vehicle_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute vehicle_get: %v", err)), nil
	}
...
// Vehicle_get performs GET  for Vehicle
func Vehicle_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
