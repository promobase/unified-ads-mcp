...
// ToolVehicle_get_channels_to_integrity_status returns the MCP tool definition for vehicle_get_channels_to_integrity_status
func ToolVehicle_get_channels_to_integrity_status() mcp.Tool {
	// Available fields for CatalogItemChannelsToIntegrityStatus: channels, rejection_information

	return mcp.NewTool("vehicle_get_channels_to_integrity_status",
...
func HandleVehicle_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Vehicle_get_channels_to_integrity_status(accessToken, args)
	if err != nil {
...
// Vehicle_get_channels_to_integrity_status performs GET channels_to_integrity_status for Vehicle
func Vehicle_get_channels_to_integrity_status(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
