...
func TestUnifiedthread_get_messages_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsUnifiedthread_get_messages(accessToken, tt.args, skipParams...)
...
func buildURLParamsUnifiedthread_get_messages(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
