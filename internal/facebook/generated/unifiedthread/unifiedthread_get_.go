...
// ToolUnifiedthread_get_ returns the MCP tool definition for unifiedthread_get_
func ToolUnifiedthread_get_() mcp.Tool {
	...
	return mcp.NewTool("unifiedthread_get_",
...
func HandleUnifiedthread_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Unifiedthread_get_(accessToken, args)
	if err != nil {
...
func Unifiedthread_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
