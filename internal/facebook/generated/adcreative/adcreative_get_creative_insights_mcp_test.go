...
func TestToolAdcreative_get_creative_insights_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdcreative_get_creative_insights()
	if tool.Name != "adcreative_get_creative_insights" {
		t.Errorf("expected tool name adcreative_get_creative_insights, got %s", tool.Name)
	}
}

func TestToolAdcreative_get_creative_insights_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adcreative_get_creative_insights",
			...
			// Call handler
			result, err := HandleAdcreative_get_creative_insights(ctx, request)
