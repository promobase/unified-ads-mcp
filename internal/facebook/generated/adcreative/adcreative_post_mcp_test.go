...
func TestToolAdcreative_post_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdcreative_post()
	if tool.Name != "adcreative_post" {
		t.Errorf("expected tool name adcreative_post, got %s", tool.Name)
	}
}

func TestToolAdcreative_post_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdcreative_post(ctx, request)
