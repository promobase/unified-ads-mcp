...
func TestAdcreative_delete_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdcreative_delete(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdcreative_delete(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
