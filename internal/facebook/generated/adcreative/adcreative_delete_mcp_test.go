...
func TestToolAdcreative_delete_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdcreative_delete()
	if tool.Name != "adcreative_delete" {
		t.Errorf("expected tool name adcreative_delete, got %s", tool.Name)
	}
}

func TestToolAdcreative_delete_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdcreative_delete(ctx, request)
