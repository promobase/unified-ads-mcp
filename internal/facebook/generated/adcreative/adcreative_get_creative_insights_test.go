...
func TestAdcreative_get_creative_insights_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/creative_insights",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdcreative_get_creative_insights(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdcreative_get_creative_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
