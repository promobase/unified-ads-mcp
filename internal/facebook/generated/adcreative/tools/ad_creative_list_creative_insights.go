...
// RegisterAdCreativeListCreativeInsightsHandler registers the ad_creative_list_creative_insights tool
func RegisterAdCreativeListCreativeInsightsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, AdCreativeListCreativeInsightsHandler)
	return nil
}

// AdCreativeListCreativeInsightsHandler handles the ad_creative_list_creative_insights tool
func AdCreativeListCreativeInsightsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args ad_creative_list_creative_insightsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/creative_insights", args.ID)
