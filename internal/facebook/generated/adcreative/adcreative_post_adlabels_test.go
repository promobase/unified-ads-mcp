...
func TestAdcreative_post_adlabels_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdcreative_post_adlabels(accessToken, tt.args, skipParams...)
...
func TestAdcreative_post_adlabels_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdcreative_post_adlabels(tt.args, skipParams...)
...
func buildBodyParamsAdcreative_post_adlabels(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdcreative_post_adlabels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
