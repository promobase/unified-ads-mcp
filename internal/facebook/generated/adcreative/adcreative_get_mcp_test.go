...
func TestToolAdcreative_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdcreative_get()
	if tool.Name != "adcreative_get" {
		t.Errorf("expected tool name adcreative_get, got %s", tool.Name)
	}
}

func TestToolAdcreative_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdcreative_get(ctx, request)
