...
func TestAdcreative_get_previews_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/previews",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/previews", FacebookGraphAPIBaseURL, adCreativeId)
			...
			urlParams := buildURLParamsAdcreative_get_previews(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdcreative_get_previews(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
