...
// ToolBusinesstag_get_ returns the MCP tool definition for businesstag_get_
func ToolBusinesstag_get_() mcp.Tool {
	// Available fields for BusinessTag: id, name

	return mcp.NewTool("businesstag_get_",
...
func HandleBusinesstag_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businesstag_get_(accessToken, args)
	if err != nil {
...
// Businesstag_get_ performs GET  for BusinessTag
func Businesstag_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
