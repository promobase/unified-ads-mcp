...
func TestAdstudy_get_instances_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdstudy_get_instances(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdstudy_get_instances(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
