...
// ToolOffsitesignalcontainerbusinessobject_get_linked_page returns the MCP tool definition for offsitesignalcontainerbusinessobject_get_linked_page
func ToolOffsitesignalcontainerbusinessobject_get_linked_page() mcp.Tool {
	...
	return mcp.NewTool("offsitesignalcontainerbusinessobject_get_linked_page",
...
func HandleOffsitesignalcontainerbusinessobject_get_linked_page(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Offsitesignalcontainerbusinessobject_get_linked_page(accessToken, args)
	if err != nil {
...
func Offsitesignalcontainerbusinessobject_get_linked_page(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string

	baseURL = FacebookGraphAPIBaseURL + "linked_page"
