...
func TestOffsitesignalcontainerbusinessobject_get_linked_application_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/linked_application",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsOffsitesignalcontainerbusinessobject_get_linked_application(accessToken, tt.args, skipParams...)
...
func buildURLParamsOffsitesignalcontainerbusinessobject_get_linked_application(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
