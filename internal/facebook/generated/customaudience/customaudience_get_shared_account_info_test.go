...
func TestCustomaudience_get_shared_account_info_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/shared_account_info",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCustomaudience_get_shared_account_info(accessToken, tt.args, skipParams...)
...
func buildURLParamsCustomaudience_get_shared_account_info(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
