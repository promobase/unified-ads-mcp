...
// ToolCustomaudience_delete_ returns the MCP tool definition for customaudience_delete_
func ToolCustomaudience_delete_() mcp.Tool {

	return mcp.NewTool("customaudience_delete_",
...
func HandleCustomaudience_delete_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Customaudience_delete_(accessToken, args)
	if err != nil {
...
func Customaudience_delete_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
