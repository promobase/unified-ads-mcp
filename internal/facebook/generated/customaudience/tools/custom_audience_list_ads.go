...
// RegisterCustomAudienceListAdsHandler registers the custom_audience_list_ads tool
func RegisterCustomAudienceListAdsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CustomAudienceListAdsHandler)
	return nil
}

// CustomAudienceListAdsHandler handles the custom_audience_list_ads tool
func CustomAudienceListAdsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	if len(args.Status) > 0 {
		params["status"] = strings.Join(args.Status, ",")
	}
