...
// RegisterCustomAudienceGetSharedAccountInfoHandler registers the custom_audience_get_shared_account_info tool
func RegisterCustomAudienceGetSharedAccountInfoHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CustomAudienceGetSharedAccountInfoHandler)
	return nil
}

// CustomAudienceGetSharedAccountInfoHandler handles the custom_audience_get_shared_account_info tool
func CustomAudienceGetSharedAccountInfoHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args custom_audience_get_shared_account_infoArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/shared_account_info", args.ID)
