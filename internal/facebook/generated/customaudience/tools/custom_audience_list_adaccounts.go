...
// RegisterCustomAudienceListAdaccountsHandler registers the custom_audience_list_adaccounts tool
func RegisterCustomAudienceListAdaccountsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CustomAudienceListAdaccountsHandler)
	return nil
}

// CustomAudienceListAdaccountsHandler handles the custom_audience_list_adaccounts tool
func CustomAudienceListAdaccountsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
