...
// ToolTransactableitem_get_ returns the MCP tool definition for transactableitem_get_
func ToolTransactableitem_get_() mcp.Tool {
	...
	return mcp.NewTool("transactableitem_get_",
...
func HandleTransactableitem_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Transactableitem_get_(accessToken, args)
	if err != nil {
...
func Transactableitem_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
