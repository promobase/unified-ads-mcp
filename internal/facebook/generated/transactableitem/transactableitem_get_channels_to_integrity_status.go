...
// ToolTransactableitem_get_channels_to_integrity_status returns the MCP tool definition for transactableitem_get_channels_to_integrity_status
func ToolTransactableitem_get_channels_to_integrity_status() mcp.Tool {
	// Available fields for CatalogItemChannelsToIntegrityStatus: channels, rejection_information

	return mcp.NewTool("transactableitem_get_channels_to_integrity_status",
...
func HandleTransactableitem_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Transactableitem_get_channels_to_integrity_status(accessToken, args)
	if err != nil {
