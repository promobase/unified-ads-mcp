...
// ToolTransactableitem_get_override_details returns the MCP tool definition for transactableitem_get_override_details
func ToolTransactableitem_get_override_details() mcp.Tool {
	// Available fields for OverrideDetails: key, type, values
	// Params object accepts: keys (list<string>), type (transactableitemoverride_details_type_enum_param)
	return mcp.NewTool("transactableitem_get_override_details",
...
func HandleTransactableitem_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Transactableitem_get_override_details(accessToken, args)
	if err != nil {
...
func Transactableitem_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
