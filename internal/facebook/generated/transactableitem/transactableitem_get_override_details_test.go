...
func TestTransactableitem_get_override_details_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsTransactableitem_get_override_details(accessToken, tt.args, skipParams...)
...
func buildURLParamsTransactableitem_get_override_details(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
