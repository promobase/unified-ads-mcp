...
func TestIguser_get_catalog_product_search_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/catalog_product_search",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguser_get_catalog_product_search(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguser_get_catalog_product_search(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
