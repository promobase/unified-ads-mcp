...
func TestIguser_post_product_appeal_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/product_appeal",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguser_post_product_appeal(accessToken, tt.args, skipParams...)
...
func TestIguser_post_product_appeal_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIguser_post_product_appeal(tt.args, skipParams...)
...
func buildBodyParamsIguser_post_product_appeal(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIguser_post_product_appeal(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
