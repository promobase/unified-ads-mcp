...
// ToolIguser_get_tags returns the MCP tool definition for iguser_get_tags
func ToolIguser_get_tags() mcp.Tool {
	...
	return mcp.NewTool("iguser_get_tags",
...
func HandleIguser_get_tags(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguser_get_tags(accessToken, args)
	if err != nil {
...
func Iguser_get_tags(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
