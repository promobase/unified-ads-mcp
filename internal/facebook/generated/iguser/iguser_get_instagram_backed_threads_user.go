...
// ToolIguser_get_instagram_backed_threads_user returns the MCP tool definition for iguser_get_instagram_backed_threads_user
func ToolIguser_get_instagram_backed_threads_user() mcp.Tool {
	// Available fields for ThreadsUser: threads_user_id, threads_user_profile_pic

	return mcp.NewTool("iguser_get_instagram_backed_threads_user",
...
func HandleIguser_get_instagram_backed_threads_user(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguser_get_instagram_backed_threads_user(accessToken, args)
	if err != nil {
