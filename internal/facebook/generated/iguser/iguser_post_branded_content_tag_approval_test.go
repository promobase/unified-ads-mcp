...
func TestIguser_post_branded_content_tag_approval_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/branded_content_tag_approval",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguser_post_branded_content_tag_approval(accessToken, tt.args, skipParams...)
...
func TestIguser_post_branded_content_tag_approval_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIguser_post_branded_content_tag_approval(tt.args, skipParams...)
...
func buildBodyParamsIguser_post_branded_content_tag_approval(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIguser_post_branded_content_tag_approval(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
