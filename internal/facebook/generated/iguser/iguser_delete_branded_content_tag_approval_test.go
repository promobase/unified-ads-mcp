...
func TestIguser_delete_branded_content_tag_approval_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguser_delete_branded_content_tag_approval(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguser_delete_branded_content_tag_approval(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
