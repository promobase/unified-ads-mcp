...
// ToolIguser_get_authorized_adaccounts returns the MCP tool definition for iguser_get_authorized_adaccounts
func ToolIguser_get_authorized_adaccounts() mcp.Tool {
	...
	return mcp.NewTool("iguser_get_authorized_adaccounts",
...
func HandleIguser_get_authorized_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguser_get_authorized_adaccounts(accessToken, args)
	if err != nil {
...
func Iguser_get_authorized_adaccounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
