...
func TestIguser_get_branded_content_advertisable_medias_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/branded_content_advertisable_medias",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguser_get_branded_content_advertisable_medias(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguser_get_branded_content_advertisable_medias(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
