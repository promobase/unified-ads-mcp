...
func TestIguser_get_dataset_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguser_get_dataset(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguser_get_dataset(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
