...
// ToolAdsavedreport_get_ returns the MCP tool definition for adsavedreport_get_
func ToolAdsavedreport_get_() mcp.Tool {
	...
	return mcp.NewTool("adsavedreport_get_",
...
func HandleAdsavedreport_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adsavedreport_get_(accessToken, args)
	if err != nil {
...
// Adsavedreport_get_ performs GET  for AdSavedReport
func Adsavedreport_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
