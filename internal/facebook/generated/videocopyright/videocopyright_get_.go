...
// ToolVideocopyright_get_ returns the MCP tool definition for videocopyright_get_
func ToolVideocopyright_get_() mcp.Tool {
	...
	return mcp.NewTool("videocopyright_get_",
...
func HandleVideocopyright_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Videocopyright_get_(accessToken, args)
	if err != nil {
...
// Videocopyright_get_ performs GET  for VideoCopyright
func Videocopyright_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
