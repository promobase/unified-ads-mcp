...
func TestVideocopyright_get_update_records_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/update_records",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsVideocopyright_get_update_records(accessToken, tt.args, skipParams...)
...
func buildURLParamsVideocopyright_get_update_records(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
