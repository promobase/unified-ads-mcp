...
// ToolAdstudyobjective_get_ returns the MCP tool definition for adstudyobjective_get_
func ToolAdstudyobjective_get_() mcp.Tool {
	...
	return mcp.NewTool("adstudyobjective_get_",
...
func HandleAdstudyobjective_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adstudyobjective_get_(accessToken, args)
	if err != nil {
...
func Adstudyobjective_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
