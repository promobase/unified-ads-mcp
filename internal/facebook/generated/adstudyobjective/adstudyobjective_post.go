...
// ToolAdstudyobjective_post returns the MCP tool definition for adstudyobjective_post
func ToolAdstudyobjective_post() mcp.Tool {
	...
	return mcp.NewTool("adstudyobjective_post",
...
// HandleAdstudyobjective_post handles the adstudyobjective_post tool with context-based auth
func HandleAdstudyobjective_post(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adstudyobjective_post(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute adstudyobjective_post: %v", err)), nil
	}
...
// Adstudyobjective_post performs POST  for AdStudyObjective
func Adstudyobjective_post(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
