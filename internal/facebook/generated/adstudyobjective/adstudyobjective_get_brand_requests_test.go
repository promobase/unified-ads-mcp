...
func TestAdstudyobjective_get_brand_requests_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/brand_requests",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdstudyobjective_get_brand_requests(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdstudyobjective_get_brand_requests(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
