...
func TestAdstudyobjective_get_offline_conversion_data_sets_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/offline_conversion_data_sets",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdstudyobjective_get_offline_conversion_data_sets(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdstudyobjective_get_offline_conversion_data_sets(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
