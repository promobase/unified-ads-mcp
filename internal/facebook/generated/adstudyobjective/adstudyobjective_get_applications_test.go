...
func TestAdstudyobjective_get_applications_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdstudyobjective_get_applications(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdstudyobjective_get_applications(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
