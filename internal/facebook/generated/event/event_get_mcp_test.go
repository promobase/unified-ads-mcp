...
func TestToolEvent_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolEvent_get()
	if tool.Name != "event_get" {
		t.Errorf("expected tool name event_get, got %s", tool.Name)
	}
}

func TestToolEvent_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleEvent_get(ctx, request)
