...
// ToolEvent_post_live_videos returns the MCP tool definition for event_post_live_videos
func ToolEvent_post_live_videos() mcp.Tool {
	...
	return mcp.NewTool("event_post_live_videos",
...
func HandleEvent_post_live_videos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Event_post_live_videos(accessToken, args)
	if err != nil {
...
func Event_post_live_videos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
