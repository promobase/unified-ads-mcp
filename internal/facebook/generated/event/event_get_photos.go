...
// ToolEvent_get_photos returns the MCP tool definition for event_get_photos
func ToolEvent_get_photos() mcp.Tool {

	return mcp.NewTool("event_get_photos",
...
func HandleEvent_get_photos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Event_get_photos(accessToken, args)
	if err != nil {
...
func Event_get_photos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
