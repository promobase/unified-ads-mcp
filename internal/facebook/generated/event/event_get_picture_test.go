...
func TestEvent_get_picture_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsEvent_get_picture(accessToken, tt.args, skipParams...)
...
func buildURLParamsEvent_get_picture(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
