...
// ToolEvent_get_videos returns the MCP tool definition for event_get_videos
func ToolEvent_get_videos() mcp.Tool {
	
	
	return mcp.NewTool("event_get_videos",
...
func HandleEvent_get_videos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Event_get_videos(accessToken, args)
	if err != nil {
...
func Event_get_videos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
