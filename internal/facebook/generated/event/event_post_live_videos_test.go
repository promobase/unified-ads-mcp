...
func TestEvent_post_live_videos_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsEvent_post_live_videos(accessToken, tt.args, skipParams...)
...
func TestEvent_post_live_videos_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsEvent_post_live_videos(tt.args, skipParams...)
...
func buildBodyParamsEvent_post_live_videos(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsEvent_post_live_videos(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
