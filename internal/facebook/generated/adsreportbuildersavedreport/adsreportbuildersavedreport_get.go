...
// ToolAdsreportbuildersavedreport_get returns the MCP tool definition for adsreportbuildersavedreport_get
func ToolAdsreportbuildersavedreport_get() mcp.Tool {
	...
	return mcp.NewTool("adsreportbuildersavedreport_get",
...
// HandleAdsreportbuildersavedreport_get handles the adsreportbuildersavedreport_get tool with context-based auth
func HandleAdsreportbuildersavedreport_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adsreportbuildersavedreport_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute adsreportbuildersavedreport_get: %v", err)), nil
	}
...
// Adsreportbuildersavedreport_get performs GET  for AdsReportBuilderSavedReport
func Adsreportbuildersavedreport_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
