...
// ToolPage_get_crosspost_whitelisted_pages returns the MCP tool definition for page_get_crosspost_whitelisted_pages
func ToolPage_get_crosspost_whitelisted_pages() mcp.Tool {
	...
	return mcp.NewTool("page_get_crosspost_whitelisted_pages",
...
func HandlePage_get_crosspost_whitelisted_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_crosspost_whitelisted_pages(accessToken, args)
	if err != nil {
