...
// ToolPage_get_personas returns the MCP tool definition for page_get_personas
func ToolPage_get_personas() mcp.Tool {
	// Available fields for Persona: id, name, profile_picture_url

	return mcp.NewTool("page_get_personas",
...
func HandlePage_get_personas(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_personas(accessToken, args)
	if err != nil {
