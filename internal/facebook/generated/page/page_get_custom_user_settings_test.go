...
func TestPage_get_custom_user_settings_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPage_get_custom_user_settings(accessToken, tt.args, skipParams...)
...
func buildURLParamsPage_get_custom_user_settings(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
