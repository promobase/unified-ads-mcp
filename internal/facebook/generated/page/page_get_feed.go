...
// ToolPage_get_feed returns the MCP tool definition for page_get_feed
func ToolPage_get_feed() mcp.Tool {
	...
	return mcp.NewTool("page_get_feed",
...
func HandlePage_get_feed(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_feed(accessToken, args)
	if err != nil {
...
func Page_get_feed(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
