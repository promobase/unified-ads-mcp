...
func TestPage_get_ads_posts_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/ads_posts",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = FacebookGraphAPIBaseURL + "/ads_posts"
			...
			skipParams := []string{}
			urlParams := buildURLParamsPage_get_ads_posts(accessToken, tt.args, skipParams...)
...
func buildURLParamsPage_get_ads_posts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
