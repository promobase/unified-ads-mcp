...
// ToolPage_post returns the MCP tool definition for page_post
func ToolPage_post() mcp.Tool {
...
// HandlePage_post handles the page_post tool with context-based auth
func HandlePage_post(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_post(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute page_post: %v", err)), nil
	}
...
// Page_post performs POST  for Page
