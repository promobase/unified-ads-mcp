...
// ToolPage_get_agencies returns the MCP tool definition for page_get_agencies
func ToolPage_get_agencies() mcp.Tool {
	...
	return mcp.NewTool("page_get_agencies",
...
func HandlePage_get_agencies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_agencies(accessToken, args)
	if err != nil {
...
func Page_get_agencies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
