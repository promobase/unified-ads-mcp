...
// ToolPage_get_video_lists returns the MCP tool definition for page_get_video_lists
func ToolPage_get_video_lists() mcp.Tool {
	...
	return mcp.NewTool("page_get_video_lists",
...
func HandlePage_get_video_lists(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_video_lists(accessToken, args)
	if err != nil {
