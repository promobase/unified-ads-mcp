...
// ToolPage_get_commerce_payouts returns the MCP tool definition for page_get_commerce_payouts
func ToolPage_get_commerce_payouts() mcp.Tool {
	...
	return mcp.NewTool("page_get_commerce_payouts",
