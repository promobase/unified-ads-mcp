...
func TestPage_post_page_whatsapp_number_verification_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/page_whatsapp_number_verification",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = FacebookGraphAPIBaseURL + "/page_whatsapp_number_verification"
			...
			skipParams := []string{}
			urlParams := buildURLParamsPage_post_page_whatsapp_number_verification(accessToken, tt.args, skipParams...)
...
func TestPage_post_page_whatsapp_number_verification_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPage_post_page_whatsapp_number_verification(tt.args, skipParams...)
...
func buildBodyParamsPage_post_page_whatsapp_number_verification(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPage_post_page_whatsapp_number_verification(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
