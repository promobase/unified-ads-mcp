...
// ToolPage_get_visitor_posts returns the MCP tool definition for page_get_visitor_posts
func ToolPage_get_visitor_posts() mcp.Tool {
	...
	return mcp.NewTool("page_get_visitor_posts",
...
func HandlePage_get_visitor_posts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_visitor_posts(accessToken, args)
	if err != nil {
...
func Page_get_visitor_posts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
