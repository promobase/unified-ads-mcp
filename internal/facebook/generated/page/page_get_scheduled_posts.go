...
// ToolPage_get_scheduled_posts returns the MCP tool definition for page_get_scheduled_posts
func ToolPage_get_scheduled_posts() mcp.Tool {
	...
	return mcp.NewTool("page_get_scheduled_posts",
...
func HandlePage_get_scheduled_posts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_scheduled_posts(accessToken, args)
	if err != nil {
