...
// ToolPage_get_global_brand_children returns the MCP tool definition for page_get_global_brand_children
func ToolPage_get_global_brand_children() mcp.Tool {
	...
	return mcp.NewTool("page_get_global_brand_children",
...
func HandlePage_get_global_brand_children(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_global_brand_children(accessToken, args)
	if err != nil {
