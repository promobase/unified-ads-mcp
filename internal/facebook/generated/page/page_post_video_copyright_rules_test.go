...
func TestPage_post_video_copyright_rules_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/video_copyright_rules",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPage_post_video_copyright_rules(accessToken, tt.args, skipParams...)
...
func TestPage_post_video_copyright_rules_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPage_post_video_copyright_rules(tt.args, skipParams...)
...
func buildBodyParamsPage_post_video_copyright_rules(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPage_post_video_copyright_rules(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
