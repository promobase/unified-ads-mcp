...
// ToolPage_get_businessprojects returns the MCP tool definition for page_get_businessprojects
func ToolPage_get_businessprojects() mcp.Tool {
	// Available fields for BusinessProject: business, created_time, creator, id, name
	// Params object accepts: business (string)
	return mcp.NewTool("page_get_businessprojects",
...
func HandlePage_get_businessprojects(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_businessprojects(accessToken, args)
	if err != nil {
