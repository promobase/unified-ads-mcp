...
// ToolPage_get_likes returns the MCP tool definition for page_get_likes
func ToolPage_get_likes() mcp.Tool {
	...
	return mcp.NewTool("page_get_likes",
...
func HandlePage_get_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_likes(accessToken, args)
	if err != nil {
