...
// ToolPage_get_picture returns the MCP tool definition for page_get_picture
func ToolPage_get_picture() mcp.Tool {
	...
	return mcp.NewTool("page_get_picture",
...
func HandlePage_get_picture(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_picture(accessToken, args)
	if err != nil {
...
func Page_get_picture(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
