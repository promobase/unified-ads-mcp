...
// ToolPage_get_commerce_transactions returns the MCP tool definition for page_get_commerce_transactions
func ToolPage_get_commerce_transactions() mcp.Tool {
	...
	return mcp.NewTool("page_get_commerce_transactions",
...
func HandlePage_get_commerce_transactions(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_commerce_transactions(accessToken, args)
	if err != nil {
...
func Page_get_commerce_transactions(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
