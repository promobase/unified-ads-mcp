...
func TestToolPage_post_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolPage_post()
	if tool.Name != "page_post" {
		t.Errorf("expected tool name page_post, got %s", tool.Name)
	}
}

func TestToolPage_post_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandlePage_post(ctx, request)
