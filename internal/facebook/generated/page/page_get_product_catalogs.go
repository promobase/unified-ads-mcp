...
// ToolPage_get_product_catalogs returns the MCP tool definition for page_get_product_catalogs
func ToolPage_get_product_catalogs() mcp.Tool {
	...
	return mcp.NewTool("page_get_product_catalogs",
...
func HandlePage_get_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_product_catalogs(accessToken, args)
	if err != nil {
...
func Page_get_product_catalogs(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
