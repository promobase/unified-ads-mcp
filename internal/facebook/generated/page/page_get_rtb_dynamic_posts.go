...
// ToolPage_get_rtb_dynamic_posts returns the MCP tool definition for page_get_rtb_dynamic_posts
func ToolPage_get_rtb_dynamic_posts() mcp.Tool {
	...
	return mcp.NewTool("page_get_rtb_dynamic_posts",
...
func HandlePage_get_rtb_dynamic_posts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_rtb_dynamic_posts(accessToken, args)
	if err != nil {
