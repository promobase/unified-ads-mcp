...
// ToolPage_get_messenger_lead_forms returns the MCP tool definition for page_get_messenger_lead_forms
func ToolPage_get_messenger_lead_forms() mcp.Tool {
	...
	return mcp.NewTool("page_get_messenger_lead_forms",
...
func HandlePage_get_messenger_lead_forms(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_messenger_lead_forms(accessToken, args)
	if err != nil {
