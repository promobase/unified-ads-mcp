...
func TestPage_post_extend_thread_control_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/extend_thread_control",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = FacebookGraphAPIBaseURL + "/extend_thread_control"
			...
			skipParams := []string{}
			urlParams := buildURLParamsPage_post_extend_thread_control(accessToken, tt.args, skipParams...)
...
func TestPage_post_extend_thread_control_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPage_post_extend_thread_control(tt.args, skipParams...)
...
func buildBodyParamsPage_post_extend_thread_control(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPage_post_extend_thread_control(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
