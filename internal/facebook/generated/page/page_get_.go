...
// ToolPage_get_ returns the MCP tool definition for page_get_
func ToolPage_get_() mcp.Tool {
...
func HandlePage_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_(accessToken, args)
	if err != nil {
...
func Page_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
