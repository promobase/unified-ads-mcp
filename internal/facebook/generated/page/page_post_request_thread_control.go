...
// ToolPage_post_request_thread_control returns the MCP tool definition for page_post_request_thread_control
func ToolPage_post_request_thread_control() mcp.Tool {

	// Params object accepts: metadata (string), recipient (Object)
	return mcp.NewTool("page_post_request_thread_control",
...
func HandlePage_post_request_thread_control(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_post_request_thread_control(accessToken, args)
	if err != nil {
...
func Page_post_request_thread_control(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
