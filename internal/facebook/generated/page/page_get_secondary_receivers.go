...
// ToolPage_get_secondary_receivers returns the MCP tool definition for page_get_secondary_receivers
func ToolPage_get_secondary_receivers() mcp.Tool {
	...
	return mcp.NewTool("page_get_secondary_receivers",
...
func HandlePage_get_secondary_receivers(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_secondary_receivers(accessToken, args)
	if err != nil {
