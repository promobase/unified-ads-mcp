...
// ToolPage_post_photos returns the MCP tool definition for page_post_photos
func ToolPage_post_photos() mcp.Tool {
	...
	return mcp.NewTool("page_post_photos",
...
func HandlePage_post_photos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_post_photos(accessToken, args)
	if err != nil {
...
func Page_post_photos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
