...
// ToolPage_get_custom_user_settings returns the MCP tool definition for page_get_custom_user_settings
func ToolPage_get_custom_user_settings() mcp.Tool {
	...
	return mcp.NewTool("page_get_custom_user_settings",
...
func HandlePage_get_custom_user_settings(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_custom_user_settings(accessToken, args)
	if err != nil {
