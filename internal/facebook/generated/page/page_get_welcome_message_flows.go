...
// ToolPage_get_welcome_message_flows returns the MCP tool definition for page_get_welcome_message_flows
func ToolPage_get_welcome_message_flows() mcp.Tool {
	...
	return mcp.NewTool("page_get_welcome_message_flows",
...
func HandlePage_get_welcome_message_flows(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Page_get_welcome_message_flows(accessToken, args)
	if err != nil {
...
func Page_get_welcome_message_flows(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
