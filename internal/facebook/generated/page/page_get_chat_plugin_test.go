...
func TestPage_get_chat_plugin_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/chat_plugin",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = FacebookGraphAPIBaseURL + "/chat_plugin"
			...
			skipParams := []string{}
			urlParams := buildURLParamsPage_get_chat_plugin(accessToken, tt.args, skipParams...)
...
func buildURLParamsPage_get_chat_plugin(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
