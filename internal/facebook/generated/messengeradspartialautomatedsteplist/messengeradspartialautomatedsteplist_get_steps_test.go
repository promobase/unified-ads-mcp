...
func TestMessengeradspartialautomatedsteplist_get_steps_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/steps",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsMessengeradspartialautomatedsteplist_get_steps(accessToken, tt.args, skipParams...)
...
func buildURLParamsMessengeradspartialautomatedsteplist_get_steps(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
