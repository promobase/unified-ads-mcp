...
// ToolLead_get_ returns the MCP tool definition for lead_get_
func ToolLead_get_() mcp.Tool {
...
func HandleLead_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Lead_get_(accessToken, args)
	if err != nil {
...
func Lead_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
