...
func TestLead_delete_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsLead_delete(accessToken, tt.args, skipParams...)
...
func buildURLParamsLead_delete(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
