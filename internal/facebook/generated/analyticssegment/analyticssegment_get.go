...
// ToolAnalyticssegment_get returns the MCP tool definition for analyticssegment_get
func ToolAnalyticssegment_get() mcp.Tool {
	...
	return mcp.NewTool("analyticssegment_get",
...
// HandleAnalyticssegment_get handles the analyticssegment_get tool with context-based auth
func HandleAnalyticssegment_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Analyticssegment_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute analyticssegment_get: %v", err)), nil
	}
...
// Analyticssegment_get performs GET  for AnalyticsSegment
