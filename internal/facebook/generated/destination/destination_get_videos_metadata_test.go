...
func TestDestination_get_videos_metadata_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsDestination_get_videos_metadata(accessToken, tt.args, skipParams...)
...
func buildURLParamsDestination_get_videos_metadata(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
