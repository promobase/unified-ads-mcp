...
// ToolDestination_get_channels_to_integrity_status returns the MCP tool definition for destination_get_channels_to_integrity_status
func ToolDestination_get_channels_to_integrity_status() mcp.Tool {
	// Available fields for CatalogItemChannelsToIntegrityStatus: channels, rejection_information

	return mcp.NewTool("destination_get_channels_to_integrity_status",
...
func HandleDestination_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Destination_get_channels_to_integrity_status(accessToken, args)
	if err != nil {
...
func Destination_get_channels_to_integrity_status(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
