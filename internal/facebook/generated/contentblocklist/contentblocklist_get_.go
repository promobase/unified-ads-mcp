...
// ToolContentblocklist_get_ returns the MCP tool definition for contentblocklist_get_
func ToolContentblocklist_get_() mcp.Tool {
	// Available fields for ContentBlockList: business, id, name

	return mcp.NewTool("contentblocklist_get_",
...
func HandleContentblocklist_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Contentblocklist_get_(accessToken, args)
	if err != nil {
...
func Contentblocklist_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
