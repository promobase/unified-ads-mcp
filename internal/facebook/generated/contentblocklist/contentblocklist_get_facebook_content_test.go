...
func TestContentblocklist_get_facebook_content_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/facebook_content",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsContentblocklist_get_facebook_content(accessToken, tt.args, skipParams...)
...
func buildURLParamsContentblocklist_get_facebook_content(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
