...
// ToolContentblocklist_get_applied_ad_accounts returns the MCP tool definition for contentblocklist_get_applied_ad_accounts
func ToolContentblocklist_get_applied_ad_accounts() mcp.Tool {
	...
	return mcp.NewTool("contentblocklist_get_applied_ad_accounts",
...
func HandleContentblocklist_get_applied_ad_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Contentblocklist_get_applied_ad_accounts(accessToken, args)
	if err != nil {
