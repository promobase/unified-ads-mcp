...
// ToolOfflineproductitem_get_ returns the MCP tool definition for offlineproductitem_get_
func ToolOfflineproductitem_get_() mcp.Tool {
	...
	return mcp.NewTool("offlineproductitem_get_",
...
func HandleOfflineproductitem_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Offlineproductitem_get_(accessToken, args)
	if err != nil {
...
func Offlineproductitem_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
