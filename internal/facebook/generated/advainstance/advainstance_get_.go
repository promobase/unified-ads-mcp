...
// ToolAdvainstance_get_ returns the MCP tool definition for advainstance_get_
func ToolAdvainstance_get_() mcp.Tool {
	// Available fields for AdvAInstance: id, instance_type, name, owner_business

	return mcp.NewTool("advainstance_get_",
...
func HandleAdvainstance_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Advainstance_get_(accessToken, args)
	if err != nil {
...
// Advainstance_get_ performs GET  for AdvAInstance
func Advainstance_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
