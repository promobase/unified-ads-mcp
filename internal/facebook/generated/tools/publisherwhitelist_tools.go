...
func GetPublisherWhiteListTools() []mcp.Tool {
	...
	publisherwhitelist_get_Tool := mcp.NewTool("publisherwhitelist_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for PublisherWhiteList objects. Available fields: business_owner_id, id, last_updated_time, last_updated_user, name, placement_type"),
		),
