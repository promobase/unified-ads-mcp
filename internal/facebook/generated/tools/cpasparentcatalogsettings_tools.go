...
func GetCPASParentCatalogSettingsTools() []mcp.Tool {
	...
	cpasparentcatalogsettings_get_Tool := mcp.NewTool("cpasparentcatalogsettings_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for CPASParentCatalogSettings objects. Available fields: attribution_windows, default_currency, disable_use_as_parent_catalog, id"),
		),
