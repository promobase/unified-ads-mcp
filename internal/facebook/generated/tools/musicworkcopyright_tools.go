...
func GetMusicWorkCopyrightTools() []mcp.Tool {
	...
	musicworkcopyright_get_Tool := mcp.NewTool("musicworkcopyright_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for MusicWorkCopyright objects. Available fields: available_ui_actions, claim_status, creation_time, displayed_fb_matches_count, displayed_ig_matches_count, displayed_matches_count, has_rev_share_eligible_isrcs, id, is_linking_required_to_monetize_for_manual_claim, match_rule, status, tags, update_time"),
		),
