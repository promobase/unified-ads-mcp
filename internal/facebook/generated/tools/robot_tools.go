...
func GetRobotTools() []mcp.Tool {
	...
	robot_get_Tool := mcp.NewTool("robot_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for Robot objects. Available fields: bringup_vars, configurations, data_center, id, init_pos, last_pos, meetup_link_hash, suite, target_map_image_uri, target_os_image_uri, target_sw_image_uri, user"),
		),
