...
func GetGeoGatingPolicyTools() []mcp.Tool {
	...
	geogatingpolicy_get_Tool := mcp.NewTool("geogatingpolicy_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for GeoGatingPolicy objects. Available fields: after_schedule, exclude_country, id, include_country, name, valid_from, valid_until"),
		),
