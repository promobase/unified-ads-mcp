...
func GetProductCatalogLocalizationSettingsTools() []mcp.Tool {
	...
	productcataloglocalizationsettings_get_Tool := mcp.NewTool("productcataloglocalizationsettings_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for ProductCatalogLocalizationSettings objects. Available fields: default_country, default_language, id"),
		),
