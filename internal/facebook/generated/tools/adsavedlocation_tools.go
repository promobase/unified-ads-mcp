...
func GetAdSavedLocationTools() []mcp.Tool {
	...
	adsavedlocation_get_Tool := mcp.NewTool("adsavedlocation_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AdSavedLocation objects. Available fields: cities, countries, country_groups, custom_locations, geo_markets, id, location_sentences, name, regions, zips"),
		),
