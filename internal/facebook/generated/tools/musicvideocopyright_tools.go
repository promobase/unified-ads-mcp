...
func GetMusicVideoCopyrightTools() []mcp.Tool {
	...
	musicvideocopyright_get_Tool := mcp.NewTool("musicvideocopyright_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for MusicVideoCopyright objects. Available fields: creation_time, displayed_matches_count, id, in_conflict, isrc, match_rule, ownership_countries, reference_file_status, ridge_monitoring_status, tags, update_time, video_asset, whitelisted_fb_users, whitelisted_ig_users"),
		),
