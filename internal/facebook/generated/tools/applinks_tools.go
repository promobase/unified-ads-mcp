...
func GetAppLinksTools() []mcp.Tool {
	...
	applinks_get_Tool := mcp.NewTool("applinks_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AppLinks objects. Available fields: android, id, ios, ipad, iphone, web, windows, windows_phone, windows_universal"),
		),
