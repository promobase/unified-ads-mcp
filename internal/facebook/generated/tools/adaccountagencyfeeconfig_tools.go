...
func GetAdAccountAgencyFeeConfigTools() []mcp.Tool {
	...
	adaccountagencyfeeconfig_get_Tool := mcp.NewTool("adaccountagencyfeeconfig_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AdAccountAgencyFeeConfig objects. Available fields: can_add_agency_fee_to_invoice, default_agency_fee_pct, id, is_agency_fee_disabled, status"),
		),
