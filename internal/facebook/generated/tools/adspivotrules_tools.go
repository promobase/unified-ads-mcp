...
func GetAdsPivotRulesTools() []mcp.Tool {
	...
	adspivotrules_get_Tool := mcp.NewTool("adspivotrules_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AdsPivotRules objects. Available fields: creation_time, creator, description, id, name, permission, rules, scope, update_by, update_time"),
		),
