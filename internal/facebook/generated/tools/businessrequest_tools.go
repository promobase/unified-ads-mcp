...
func GetBusinessRequestTools() []mcp.Tool {
	...
	businessrequest_get_Tool := mcp.NewTool("businessrequest_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for BusinessRequest objects. Available fields: accessor, creation_time, id, object_id, object_type, permitted_tasks, request_status, request_type, requestor"),
		),
