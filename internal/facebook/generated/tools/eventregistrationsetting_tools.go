...
func GetEventRegistrationSettingTools() []mcp.Tool {
	...
	eventregistrationsetting_get_Tool := mcp.NewTool("eventregistrationsetting_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for EventRegistrationSetting objects. Available fields: id, questions, target_type, ticket_tier_ids"),
		),
