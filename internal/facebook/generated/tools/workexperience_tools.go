...
func GetWorkExperienceTools() []mcp.Tool {
	...
	workexperience_get_Tool := mcp.NewTool("workexperience_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for WorkExperience objects. Available fields: description, employer, end_date, from, id, location, position, projects, start_date, with"),
		),
