...
func GetShadowIGMediaBuilderTools() []mcp.Tool {
	...
	shadowigmediabuilder_get_Tool := mcp.NewTool("shadowigmediabuilder_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for ShadowIGMediaBuilder objects. Available fields: copyright_check_status, id, status, status_code, video_status"),
		),
