...
func GetWoodhengePurchasedPAYGReceiptTools() []mcp.Tool {
	...
	woodhengepurchasedpaygreceipt_get_Tool := mcp.NewTool("woodhengepurchasedpaygreceipt_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for WoodhengePurchasedPAYGReceipt objects. Available fields: id, number_of_subscriptions_purchased, purchase_time, user"),
		),
