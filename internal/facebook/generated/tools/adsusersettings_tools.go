...
func GetAdsUserSettingsTools() []mcp.Tool {
	...
	adsusersettings_get_Tool := mcp.NewTool("adsusersettings_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AdsUserSettings objects. Available fields: a_plus_c_survey_seen, add_overlays_opt_in_status, adgroup_name_template, ads_cs_catalog_opt_out_timestamp, ads_tool_visits, aplusc_carousel_cda_opt_in_status, aplusc_carousel_inline_comment_opt_in_status, aplusc_enhance_cta_opt_in_status, aplusc_epa_opt_in_status, aplusc_local_store_extension_opt_in_status, aplusc_opt_out_friction, aplusc_videofilter_opt_in_status, aplusc_videouncrop_opt_in_status, autoflow_lite_opt_in_status, autoflow_lite_should_opt_in (and 63 more)"),
		),
