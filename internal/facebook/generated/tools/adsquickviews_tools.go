...
func GetAdsQuickViewsTools() []mcp.Tool {
	...
	adsquickviews_get_Tool := mcp.NewTool("adsquickviews_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AdsQuickViews objects. Available fields: attribution_windows, breakdowns, column_fields, description, id, name, owner, permission, quick_view_type, sort"),
		),
