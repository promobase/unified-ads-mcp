...
func GetPageUpcomingChangeTools() []mcp.Tool {
	...
	pageupcomingchange_get_Tool := mcp.NewTool("pageupcomingchange_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for PageUpcomingChange objects. Available fields: change_type, effective_time, id, page, proposal, timer_status"),
		),
