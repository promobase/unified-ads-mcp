...
func GetMailingAddressTools() []mcp.Tool {
	...
	mailingaddress_get_Tool := mcp.NewTool("mailingaddress_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for MailingAddress objects. Available fields: city, city_page, country, id, postal_code, region, street1, street2"),
		),
