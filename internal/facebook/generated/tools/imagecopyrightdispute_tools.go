...
func GetImageCopyrightDisputeTools() []mcp.Tool {
	...
	imagecopyrightdispute_get_Tool := mcp.NewTool("imagecopyrightdispute_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for ImageCopyrightDispute objects. Available fields: appeal_form_data, dispute_form_data, expiration_time, id, match_id, status, time_appealed, time_created, time_updated"),
		),
