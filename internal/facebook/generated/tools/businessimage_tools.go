...
func GetBusinessImageTools() []mcp.Tool {
	...
	businessimage_get_Tool := mcp.NewTool("businessimage_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for BusinessImage objects. Available fields: business, creation_time, hash, height, id, media_library_url, name, url, url_128, width"),
		),
