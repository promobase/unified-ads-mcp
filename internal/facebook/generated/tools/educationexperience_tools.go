...
func GetEducationExperienceTools() []mcp.Tool {
	...
	educationexperience_get_Tool := mcp.NewTool("educationexperience_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for EducationExperience objects. Available fields: classes, concentration, degree, id, school, type, with, year"),
		),
