...
// GetProductGroupToolsWithoutAuth returns MCP tools for ProductGroup without access_token parameter
func GetProductGroupToolsWithoutAuth() []mcp.Tool {
	var tools []mcp.Tool
...
// HandleContextProductgroup_get_products handles the productgroup_get_products tool with context-based auth
func HandleContextProductgroup_get_products(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
// HandleContextProductgroup_post_products handles the productgroup_post_products tool with context-based auth
func HandleContextProductgroup_post_products(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductgroup_delete_ handles the productgroup_delete_ tool with context-based auth
func HandleContextProductgroup_delete_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductgroup_get_ handles the productgroup_get_ tool with context-based auth
func HandleContextProductgroup_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductgroup_post_ handles the productgroup_post_ tool with context-based auth
func HandleContextProductgroup_post_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
