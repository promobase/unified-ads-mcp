...
// GetPagePostToolsWithoutAuth returns MCP tools for PagePost without access_token parameter
func GetPagePostToolsWithoutAuth() []mcp.Tool {
	var tools []mcp.Tool
...
// HandlePagepost_get_attachments handles the pagepost_get_attachments tool
...
// HandlePagepost_get_comments handles the pagepost_get_comments tool
...
// HandlePagepost_post_comments handles the pagepost_post_comments tool
...
// HandlePagepost_get_dynamic_posts handles the pagepost_get_dynamic_posts tool
...
// HandlePagepost_get_insights handles the pagepost_get_insights tool
...
// HandlePagepost_delete_likes handles the pagepost_delete_likes tool
...
// HandlePagepost_get_likes handles the pagepost_get_likes tool
...
// HandlePagepost_post_likes handles the pagepost_post_likes tool
...
// HandlePagepost_get_reactions handles the pagepost_get_reactions tool
...
// HandlePagepost_get_sharedposts handles the pagepost_get_sharedposts tool
...
// HandlePagepost_get_sponsor_tags handles the pagepost_get_sponsor_tags tool
...
// HandlePagepost_get_to handles the pagepost_get_to tool
...
// HandlePagepost_delete_ handles the pagepost_delete_ tool
...
// HandlePagepost_get_ handles the pagepost_get_ tool
...
// HandlePagepost_post_ handles the pagepost_post_ tool
...
// HandleContextPagepost_get_attachments handles the pagepost_get_attachments tool with context-based auth
func HandleContextPagepost_get_attachments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
// HandleContextPagepost_get_comments handles the pagepost_get_comments tool with context-based auth
func HandleContextPagepost_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_post_comments handles the pagepost_post_comments tool with context-based auth
func HandleContextPagepost_post_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_dynamic_posts handles the pagepost_get_dynamic_posts tool with context-based auth
func HandleContextPagepost_get_dynamic_posts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_insights handles the pagepost_get_insights tool with context-based auth
func HandleContextPagepost_get_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_delete_likes handles the pagepost_delete_likes tool with context-based auth
func HandleContextPagepost_delete_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_likes handles the pagepost_get_likes tool with context-based auth
func HandleContextPagepost_get_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_post_likes handles the pagepost_post_likes tool with context-based auth
func HandleContextPagepost_post_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_reactions handles the pagepost_get_reactions tool with context-based auth
func HandleContextPagepost_get_reactions(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_sharedposts handles the pagepost_get_sharedposts tool with context-based auth
func HandleContextPagepost_get_sharedposts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_sponsor_tags handles the pagepost_get_sponsor_tags tool with context-based auth
func HandleContextPagepost_get_sponsor_tags(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_to handles the pagepost_get_to tool with context-based auth
func HandleContextPagepost_get_to(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_delete_ handles the pagepost_delete_ tool with context-based auth
func HandleContextPagepost_delete_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_get_ handles the pagepost_get_ tool with context-based auth
func HandleContextPagepost_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextPagepost_post_ handles the pagepost_post_ tool with context-based auth
func HandleContextPagepost_post_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
