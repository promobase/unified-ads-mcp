...
func GetWoodhengeSupporterTools() []mcp.Tool {
	...
	woodhengesupporter_get_Tool := mcp.NewTool("woodhengesupporter_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for WoodhengeSupporter objects. Available fields: creation_time, id, is_gifted_subscription, most_recent_subscription_time, number_of_months_subscribed, user"),
		),
