...
// GetProductItemToolsWithoutAuth returns MCP tools for ProductItem without access_token parameter
func GetProductItemToolsWithoutAuth() []mcp.Tool {
	var tools []mcp.Tool
...
// HandleContextProductitem_get_channels_to_integrity_status handles the productitem_get_channels_to_integrity_status tool with context-based auth
func HandleContextProductitem_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
// HandleContextProductitem_get_override_details handles the productitem_get_override_details tool with context-based auth
func HandleContextProductitem_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductitem_get_product_sets handles the productitem_get_product_sets tool with context-based auth
func HandleContextProductitem_get_product_sets(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductitem_get_videos_metadata handles the productitem_get_videos_metadata tool with context-based auth
func HandleContextProductitem_get_videos_metadata(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductitem_delete_ handles the productitem_delete_ tool with context-based auth
func HandleContextProductitem_delete_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductitem_get_ handles the productitem_get_ tool with context-based auth
func HandleContextProductitem_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextProductitem_post_ handles the productitem_post_ tool with context-based auth
func HandleContextProductitem_post_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
