...
// GetAdToolsWithoutAuth returns MCP tools for Ad without access_token parameter
func GetAdToolsWithoutAuth() []mcp.Tool {
	var tools []mcp.Tool
...
// HandleAd_get_adcreatives handles the ad_get_adcreatives tool
...
// HandleAd_post_adlabels handles the ad_post_adlabels tool
...
// HandleAd_get_adrules_governed handles the ad_get_adrules_governed tool
...
// HandleAd_get_copies handles the ad_get_copies tool
...
// HandleAd_post_copies handles the ad_post_copies tool
...
// HandleAd_get_insights handles the ad_get_insights tool
...
// HandleAd_post_insights handles the ad_post_insights tool
...
// HandleAd_get_leads handles the ad_get_leads tool
...
// HandleAd_get_previews handles the ad_get_previews tool
...
// HandleAd_get_targetingsentencelines handles the ad_get_targetingsentencelines tool
...
// HandleAd_delete_ handles the ad_delete_ tool
...
// HandleAd_get_ handles the ad_get_ tool
...
// HandleAd_post_ handles the ad_post_ tool
...
// HandleContextAd_get_adcreatives handles the ad_get_adcreatives tool with context-based auth
func HandleContextAd_get_adcreatives(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
// HandleContextAd_post_adlabels handles the ad_post_adlabels tool with context-based auth
func HandleContextAd_post_adlabels(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_get_adrules_governed handles the ad_get_adrules_governed tool with context-based auth
func HandleContextAd_get_adrules_governed(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_get_copies handles the ad_get_copies tool with context-based auth
func HandleContextAd_get_copies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_post_copies handles the ad_post_copies tool with context-based auth
func HandleContextAd_post_copies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_get_insights handles the ad_get_insights tool with context-based auth
func HandleContextAd_get_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_post_insights handles the ad_post_insights tool with context-based auth
func HandleContextAd_post_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_get_leads handles the ad_get_leads tool with context-based auth
func HandleContextAd_get_leads(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_get_previews handles the ad_get_previews tool with context-based auth
func HandleContextAd_get_previews(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_get_targetingsentencelines handles the ad_get_targetingsentencelines tool with context-based auth
func HandleContextAd_get_targetingsentencelines(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_delete_ handles the ad_delete_ tool with context-based auth
func HandleContextAd_delete_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_get_ handles the ad_get_ tool with context-based auth
func HandleContextAd_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextAd_post_ handles the ad_post_ tool with context-based auth
func HandleContextAd_post_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
