...
func GetFranchiseProgramTools() []mcp.Tool {
	...
	franchiseprogram_get_Tool := mcp.NewTool("franchiseprogram_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for FranchiseProgram objects. Available fields: business_asset_group, creator_business, description, end_date, id, name, program_access_type, program_approval_type, program_image_link, program_url, shared_custom_audience, start_date"),
		),
