...
func GetProductDeliveryPreferenceTools() []mcp.Tool {
	...
	productdeliverypreference_get_Tool := mcp.NewTool("productdeliverypreference_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for ProductDeliveryPreference objects. Available fields: ad_object_id, id, product_priority, product_priority_category"),
		),
