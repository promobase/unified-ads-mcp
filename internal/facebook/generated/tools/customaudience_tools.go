...
// GetCustomAudienceToolsWithoutAuth returns MCP tools for CustomAudience without access_token parameter
func GetCustomAudienceToolsWithoutAuth() []mcp.Tool {
	var tools []mcp.Tool
...
// HandleContextCustomaudience_delete_adaccounts handles the customaudience_delete_adaccounts tool with context-based auth
func HandleContextCustomaudience_delete_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
// HandleContextCustomaudience_get_adaccounts handles the customaudience_get_adaccounts tool with context-based auth
func HandleContextCustomaudience_get_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_post_adaccounts handles the customaudience_post_adaccounts tool with context-based auth
func HandleContextCustomaudience_post_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_get_ads handles the customaudience_get_ads tool with context-based auth
func HandleContextCustomaudience_get_ads(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_get_health handles the customaudience_get_health tool with context-based auth
func HandleContextCustomaudience_get_health(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_get_salts handles the customaudience_get_salts tool with context-based auth
func HandleContextCustomaudience_get_salts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_post_salts handles the customaudience_post_salts tool with context-based auth
func HandleContextCustomaudience_post_salts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_get_sessions handles the customaudience_get_sessions tool with context-based auth
func HandleContextCustomaudience_get_sessions(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_get_shared_account_info handles the customaudience_get_shared_account_info tool with context-based auth
func HandleContextCustomaudience_get_shared_account_info(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_delete_users handles the customaudience_delete_users tool with context-based auth
func HandleContextCustomaudience_delete_users(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_post_users handles the customaudience_post_users tool with context-based auth
func HandleContextCustomaudience_post_users(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_post_usersreplace handles the customaudience_post_usersreplace tool with context-based auth
func HandleContextCustomaudience_post_usersreplace(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_delete_ handles the customaudience_delete_ tool with context-based auth
func HandleContextCustomaudience_delete_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_get_ handles the customaudience_get_ tool with context-based auth
func HandleContextCustomaudience_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
...
// HandleContextCustomaudience_post_ handles the customaudience_post_ tool with context-based auth
func HandleContextCustomaudience_post_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get access token from context
	accessToken, ok := shared.FacebookAccessTokenFromContext(ctx)
	if !ok {
		return mcp.NewToolResultError("Facebook access token not found in context"), nil
