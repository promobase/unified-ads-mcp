...
func GetAudioSubLabelTools() []mcp.Tool {
	...
	audiosublabel_get_Tool := mcp.NewTool("audiosublabel_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AudioSubLabel objects. Available fields: expiration_timestamp, flagged_timestamp, id, label_name, last_update_timestamp, num_audio_tracks, state"),
		),
