...
func GetAdsCreationSavedStateTools() []mcp.Tool {
	...
	adscreationsavedstate_get_Tool := mcp.NewTool("adscreationsavedstate_get_",
		...
		mcp.WithString("fields",
			mcp.Description("Comma-separated list of fields to return for AdsCreationSavedState objects. Available fields: ad_account, id, serialized_store_data, time_updated, user"),
		),
