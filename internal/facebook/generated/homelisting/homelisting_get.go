...
// ToolHomelisting_get returns the MCP tool definition for homelisting_get
func ToolHomelisting_get() mcp.Tool {
	...
	return mcp.NewTool("homelisting_get",
...
// HandleHomelisting_get handles the homelisting_get tool with context-based auth
func HandleHomelisting_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Homelisting_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute homelisting_get: %v", err)), nil
	}
...
// Homelisting_get performs GET  for HomeListing
func Homelisting_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
