...
// ToolHomelisting_get_override_details returns the MCP tool definition for homelisting_get_override_details
func ToolHomelisting_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("homelisting_get_override_details",
...
func HandleHomelisting_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Homelisting_get_override_details(accessToken, args)
	if err != nil {
...
func Homelisting_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
