...
// ToolHomelisting_get_videos_metadata returns the MCP tool definition for homelisting_get_videos_metadata
func ToolHomelisting_get_videos_metadata() mcp.Tool {
	// Available fields for DynamicVideoMetadata: id, tags, url, video

	return mcp.NewTool("homelisting_get_videos_metadata",
...
func HandleHomelisting_get_videos_metadata(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Homelisting_get_videos_metadata(accessToken, args)
	if err != nil {
...
func Homelisting_get_videos_metadata(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
