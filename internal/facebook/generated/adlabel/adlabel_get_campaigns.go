...
// ToolAdlabel_get_campaigns returns the MCP tool definition for adlabel_get_campaigns
func ToolAdlabel_get_campaigns() mcp.Tool {
	...
	return mcp.NewTool("adlabel_get_campaigns",
...
func HandleAdlabel_get_campaigns(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adlabel_get_campaigns(accessToken, args)
	if err != nil {
