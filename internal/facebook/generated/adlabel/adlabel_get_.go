...
// ToolAdlabel_get_ returns the MCP tool definition for adlabel_get_
func ToolAdlabel_get_() mcp.Tool {
	// Available fields for AdLabel: account, created_time, id, name, updated_time
	
	return mcp.NewTool("adlabel_get_",
...
func HandleAdlabel_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adlabel_get_(accessToken, args)
	if err != nil {
...
func Adlabel_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
