...
// ToolStorecatalogsettings_get_ returns the MCP tool definition for storecatalogsettings_get_
func ToolStorecatalogsettings_get_() mcp.Tool {
	// Available fields for StoreCatalogSettings: id, page

	return mcp.NewTool("storecatalogsettings_get_",
...
func HandleStorecatalogsettings_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Storecatalogsettings_get_(accessToken, args)
	if err != nil {
...
func Storecatalogsettings_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
