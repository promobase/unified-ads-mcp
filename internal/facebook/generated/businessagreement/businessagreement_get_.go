...
// ToolBusinessagreement_get_ returns the MCP tool definition for businessagreement_get_
func ToolBusinessagreement_get_() mcp.Tool {
	// Available fields for BusinessAgreement: id, request_status

	return mcp.NewTool("businessagreement_get_",
...
func HandleBusinessagreement_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessagreement_get_(accessToken, args)
	if err != nil {
...
func Businessagreement_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
