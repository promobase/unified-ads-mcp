...
// ad_set_list_ad_studiesArgs defines the typed arguments for ad_set_list_ad_studies
type ad_set_list_ad_studiesArgs struct {
	ID     string   `json:"id" jsonschema:"required,description=AdSet ID,pattern=^[0-9]+$"`
	Fields []string `json:"fields,omitempty" jsonschema:"description=Fields to return"`
	Limit  int      `json:"limit,omitempty" jsonschema:"description=Maximum number of results,minimum=1,maximum=100"`
	After  string   `json:"after,omitempty" jsonschema:"description=Cursor for pagination (next page)"`
...
// ad_set_get_delivery_estimateArgs defines the typed arguments for ad_set_get_delivery_estimate
type ad_set_get_delivery_estimateArgs struct {
	ID               string            `json:"id" jsonschema:"required,description=AdSet ID,pattern=^[0-9]+$"`
	Fields           []string          `json:"fields,omitempty" jsonschema:"description=Fields to return"`
	Limit            int               `json:"limit,omitempty" jsonschema:"description=Maximum number of results,minimum=1,maximum=100"`
	After            string            `json:"after,omitempty" jsonschema:"description=Cursor for pagination (next page)"`
...
// ad_set_get_insightsArgs defines the typed arguments for ad_set_get_insights
type ad_set_get_insightsArgs struct {
	ID                           string                   `json:"id" jsonschema:"required,description=AdSet ID,pattern=^[0-9]+$"`
	Fields                       []string                 `json:"fields,omitempty" jsonschema:"description=Fields to return"`
	Limit                        int                      `json:"limit,omitempty" jsonschema:"description=Maximum number of results,minimum=1,maximum=100"`
	After                        string                   `json:"after,omitempty" jsonschema:"description=Cursor for pagination (next page)"`
...
// ad_set_create_insights_reportArgs defines the typed arguments for ad_set_create_insights_report
type ad_set_create_insights_reportArgs struct {
	ID                           string                   `json:"id" jsonschema:"required,description=AdSet ID,pattern=^[0-9]+$"`
	ActionAttributionWindows     []string                 `json:"action_attribution_windows,omitempty" jsonschema:"description=Action Attribution Windows"`
	ActionBreakdowns             []string                 `json:"action_breakdowns,omitempty" jsonschema:"description=Action Breakdowns"`
	ActionReportTime             string                   `json:"action_report_time,omitempty" jsonschema:"description=Action Report Time"`
...
// ad_set_get_message_delivery_estimateArgs defines the typed arguments for ad_set_get_message_delivery_estimate
type ad_set_get_message_delivery_estimateArgs struct {
	Fields               []string          `json:"fields,omitempty" jsonschema:"description=Fields to return"`
	Limit                int               `json:"limit,omitempty" jsonschema:"description=Maximum number of results,minimum=1,maximum=100"`
	After                string            `json:"after,omitempty" jsonschema:"description=Cursor for pagination (next page)"`
	Before               string            `json:"before,omitempty" jsonschema:"description=Cursor for pagination (previous page)"`
...
// ad_set_list_targetingsentencelinesArgs defines the typed arguments for ad_set_list_targetingsentencelines
type ad_set_list_targetingsentencelinesArgs struct {
	ID     string   `json:"id" jsonschema:"required,description=AdSet ID,pattern=^[0-9]+$"`
	Fields []string `json:"fields,omitempty" jsonschema:"description=Fields to return"`
	Limit  int      `json:"limit,omitempty" jsonschema:"description=Maximum number of results,minimum=1,maximum=100"`
	After  string   `json:"after,omitempty" jsonschema:"description=Cursor for pagination (next page)"`
...
// ad_set_getArgs defines the typed arguments for ad_set_get
type ad_set_getArgs struct {
	ID          string                 `json:"id" jsonschema:"required,description=AdSet ID,pattern=^[0-9]+$"`
	Fields      []string               `json:"fields,omitempty" jsonschema:"description=Fields to return"`
	Limit       int                    `json:"limit,omitempty" jsonschema:"description=Maximum number of results,minimum=1,maximum=100"`
	After       string                 `json:"after,omitempty" jsonschema:"description=Cursor for pagination (next page)"`
...
// ad_set_updateArgs defines the typed arguments for ad_set_update
type ad_set_updateArgs struct {
	ID                                string                   `json:"id" jsonschema:"required,description=AdSet ID,pattern=^[0-9]+$"`
...
// AdSetListActivitiesHandler handles ad_set_list_activities with raw schema validation
func AdSetListActivitiesHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_list_activitiesArgs) (*mcp.CallToolResult, error) {
...
// AdSetListAdStudiesHandler handles ad_set_list_ad_studies with raw schema validation
func AdSetListAdStudiesHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_list_ad_studiesArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetListAdcreativesHandler handles ad_set_list_adcreatives with raw schema validation
func AdSetListAdcreativesHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_list_adcreativesArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetRemoveAdlabelsHandler handles ad_set_remove_adlabels with raw schema validation
func AdSetRemoveAdlabelsHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_remove_adlabelsArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetCreateAdlabelHandler handles ad_set_create_adlabel with raw schema validation
func AdSetCreateAdlabelHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_create_adlabelArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetGetAdrulesGovernedHandler handles ad_set_get_adrules_governed with raw schema validation
func AdSetGetAdrulesGovernedHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_get_adrules_governedArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetListAdsHandler handles ad_set_list_ads with raw schema validation
func AdSetListAdsHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_list_adsArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetListAsyncadrequestsHandler handles ad_set_list_asyncadrequests with raw schema validation
func AdSetListAsyncadrequestsHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_list_asyncadrequestsArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetCreateBudgetScheduleHandler handles ad_set_create_budget_schedule with raw schema validation
func AdSetCreateBudgetScheduleHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_create_budget_scheduleArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetListCopiesHandler handles ad_set_list_copies with raw schema validation
func AdSetListCopiesHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_list_copiesArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetCreateCopieHandler handles ad_set_create_copie with raw schema validation
func AdSetCreateCopieHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_create_copieArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetGetDeliveryEstimateHandler handles ad_set_get_delivery_estimate with raw schema validation
func AdSetGetDeliveryEstimateHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_get_delivery_estimateArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetGetInsightsHandler handles ad_set_get_insights with raw schema validation
func AdSetGetInsightsHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_get_insightsArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetCreateInsightsReportHandler handles ad_set_create_insights_report with raw schema validation
func AdSetCreateInsightsReportHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_create_insights_reportArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetGetMessageDeliveryEstimateHandler handles ad_set_get_message_delivery_estimate with raw schema validation
func AdSetGetMessageDeliveryEstimateHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_get_message_delivery_estimateArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetListTargetingsentencelinesHandler handles ad_set_list_targetingsentencelines with raw schema validation
func AdSetListTargetingsentencelinesHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_list_targetingsentencelinesArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetDeleteHandler handles ad_set_delete with raw schema validation
func AdSetDeleteHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_deleteArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetGetHandler handles ad_set_get with raw schema validation
func AdSetGetHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_getArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
// AdSetUpdateHandler handles ad_set_update with raw schema validation
func AdSetUpdateHandler(ctx context.Context, request mcp.CallToolRequest, args ad_set_updateArgs) (*mcp.CallToolResult, error) {
	// Arguments are explicitly passed as typed struct
...
func RegisterAdSetTools(s *server.MCPServer) error {
	...
	// Register ad_set_list_activities using raw JSON schema
	ad_set_list_activitiesTool := mcp.NewToolWithRawSchema(
	...
	s.AddTool(ad_set_list_activitiesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_list_activitiesArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetListActivitiesHandler(ctx, request, args)
	})

	// Register ad_set_list_ad_studies using raw JSON schema
	ad_set_list_ad_studiesTool := mcp.NewToolWithRawSchema(
		"ad_set_list_ad_studies",
	...
	s.AddTool(ad_set_list_ad_studiesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_list_ad_studiesArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetListAdStudiesHandler(ctx, request, args)
	})

	// Register ad_set_list_adcreatives using raw JSON schema
	ad_set_list_adcreativesTool := mcp.NewToolWithRawSchema(
		"ad_set_list_adcreatives",
		"List adcreatives for this AdSet Returns AdCreative.",
		json.RawMessage(`{"additionalProperties":false,"properties":{"after":{"description":"Cursor for pagination (next page)","type":"string"},"before":{"description":"Cursor for pagination (previous page)","type":"string"},"fields":{"description":"Fields to return","items":{"type":"string"},"type":"array"},"id":{"description":"AdSet ID","pattern":"^[0-9]+$","type":"string"},"limit":{"description":"Maximum number of results","maximum":100,"minimum":1,"type":"integer"}},"required":["id"],"type":"object"}`),
	)
	s.AddTool(ad_set_list_adcreativesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_list_adcreativesArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetListAdcreativesHandler(ctx, request, args)
	})

	// Register ad_set_remove_adlabels using raw JSON schema
	ad_set_remove_adlabelsTool := mcp.NewToolWithRawSchema(
	...
	s.AddTool(ad_set_remove_adlabelsTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_remove_adlabelsArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetRemoveAdlabelsHandler(ctx, request, args)
	})

	// Register ad_set_create_adlabel using raw JSON schema
	ad_set_create_adlabelTool := mcp.NewToolWithRawSchema(
		"ad_set_create_adlabel",
		"Associate adlabels with this AdSet Returns AdSet. Required: adlabels",
		json.RawMessage(`{"additionalProperties":false,"properties":{"adlabels":{"description":"Adlabels","items":{"additionalProperties":true,"type":"object"},"type":"array"},"execution_options":{"description":"Execution Options","items":{"type":"string"},"type":"array"},"id":{"description":"AdSet ID","pattern":"^[0-9]+$","type":"string"}},"required":["id","adlabels"],"type":"object"}`),
	)
	s.AddTool(ad_set_create_adlabelTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_create_adlabelArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetCreateAdlabelHandler(ctx, request, args)
	})

	// Register ad_set_get_adrules_governed using raw JSON schema
	ad_set_get_adrules_governedTool := mcp.NewToolWithRawSchema(
	...
	s.AddTool(ad_set_get_adrules_governedTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_get_adrules_governedArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetGetAdrulesGovernedHandler(ctx, request, args)
	})

	// Register ad_set_list_ads using raw JSON schema
	ad_set_list_adsTool := mcp.NewToolWithRawSchema(
		"ad_set_list_ads",
	...
	s.AddTool(ad_set_list_adsTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_list_adsArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetListAdsHandler(ctx, request, args)
	})

	// Register ad_set_list_asyncadrequests using raw JSON schema
	ad_set_list_asyncadrequestsTool := mcp.NewToolWithRawSchema(
	...
	s.AddTool(ad_set_list_asyncadrequestsTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_list_asyncadrequestsArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetListAsyncadrequestsHandler(ctx, request, args)
	})

	// Register ad_set_create_budget_schedule using raw JSON schema
	ad_set_create_budget_scheduleTool := mcp.NewToolWithRawSchema(
	...
	s.AddTool(ad_set_create_budget_scheduleTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_create_budget_scheduleArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetCreateBudgetScheduleHandler(ctx, request, args)
	})

	// Register ad_set_list_copies using raw JSON schema
	ad_set_list_copiesTool := mcp.NewToolWithRawSchema(
		"ad_set_list_copies",
	...
	s.AddTool(ad_set_list_copiesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_list_copiesArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetListCopiesHandler(ctx, request, args)
	})

	// Register ad_set_create_copie using raw JSON schema
	ad_set_create_copieTool := mcp.NewToolWithRawSchema(
		"ad_set_create_copie",
	...
	s.AddTool(ad_set_create_copieTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_create_copieArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetCreateCopieHandler(ctx, request, args)
	})

	// Register ad_set_get_delivery_estimate using raw JSON schema
	ad_set_get_delivery_estimateTool := mcp.NewToolWithRawSchema(
		"ad_set_get_delivery_estimate",
	...
	s.AddTool(ad_set_get_delivery_estimateTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_get_delivery_estimateArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetGetDeliveryEstimateHandler(ctx, request, args)
	})

	// Register ad_set_get_insights using raw JSON schema
	ad_set_get_insightsTool := mcp.NewToolWithRawSchema(
		"ad_set_get_insights",
	...
	s.AddTool(ad_set_get_insightsTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_get_insightsArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetGetInsightsHandler(ctx, request, args)
	})

	// Register ad_set_create_insights_report using raw JSON schema
	ad_set_create_insights_reportTool := mcp.NewToolWithRawSchema(
		"ad_set_create_insights_report",
	...
	s.AddTool(ad_set_create_insights_reportTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_create_insights_reportArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetCreateInsightsReportHandler(ctx, request, args)
	})

	// Register ad_set_get_message_delivery_estimate using raw JSON schema
	ad_set_get_message_delivery_estimateTool := mcp.NewToolWithRawSchema(
		"ad_set_get_message_delivery_estimate",
	...
	s.AddTool(ad_set_get_message_delivery_estimateTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_get_message_delivery_estimateArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetGetMessageDeliveryEstimateHandler(ctx, request, args)
	})

	// Register ad_set_list_targetingsentencelines using raw JSON schema
	ad_set_list_targetingsentencelinesTool := mcp.NewToolWithRawSchema(
		"ad_set_list_targetingsentencelines",
		"List targetingsentencelines for this AdSet Returns TargetingSentenceLine.",
		json.RawMessage(`{"additionalProperties":false,"properties":{"after":{"description":"Cursor for pagination (next page)","type":"string"},"before":{"description":"Cursor for pagination (previous page)","type":"string"},"fields":{"description":"Fields to return","items":{"type":"string"},"type":"array"},"id":{"description":"AdSet ID","pattern":"^[0-9]+$","type":"string"},"limit":{"description":"Maximum number of results","maximum":100,"minimum":1,"type":"integer"}},"required":["id"],"type":"object"}`),
	)
	s.AddTool(ad_set_list_targetingsentencelinesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_list_targetingsentencelinesArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetListTargetingsentencelinesHandler(ctx, request, args)
	})

	// Register ad_set_delete using raw JSON schema
	ad_set_deleteTool := mcp.NewToolWithRawSchema(
		"ad_set_delete",
		"Delete a AdSet",
	...
	s.AddTool(ad_set_deleteTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_deleteArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetDeleteHandler(ctx, request, args)
	})

	// Register ad_set_get using raw JSON schema
	ad_set_getTool := mcp.NewToolWithRawSchema(
		"ad_set_get",
	...
	s.AddTool(ad_set_getTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_getArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetGetHandler(ctx, request, args)
	})

	// Register ad_set_update using raw JSON schema
	ad_set_updateTool := mcp.NewToolWithRawSchema(
		"ad_set_update",
	...
	s.AddTool(ad_set_updateTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		// Parse arguments using the built-in type-safe binding
		var args ad_set_updateArgs
		if err := request.BindArguments(&args); err != nil {
			return mcp.NewToolResultError(fmt.Sprintf("Invalid arguments: %v", err)), nil
		}
		return AdSetUpdateHandler(ctx, request, args)
	})
