...
// ToolExtendedcredit_post_whatsapp_credit_attach returns the MCP tool definition for extendedcredit_post_whatsapp_credit_attach
func ToolExtendedcredit_post_whatsapp_credit_attach() mcp.Tool {
	
	// Params object accepts: waba_currency (string), waba_id (string)
	return mcp.NewTool("extendedcredit_post_whatsapp_credit_attach",
...
func HandleExtendedcredit_post_whatsapp_credit_attach(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Extendedcredit_post_whatsapp_credit_attach(accessToken, args)
	if err != nil {
