...
func TestExtendedcredit_post_extended_credit_invoice_groups_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/extended_credit_invoice_groups",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsExtendedcredit_post_extended_credit_invoice_groups(accessToken, tt.args, skipParams...)
...
func TestExtendedcredit_post_extended_credit_invoice_groups_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsExtendedcredit_post_extended_credit_invoice_groups(tt.args, skipParams...)
...
func buildBodyParamsExtendedcredit_post_extended_credit_invoice_groups(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsExtendedcredit_post_extended_credit_invoice_groups(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
