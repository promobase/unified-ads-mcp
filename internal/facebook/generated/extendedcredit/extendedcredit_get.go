...
// ToolExtendedcredit_get returns the MCP tool definition for extendedcredit_get
func ToolExtendedcredit_get() mcp.Tool {
	...
	return mcp.NewTool("extendedcredit_get",
...
// HandleExtendedcredit_get handles the extendedcredit_get tool with context-based auth
func HandleExtendedcredit_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Extendedcredit_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute extendedcredit_get: %v", err)), nil
	}
...
// Extendedcredit_get performs GET  for ExtendedCredit
func Extendedcredit_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
