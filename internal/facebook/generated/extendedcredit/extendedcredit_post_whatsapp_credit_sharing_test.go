...
func TestExtendedcredit_post_whatsapp_credit_sharing_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/whatsapp_credit_sharing",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsExtendedcredit_post_whatsapp_credit_sharing(accessToken, tt.args, skipParams...)
...
func TestExtendedcredit_post_whatsapp_credit_sharing_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsExtendedcredit_post_whatsapp_credit_sharing(tt.args, skipParams...)
...
func buildBodyParamsExtendedcredit_post_whatsapp_credit_sharing(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsExtendedcredit_post_whatsapp_credit_sharing(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
