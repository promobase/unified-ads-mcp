...
func TestExtendedcredit_get_owning_credit_allocation_configs_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsExtendedcredit_get_owning_credit_allocation_configs(accessToken, tt.args, skipParams...)
...
func buildURLParamsExtendedcredit_get_owning_credit_allocation_configs(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
