...
func TestExtendedcredit_get_extended_credit_invoice_groups_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsExtendedcredit_get_extended_credit_invoice_groups(accessToken, tt.args, skipParams...)
...
func buildURLParamsExtendedcredit_get_extended_credit_invoice_groups(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
