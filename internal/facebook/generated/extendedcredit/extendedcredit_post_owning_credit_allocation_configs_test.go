...
func TestExtendedcredit_post_owning_credit_allocation_configs_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/owning_credit_allocation_configs",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsExtendedcredit_post_owning_credit_allocation_configs(accessToken, tt.args, skipParams...)
...
func TestExtendedcredit_post_owning_credit_allocation_configs_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsExtendedcredit_post_owning_credit_allocation_configs(tt.args, skipParams...)
...
func buildBodyParamsExtendedcredit_post_owning_credit_allocation_configs(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsExtendedcredit_post_owning_credit_allocation_configs(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
