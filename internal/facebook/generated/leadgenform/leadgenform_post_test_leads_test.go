...
func TestLeadgenform_post_test_leads_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/test_leads",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsLeadgenform_post_test_leads(accessToken, tt.args, skipParams...)
...
func TestLeadgenform_post_test_leads_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsLeadgenform_post_test_leads(tt.args, skipParams...)
...
func buildBodyParamsLeadgenform_post_test_leads(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsLeadgenform_post_test_leads(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
