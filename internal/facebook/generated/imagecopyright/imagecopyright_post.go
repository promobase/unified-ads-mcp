...
// ToolImagecopyright_post returns the MCP tool definition for imagecopyright_post
func ToolImagecopyright_post() mcp.Tool {
	...
	return mcp.NewTool("imagecopyright_post",
...
// HandleImagecopyright_post handles the imagecopyright_post tool with context-based auth
func HandleImagecopyright_post(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Imagecopyright_post(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute imagecopyright_post: %v", err)), nil
	}
...
// Imagecopyright_post performs POST  for ImageCopyright
func Imagecopyright_post(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
