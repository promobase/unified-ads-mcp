...
func TestPagepostexperiment_get_video_insights_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/video_insights",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPagepostexperiment_get_video_insights(accessToken, tt.args, skipParams...)
...
func buildURLParamsPagepostexperiment_get_video_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
