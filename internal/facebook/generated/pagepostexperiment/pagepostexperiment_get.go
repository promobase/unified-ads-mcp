...
// ToolPagepostexperiment_get returns the MCP tool definition for pagepostexperiment_get
func ToolPagepostexperiment_get() mcp.Tool {
	...
	return mcp.NewTool("pagepostexperiment_get",
...
// HandlePagepostexperiment_get handles the pagepostexperiment_get tool with context-based auth
func HandlePagepostexperiment_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepostexperiment_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute pagepostexperiment_get: %v", err)), nil
	}
...
// Pagepostexperiment_get performs GET  for PagePostExperiment
func Pagepostexperiment_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
