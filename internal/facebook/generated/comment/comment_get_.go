...
// ToolComment_get_ returns the MCP tool definition for comment_get_
func ToolComment_get_() mcp.Tool {
	...
	return mcp.NewTool("comment_get_",
...
func HandleComment_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Comment_get_(accessToken, args)
	if err != nil {
...
func Comment_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
