...
// ToolComment_get_likes returns the MCP tool definition for comment_get_likes
func ToolComment_get_likes() mcp.Tool {
	// Available fields for Profile: can_post, id, link, name, pic, pic_crop, pic_large, pic_small, pic_square, profile_type, username

	return mcp.NewTool("comment_get_likes",
...
func HandleComment_get_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Comment_get_likes(accessToken, args)
	if err != nil {
...
func Comment_get_likes(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
