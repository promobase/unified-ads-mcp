...
// ToolComment_post_comments returns the MCP tool definition for comment_post_comments
func ToolComment_post_comments() mcp.Tool {
	...
	return mcp.NewTool("comment_post_comments",
...
func HandleComment_post_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Comment_post_comments(accessToken, args)
	if err != nil {
...
func Comment_post_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
