...
func TestComment_post_comments_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsComment_post_comments(accessToken, tt.args, skipParams...)
...
func TestComment_post_comments_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsComment_post_comments(tt.args, skipParams...)
...
func buildBodyParamsComment_post_comments(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsComment_post_comments(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
