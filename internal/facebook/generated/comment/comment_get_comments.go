...
// ToolComment_get_comments returns the MCP tool definition for comment_get_comments
func ToolComment_get_comments() mcp.Tool {
	...
	return mcp.NewTool("comment_get_comments",
...
func HandleComment_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Comment_get_comments(accessToken, args)
	if err != nil {
...
func Comment_get_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
