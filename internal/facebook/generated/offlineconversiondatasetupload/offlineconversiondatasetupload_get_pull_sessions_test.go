...
func TestOfflineconversiondatasetupload_get_pull_sessions_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/pull_sessions",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsOfflineconversiondatasetupload_get_pull_sessions(accessToken, tt.args, skipParams...)
...
func buildURLParamsOfflineconversiondatasetupload_get_pull_sessions(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
