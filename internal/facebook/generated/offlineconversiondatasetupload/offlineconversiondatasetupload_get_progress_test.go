...
func TestOfflineconversiondatasetupload_get_progress_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/progress",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsOfflineconversiondatasetupload_get_progress(accessToken, tt.args, skipParams...)
...
func buildURLParamsOfflineconversiondatasetupload_get_progress(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
