...
// ToolOfflineconversiondatasetupload_get_ returns the MCP tool definition for offlineconversiondatasetupload_get_
func ToolOfflineconversiondatasetupload_get_() mcp.Tool {
	...
	return mcp.NewTool("offlineconversiondatasetupload_get_",
...
func HandleOfflineconversiondatasetupload_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Offlineconversiondatasetupload_get_(accessToken, args)
	if err != nil {
...
func Offlineconversiondatasetupload_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
