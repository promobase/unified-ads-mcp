...
// ToolApplication_get_ios_dialog_configs returns the MCP tool definition for application_get_ios_dialog_configs
func ToolApplication_get_ios_dialog_configs() mcp.Tool {

	return mcp.NewTool("application_get_ios_dialog_configs",
...
func HandleApplication_get_ios_dialog_configs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_ios_dialog_configs(accessToken, args)
	if err != nil {
...
func Application_get_ios_dialog_configs(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string

	baseURL = FacebookGraphAPIBaseURL + "ios_dialog_configs"
