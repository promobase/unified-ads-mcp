...
// ToolApplication_get_android_dialog_configs returns the MCP tool definition for application_get_android_dialog_configs
func ToolApplication_get_android_dialog_configs() mcp.Tool {
	
	
	return mcp.NewTool("application_get_android_dialog_configs",
...
func HandleApplication_get_android_dialog_configs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_android_dialog_configs(accessToken, args)
	if err != nil {
