...
// ToolApplication_get_subscriptions returns the MCP tool definition for application_get_subscriptions
func ToolApplication_get_subscriptions() mcp.Tool {

	return mcp.NewTool("application_get_subscriptions",
...
func HandleApplication_get_subscriptions(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_subscriptions(accessToken, args)
	if err != nil {
...
func Application_get_subscriptions(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
