...
func TestApplication_get_subscribed_domains_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsApplication_get_subscribed_domains(accessToken, tt.args, skipParams...)
...
func buildURLParamsApplication_get_subscribed_domains(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
