...
// ToolApplication_get_subscribed_domains returns the MCP tool definition for application_get_subscribed_domains
func ToolApplication_get_subscribed_domains() mcp.Tool {

	return mcp.NewTool("application_get_subscribed_domains",
...
func HandleApplication_get_subscribed_domains(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_subscribed_domains(accessToken, args)
	if err != nil {
...
func Application_get_subscribed_domains(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
