...
// ToolApplication_get_adnetworkanalytics_results returns the MCP tool definition for application_get_adnetworkanalytics_results
func ToolApplication_get_adnetworkanalytics_results() mcp.Tool {
	...
	return mcp.NewTool("application_get_adnetworkanalytics_results",
...
func HandleApplication_get_adnetworkanalytics_results(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_adnetworkanalytics_results(accessToken, args)
	if err != nil {
