...
// ToolApplication_get_server_domain_infos returns the MCP tool definition for application_get_server_domain_infos
func ToolApplication_get_server_domain_infos() mcp.Tool {

	return mcp.NewTool("application_get_server_domain_infos",
...
func HandleApplication_get_server_domain_infos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_server_domain_infos(accessToken, args)
	if err != nil {
