...
// ToolApplication_get_app_event_types returns the MCP tool definition for application_get_app_event_types
func ToolApplication_get_app_event_types() mcp.Tool {

	return mcp.NewTool("application_get_app_event_types",
...
func HandleApplication_get_app_event_types(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_app_event_types(accessToken, args)
	if err != nil {
