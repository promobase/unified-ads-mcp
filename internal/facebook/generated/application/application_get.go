...
// ToolApplication_get returns the MCP tool definition for application_get
func ToolApplication_get() mcp.Tool {
	...
	return mcp.NewTool("application_get",
...
// HandleApplication_get handles the application_get tool with context-based auth
func HandleApplication_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute application_get: %v", err)), nil
	}
...
// Application_get performs GET  for Application
func Application_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
