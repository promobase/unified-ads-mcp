...
// ToolApplication_get_appassets returns the MCP tool definition for application_get_appassets
func ToolApplication_get_appassets() mcp.Tool {

	return mcp.NewTool("application_get_appassets",
...
func HandleApplication_get_appassets(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_appassets(accessToken, args)
	if err != nil {
