...
func TestApplication_get_aem_conversion_configs_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/aem_conversion_configs",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsApplication_get_aem_conversion_configs(accessToken, tt.args, skipParams...)
...
func buildURLParamsApplication_get_aem_conversion_configs(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
