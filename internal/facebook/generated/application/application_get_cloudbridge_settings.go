...
// ToolApplication_get_cloudbridge_settings returns the MCP tool definition for application_get_cloudbridge_settings
func ToolApplication_get_cloudbridge_settings() mcp.Tool {

	return mcp.NewTool("application_get_cloudbridge_settings",
...
func HandleApplication_get_cloudbridge_settings(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_cloudbridge_settings(accessToken, args)
	if err != nil {
