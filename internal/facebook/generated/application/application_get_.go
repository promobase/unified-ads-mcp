...
// ToolApplication_get_ returns the MCP tool definition for application_get_
func ToolApplication_get_() mcp.Tool {
	...
	return mcp.NewTool("application_get_",
...
func HandleApplication_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_(accessToken, args)
	if err != nil {
...
func Application_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
