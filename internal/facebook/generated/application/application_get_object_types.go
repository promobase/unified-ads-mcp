...
// ToolApplication_get_object_types returns the MCP tool definition for application_get_object_types
func ToolApplication_get_object_types() mcp.Tool {
	
	
	return mcp.NewTool("application_get_object_types",
...
func HandleApplication_get_object_types(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_object_types(accessToken, args)
	if err != nil {
