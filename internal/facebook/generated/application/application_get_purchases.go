...
// ToolApplication_get_purchases returns the MCP tool definition for application_get_purchases
func ToolApplication_get_purchases() mcp.Tool {

	return mcp.NewTool("application_get_purchases",
...
func HandleApplication_get_purchases(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_purchases(accessToken, args)
	if err != nil {
