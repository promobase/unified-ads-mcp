...
// ToolApplication_get_objects returns the MCP tool definition for application_get_objects
func ToolApplication_get_objects() mcp.Tool {

	return mcp.NewTool("application_get_objects",
...
func HandleApplication_get_objects(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_objects(accessToken, args)
	if err != nil {
...
func Application_get_objects(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string

	baseURL = FacebookGraphAPIBaseURL + "objects"
