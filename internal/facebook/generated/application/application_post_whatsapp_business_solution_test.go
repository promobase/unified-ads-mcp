...
func TestApplication_post_whatsapp_business_solution_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/whatsapp_business_solution",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsApplication_post_whatsapp_business_solution(accessToken, tt.args, skipParams...)
...
func TestApplication_post_whatsapp_business_solution_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsApplication_post_whatsapp_business_solution(tt.args, skipParams...)
...
func buildBodyParamsApplication_post_whatsapp_business_solution(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsApplication_post_whatsapp_business_solution(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
