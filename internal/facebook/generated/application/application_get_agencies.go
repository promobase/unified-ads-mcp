...
// ToolApplication_get_agencies returns the MCP tool definition for application_get_agencies
func ToolApplication_get_agencies() mcp.Tool {
	...
	return mcp.NewTool("application_get_agencies",
...
func HandleApplication_get_agencies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_agencies(accessToken, args)
	if err != nil {
...
func Application_get_agencies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
