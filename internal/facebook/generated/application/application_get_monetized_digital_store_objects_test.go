...
func TestApplication_get_monetized_digital_store_objects_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsApplication_get_monetized_digital_store_objects(accessToken, tt.args, skipParams...)
...
func buildURLParamsApplication_get_monetized_digital_store_objects(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
