...
// ToolApplication_get_roles returns the MCP tool definition for application_get_roles
func ToolApplication_get_roles() mcp.Tool {
	
	
	return mcp.NewTool("application_get_roles",
...
func HandleApplication_get_roles(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Application_get_roles(accessToken, args)
	if err != nil {
...
func Application_get_roles(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
