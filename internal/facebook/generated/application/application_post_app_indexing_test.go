...
func TestApplication_post_app_indexing_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/app_indexing",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsApplication_post_app_indexing(accessToken, tt.args, skipParams...)
...
func TestApplication_post_app_indexing_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsApplication_post_app_indexing(tt.args, skipParams...)
...
func buildBodyParamsApplication_post_app_indexing(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsApplication_post_app_indexing(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
