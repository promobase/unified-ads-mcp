...
func TestApplication_get_object_types_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/object_types",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsApplication_get_object_types(accessToken, tt.args, skipParams...)
...
func buildURLParamsApplication_get_object_types(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
