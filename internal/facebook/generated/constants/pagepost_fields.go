...
// PagePostFields contains field name constants for PagePost objects
...
// PagePostFieldsList contains all available fields for PagePost objects
var PagePostFieldsList = []string{
	"actions",
	"admin_creator",
