...
// AdsActionStatsFields contains field name constants for AdsActionStats objects
...
// AdsActionStatsFieldsList contains all available fields for AdsActionStats objects
var AdsActionStatsFieldsList = []string{
	"1d_click",
