...
// ToolVideocopyrightrule_get_ returns the MCP tool definition for videocopyrightrule_get_
func ToolVideocopyrightrule_get_() mcp.Tool {
	// Available fields for VideoCopyrightRule: condition_groups, copyrights, created_date, creator, id, is_in_migration, name

	return mcp.NewTool("videocopyrightrule_get_",
...
func HandleVideocopyrightrule_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Videocopyrightrule_get_(accessToken, args)
	if err != nil {
...
func Videocopyrightrule_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
