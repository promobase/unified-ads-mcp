...
// ToolExtendedcreditinvoicegroup_get_ad_accounts returns the MCP tool definition for extendedcreditinvoicegroup_get_ad_accounts
func ToolExtendedcreditinvoicegroup_get_ad_accounts() mcp.Tool {
	...
	return mcp.NewTool("extendedcreditinvoicegroup_get_ad_accounts",
...
func HandleExtendedcreditinvoicegroup_get_ad_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Extendedcreditinvoicegroup_get_ad_accounts(accessToken, args)
	if err != nil {
...
func Extendedcreditinvoicegroup_get_ad_accounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
