...
func TestExtendedcreditinvoicegroup_get_ad_accounts_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsExtendedcreditinvoicegroup_get_ad_accounts(accessToken, tt.args, skipParams...)
...
func buildURLParamsExtendedcreditinvoicegroup_get_ad_accounts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
