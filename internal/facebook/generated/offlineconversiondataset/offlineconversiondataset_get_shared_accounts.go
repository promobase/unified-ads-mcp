...
// ToolOfflineconversiondataset_get_shared_accounts returns the MCP tool definition for offlineconversiondataset_get_shared_accounts
func ToolOfflineconversiondataset_get_shared_accounts() mcp.Tool {
	...
	return mcp.NewTool("offlineconversiondataset_get_shared_accounts",
...
func HandleOfflineconversiondataset_get_shared_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Offlineconversiondataset_get_shared_accounts(accessToken, args)
	if err != nil {
