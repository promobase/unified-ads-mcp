...
// ToolOfflineconversiondataset_get_agencies returns the MCP tool definition for offlineconversiondataset_get_agencies
func ToolOfflineconversiondataset_get_agencies() mcp.Tool {
	...
	return mcp.NewTool("offlineconversiondataset_get_agencies",
...
func HandleOfflineconversiondataset_get_agencies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Offlineconversiondataset_get_agencies(accessToken, args)
	if err != nil {
...
func Offlineconversiondataset_get_agencies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
