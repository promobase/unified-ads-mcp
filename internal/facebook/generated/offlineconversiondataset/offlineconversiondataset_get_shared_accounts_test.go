...
func TestOfflineconversiondataset_get_shared_accounts_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsOfflineconversiondataset_get_shared_accounts(accessToken, tt.args, skipParams...)
...
func buildURLParamsOfflineconversiondataset_get_shared_accounts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
