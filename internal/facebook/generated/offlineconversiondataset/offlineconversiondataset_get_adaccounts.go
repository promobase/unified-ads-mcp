...
// ToolOfflineconversiondataset_get_adaccounts returns the MCP tool definition for offlineconversiondataset_get_adaccounts
func ToolOfflineconversiondataset_get_adaccounts() mcp.Tool {
	...
	return mcp.NewTool("offlineconversiondataset_get_adaccounts",
...
func Offlineconversiondataset_get_adaccounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
