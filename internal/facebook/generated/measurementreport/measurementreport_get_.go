...
// ToolMeasurementreport_get_ returns the MCP tool definition for measurementreport_get_
func ToolMeasurementreport_get_() mcp.Tool {
	// Available fields for MeasurementReport: download_urls, id, metadata, report_type, status

	return mcp.NewTool("measurementreport_get_",
...
func HandleMeasurementreport_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Measurementreport_get_(accessToken, args)
	if err != nil {
...
// Measurementreport_get_ performs GET  for MeasurementReport
func Measurementreport_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
