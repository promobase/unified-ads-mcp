...
// ToolInstagramuser_get_ returns the MCP tool definition for instagramuser_get_
func ToolInstagramuser_get_() mcp.Tool {
	...
	return mcp.NewTool("instagramuser_get_",
...
func HandleInstagramuser_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Instagramuser_get_(accessToken, args)
	if err != nil {
...
func Instagramuser_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
