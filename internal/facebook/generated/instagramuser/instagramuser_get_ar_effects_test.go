...
func TestInstagramuser_get_ar_effects_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/ar_effects",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsInstagramuser_get_ar_effects(accessToken, tt.args, skipParams...)
...
func buildURLParamsInstagramuser_get_ar_effects(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
