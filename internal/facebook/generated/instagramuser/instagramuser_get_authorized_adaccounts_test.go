...
func TestInstagramuser_get_authorized_adaccounts_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsInstagramuser_get_authorized_adaccounts(accessToken, tt.args, skipParams...)
...
func buildURLParamsInstagramuser_get_authorized_adaccounts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
