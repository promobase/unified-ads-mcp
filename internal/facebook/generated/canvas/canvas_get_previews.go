...
// ToolCanvas_get_previews returns the MCP tool definition for canvas_get_previews
func ToolCanvas_get_previews() mcp.Tool {
	// Available fields for TextWithEntities: text
	// Params object accepts: user_ids (list<int>)
	return mcp.NewTool("canvas_get_previews",
...
func HandleCanvas_get_previews(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Canvas_get_previews(accessToken, args)
	if err != nil {
...
// Canvas_get_previews performs GET previews for Canvas
