...
// ToolProductdeliverypreference_get_ returns the MCP tool definition for productdeliverypreference_get_
func ToolProductdeliverypreference_get_() mcp.Tool {
	// Available fields for ProductDeliveryPreference: ad_object_id, id, product_priority, product_priority_category

	return mcp.NewTool("productdeliverypreference_get_",
...
func HandleProductdeliverypreference_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productdeliverypreference_get_(accessToken, args)
	if err != nil {
...
// Productdeliverypreference_get_ performs GET  for ProductDeliveryPreference
func Productdeliverypreference_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
