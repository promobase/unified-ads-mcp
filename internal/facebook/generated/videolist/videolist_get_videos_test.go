...
func TestVideolist_get_videos_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsVideolist_get_videos(accessToken, tt.args, skipParams...)
...
func buildURLParamsVideolist_get_videos(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
