...
// ToolPagepost_get returns the MCP tool definition for pagepost_get
func ToolPagepost_get() mcp.Tool {
	...
	return mcp.NewTool("pagepost_get",
...
// HandlePagepost_get handles the pagepost_get tool with context-based auth
func HandlePagepost_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepost_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute pagepost_get: %v", err)), nil
	}
...
// Pagepost_get performs GET  for PagePost
func Pagepost_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
