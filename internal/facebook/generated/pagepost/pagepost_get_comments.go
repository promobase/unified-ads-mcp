...
// ToolPagepost_get_comments returns the MCP tool definition for pagepost_get_comments
func ToolPagepost_get_comments() mcp.Tool {
	...
	return mcp.NewTool("pagepost_get_comments",
...
func HandlePagepost_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepost_get_comments(accessToken, args)
	if err != nil {
...
func Pagepost_get_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
