...
// ToolPagepost_get_insights returns the MCP tool definition for pagepost_get_insights
func ToolPagepost_get_insights() mcp.Tool {
	...
	return mcp.NewTool("pagepost_get_insights",
...
func HandlePagepost_get_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepost_get_insights(accessToken, args)
	if err != nil {
...
func Pagepost_get_insights(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
