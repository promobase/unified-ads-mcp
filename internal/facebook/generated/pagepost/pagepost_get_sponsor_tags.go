...
// ToolPagepost_get_sponsor_tags returns the MCP tool definition for pagepost_get_sponsor_tags
func ToolPagepost_get_sponsor_tags() mcp.Tool {
	...
	return mcp.NewTool("pagepost_get_sponsor_tags",
...
func HandlePagepost_get_sponsor_tags(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepost_get_sponsor_tags(accessToken, args)
	if err != nil {
...
func Pagepost_get_sponsor_tags(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
