...
func TestPagepost_get_dynamic_posts_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/dynamic_posts",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPagepost_get_dynamic_posts(accessToken, tt.args, skipParams...)
...
func buildURLParamsPagepost_get_dynamic_posts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
