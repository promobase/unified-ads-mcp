...
// ToolPagepost_get_likes returns the MCP tool definition for pagepost_get_likes
func ToolPagepost_get_likes() mcp.Tool {
	// Available fields for Profile: can_post, id, link, name, pic, pic_crop, pic_large, pic_small, pic_square, profile_type, username

	return mcp.NewTool("pagepost_get_likes",
...
func HandlePagepost_get_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepost_get_likes(accessToken, args)
	if err != nil {
...
func Pagepost_get_likes(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
