...
// ToolPagepost_post returns the MCP tool definition for pagepost_post
func ToolPagepost_post() mcp.Tool {
	...
	return mcp.NewTool("pagepost_post",
...
// HandlePagepost_post handles the pagepost_post tool with context-based auth
func HandlePagepost_post(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepost_post(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute pagepost_post: %v", err)), nil
	}
...
// Pagepost_post performs POST  for PagePost
func Pagepost_post(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
