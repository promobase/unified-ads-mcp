...
// ToolPagepost_get_to returns the MCP tool definition for pagepost_get_to
func ToolPagepost_get_to() mcp.Tool {
	// Available fields for Profile: can_post, id, link, name, pic, pic_crop, pic_large, pic_small, pic_square, profile_type, username
	
	return mcp.NewTool("pagepost_get_to",
...
func HandlePagepost_get_to(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagepost_get_to(accessToken, args)
	if err != nil {
...
func Pagepost_get_to(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
