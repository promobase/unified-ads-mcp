...
// ToolSystemuser_get_assigned_pages returns the MCP tool definition for systemuser_get_assigned_pages
func ToolSystemuser_get_assigned_pages() mcp.Tool {
	...
	return mcp.NewTool("systemuser_get_assigned_pages",
...
func HandleSystemuser_get_assigned_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Systemuser_get_assigned_pages(accessToken, args)
	if err != nil {
