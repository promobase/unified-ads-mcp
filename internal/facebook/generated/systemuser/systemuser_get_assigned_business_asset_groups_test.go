...
func TestSystemuser_get_assigned_business_asset_groups_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsSystemuser_get_assigned_business_asset_groups(accessToken, tt.args, skipParams...)
...
func buildURLParamsSystemuser_get_assigned_business_asset_groups(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
