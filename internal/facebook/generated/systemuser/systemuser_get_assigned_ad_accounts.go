...
// ToolSystemuser_get_assigned_ad_accounts returns the MCP tool definition for systemuser_get_assigned_ad_accounts
func ToolSystemuser_get_assigned_ad_accounts() mcp.Tool {
	...
	return mcp.NewTool("systemuser_get_assigned_ad_accounts",
...
func HandleSystemuser_get_assigned_ad_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Systemuser_get_assigned_ad_accounts(accessToken, args)
	if err != nil {
