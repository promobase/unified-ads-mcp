...
func TestProductfeeduploaderror_get_suggested_rules_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/suggested_rules",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductfeeduploaderror_get_suggested_rules(accessToken, tt.args, skipParams...)
...
func buildURLParamsProductfeeduploaderror_get_suggested_rules(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
