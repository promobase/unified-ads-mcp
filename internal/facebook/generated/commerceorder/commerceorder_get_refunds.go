...
// ToolCommerceorder_get_refunds returns the MCP tool definition for commerceorder_get_refunds
func ToolCommerceorder_get_refunds() mcp.Tool {

	return mcp.NewTool("commerceorder_get_refunds",
...
func HandleCommerceorder_get_refunds(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Commerceorder_get_refunds(accessToken, args)
	if err != nil {
...
func Commerceorder_get_refunds(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
