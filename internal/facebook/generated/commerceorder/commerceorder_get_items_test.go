...
func TestCommerceorder_get_items_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommerceorder_get_items(accessToken, tt.args, skipParams...)
...
func buildURLParamsCommerceorder_get_items(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
