...
func TestCommerceorder_get_shipments_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommerceorder_get_shipments(accessToken, tt.args, skipParams...)
...
func buildURLParamsCommerceorder_get_shipments(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
