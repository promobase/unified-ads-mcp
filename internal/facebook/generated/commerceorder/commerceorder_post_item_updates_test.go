...
func TestCommerceorder_post_item_updates_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/item_updates",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommerceorder_post_item_updates(accessToken, tt.args, skipParams...)
...
func TestCommerceorder_post_item_updates_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCommerceorder_post_item_updates(tt.args, skipParams...)
...
func buildBodyParamsCommerceorder_post_item_updates(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCommerceorder_post_item_updates(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
