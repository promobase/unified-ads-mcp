...
func TestCommerceorder_post_returns_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/returns",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommerceorder_post_returns(accessToken, tt.args, skipParams...)
...
func TestCommerceorder_post_returns_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCommerceorder_post_returns(tt.args, skipParams...)
...
func buildBodyParamsCommerceorder_post_returns(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCommerceorder_post_returns(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
