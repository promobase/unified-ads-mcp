...
// ToolCloudgame_get returns the MCP tool definition for cloudgame_get
func ToolCloudgame_get() mcp.Tool {
	...
	return mcp.NewTool("cloudgame_get",
...
// HandleCloudgame_get handles the cloudgame_get tool with context-based auth
func HandleCloudgame_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Cloudgame_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute cloudgame_get: %v", err)), nil
	}
...
// Cloudgame_get performs GET  for CloudGame
func Cloudgame_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
