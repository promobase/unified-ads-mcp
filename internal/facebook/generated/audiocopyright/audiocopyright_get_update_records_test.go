...
func TestAudiocopyright_get_update_records_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAudiocopyright_get_update_records(accessToken, tt.args, skipParams...)
...
func buildURLParamsAudiocopyright_get_update_records(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
