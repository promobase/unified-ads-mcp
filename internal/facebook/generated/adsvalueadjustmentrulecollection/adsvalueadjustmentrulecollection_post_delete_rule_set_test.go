...
func TestAdsvalueadjustmentrulecollection_post_delete_rule_set_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/delete_rule_set",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdsvalueadjustmentrulecollection_post_delete_rule_set(accessToken, tt.args, skipParams...)
...
func TestAdsvalueadjustmentrulecollection_post_delete_rule_set_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdsvalueadjustmentrulecollection_post_delete_rule_set(tt.args, skipParams...)
...
func buildBodyParamsAdsvalueadjustmentrulecollection_post_delete_rule_set(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdsvalueadjustmentrulecollection_post_delete_rule_set(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
