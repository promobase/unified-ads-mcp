...
func TestAdsvalueadjustmentrulecollection_get_rules_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdsvalueadjustmentrulecollection_get_rules(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdsvalueadjustmentrulecollection_get_rules(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
