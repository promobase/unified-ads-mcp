...
func TestIguserexportforcam_get_branded_content_media_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/branded_content_media",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguserexportforcam_get_branded_content_media(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguserexportforcam_get_branded_content_media(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
