...
// ToolIguserexportforcam_get_recent_media returns the MCP tool definition for iguserexportforcam_get_recent_media
func ToolIguserexportforcam_get_recent_media() mcp.Tool {

	return mcp.NewTool("iguserexportforcam_get_recent_media",
...
func HandleIguserexportforcam_get_recent_media(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguserexportforcam_get_recent_media(accessToken, args)
	if err != nil {
