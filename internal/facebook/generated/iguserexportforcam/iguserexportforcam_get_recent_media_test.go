...
func TestIguserexportforcam_get_recent_media_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguserexportforcam_get_recent_media(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguserexportforcam_get_recent_media(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
