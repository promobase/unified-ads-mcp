...
// ToolIguserexportforcam_get_ returns the MCP tool definition for iguserexportforcam_get_
func ToolIguserexportforcam_get_() mcp.Tool {
	...
	return mcp.NewTool("iguserexportforcam_get_",
...
func HandleIguserexportforcam_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguserexportforcam_get_(accessToken, args)
	if err != nil {
...
func Iguserexportforcam_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
