...
// ToolAdspixel_get_shared_agencies returns the MCP tool definition for adspixel_get_shared_agencies
func ToolAdspixel_get_shared_agencies() mcp.Tool {
	...
	return mcp.NewTool("adspixel_get_shared_agencies",
...
func HandleAdspixel_get_shared_agencies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adspixel_get_shared_agencies(accessToken, args)
	if err != nil {
