...
// ToolAdspixel_get_agencies returns the MCP tool definition for adspixel_get_agencies
func ToolAdspixel_get_agencies() mcp.Tool {
	...
	return mcp.NewTool("adspixel_get_agencies",
...
func HandleAdspixel_get_agencies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adspixel_get_agencies(accessToken, args)
	if err != nil {
...
func Adspixel_get_agencies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
