...
// ToolAdspixel_get returns the MCP tool definition for adspixel_get
func ToolAdspixel_get() mcp.Tool {
	...
	return mcp.NewTool("adspixel_get",
...
// HandleAdspixel_get handles the adspixel_get tool with context-based auth
func HandleAdspixel_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adspixel_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute adspixel_get: %v", err)), nil
	}
...
// Adspixel_get performs GET  for AdsPixel
func Adspixel_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
