...
func TestAdspixel_get_da_checks_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdspixel_get_da_checks(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdspixel_get_da_checks(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
