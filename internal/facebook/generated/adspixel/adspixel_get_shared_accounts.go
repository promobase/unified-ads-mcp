...
// ToolAdspixel_get_shared_accounts returns the MCP tool definition for adspixel_get_shared_accounts
func ToolAdspixel_get_shared_accounts() mcp.Tool {
	...
	return mcp.NewTool("adspixel_get_shared_accounts",
...
func HandleAdspixel_get_shared_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adspixel_get_shared_accounts(accessToken, args)
	if err != nil {
