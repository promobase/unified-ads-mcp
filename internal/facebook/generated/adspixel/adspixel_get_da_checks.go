...
// ToolAdspixel_get_da_checks returns the MCP tool definition for adspixel_get_da_checks
func ToolAdspixel_get_da_checks() mcp.Tool {
	...
	return mcp.NewTool("adspixel_get_da_checks",
...
func HandleAdspixel_get_da_checks(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adspixel_get_da_checks(accessToken, args)
	if err != nil {
...
func Adspixel_get_da_checks(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
