...
func TestAdspixel_get_offline_event_uploads_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/offline_event_uploads",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdspixel_get_offline_event_uploads(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdspixel_get_offline_event_uploads(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
