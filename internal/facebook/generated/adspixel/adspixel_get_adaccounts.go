...
// ToolAdspixel_get_adaccounts returns the MCP tool definition for adspixel_get_adaccounts
func ToolAdspixel_get_adaccounts() mcp.Tool {
	...
	return mcp.NewTool("adspixel_get_adaccounts",
...
func HandleAdspixel_get_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adspixel_get_adaccounts(accessToken, args)
	if err != nil {
...
func Adspixel_get_adaccounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
