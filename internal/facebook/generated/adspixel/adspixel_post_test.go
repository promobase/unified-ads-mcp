...
func TestAdspixel_post_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdspixel_post(accessToken, tt.args, skipParams...)
...
func TestAdspixel_post_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdspixel_post(tt.args, skipParams...)
...
func buildBodyParamsAdspixel_post(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdspixel_post(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
