...
// ToolDynamicvideometadata_get_ returns the MCP tool definition for dynamicvideometadata_get_
func ToolDynamicvideometadata_get_() mcp.Tool {
	// Available fields for DynamicVideoMetadata: id, tags, url, video

	return mcp.NewTool("dynamicvideometadata_get_",
...
func HandleDynamicvideometadata_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Dynamicvideometadata_get_(accessToken, args)
	if err != nil {
...
func Dynamicvideometadata_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
