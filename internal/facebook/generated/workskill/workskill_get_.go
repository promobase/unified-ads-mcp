...
// ToolWorkskill_get_ returns the MCP tool definition for workskill_get_
func ToolWorkskill_get_() mcp.Tool {
	// Available fields for WorkSkill: id, name

	return mcp.NewTool("workskill_get_",
...
func HandleWorkskill_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Workskill_get_(accessToken, args)
	if err != nil {
...
func Workskill_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
