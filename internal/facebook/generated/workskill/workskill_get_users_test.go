...
func TestWorkskill_get_users_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWorkskill_get_users(accessToken, tt.args, skipParams...)
...
func buildURLParamsWorkskill_get_users(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
