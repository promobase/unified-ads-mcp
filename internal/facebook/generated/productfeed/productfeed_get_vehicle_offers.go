...
// ToolProductfeed_get_vehicle_offers returns the MCP tool definition for productfeed_get_vehicle_offers
func ToolProductfeed_get_vehicle_offers() mcp.Tool {
	...
	return mcp.NewTool("productfeed_get_vehicle_offers",
