...
// ToolProductfeed_get_flights returns the MCP tool definition for productfeed_get_flights
func ToolProductfeed_get_flights() mcp.Tool {
	...
	return mcp.NewTool("productfeed_get_flights",
...
func HandleProductfeed_get_flights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productfeed_get_flights(accessToken, args)
	if err != nil {
...
func Productfeed_get_flights(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
