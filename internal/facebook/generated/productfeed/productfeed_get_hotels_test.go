...
func TestProductfeed_get_hotels_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductfeed_get_hotels(accessToken, tt.args, skipParams...)
...
func buildURLParamsProductfeed_get_hotels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
