...
// ToolProductfeed_get_home_listings returns the MCP tool definition for productfeed_get_home_listings
func ToolProductfeed_get_home_listings() mcp.Tool {
	...
	return mcp.NewTool("productfeed_get_home_listings",
...
func HandleProductfeed_get_home_listings(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productfeed_get_home_listings(accessToken, args)
	if err != nil {
...
func Productfeed_get_home_listings(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
