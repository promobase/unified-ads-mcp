...
// ToolProductfeed_get_products returns the MCP tool definition for productfeed_get_products
func ToolProductfeed_get_products() mcp.Tool {
	...
	return mcp.NewTool("productfeed_get_products",
...
func HandleProductfeed_get_products(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productfeed_get_products(accessToken, args)
	if err != nil {
