...
// ToolProductfeed_get_media_titles returns the MCP tool definition for productfeed_get_media_titles
func ToolProductfeed_get_media_titles() mcp.Tool {
	...
	return mcp.NewTool("productfeed_get_media_titles",
...
func HandleProductfeed_get_media_titles(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productfeed_get_media_titles(accessToken, args)
	if err != nil {
...
func Productfeed_get_media_titles(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
