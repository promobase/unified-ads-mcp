...
func TestProductfeed_post_supplementary_feed_assocs_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/supplementary_feed_assocs",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductfeed_post_supplementary_feed_assocs(accessToken, tt.args, skipParams...)
...
func TestProductfeed_post_supplementary_feed_assocs_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsProductfeed_post_supplementary_feed_assocs(tt.args, skipParams...)
...
func buildBodyParamsProductfeed_post_supplementary_feed_assocs(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsProductfeed_post_supplementary_feed_assocs(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
