...
// ToolProductfeed_get_destinations returns the MCP tool definition for productfeed_get_destinations
func ToolProductfeed_get_destinations() mcp.Tool {
	...
	return mcp.NewTool("productfeed_get_destinations",
...
func HandleProductfeed_get_destinations(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productfeed_get_destinations(accessToken, args)
	if err != nil {
