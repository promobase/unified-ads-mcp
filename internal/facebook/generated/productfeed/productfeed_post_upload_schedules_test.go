...
func TestProductfeed_post_upload_schedules_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/upload_schedules",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductfeed_post_upload_schedules(accessToken, tt.args, skipParams...)
...
func TestProductfeed_post_upload_schedules_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsProductfeed_post_upload_schedules(tt.args, skipParams...)
...
func buildBodyParamsProductfeed_post_upload_schedules(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsProductfeed_post_upload_schedules(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
