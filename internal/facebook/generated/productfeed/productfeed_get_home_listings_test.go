...
func TestProductfeed_get_home_listings_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductfeed_get_home_listings(accessToken, tt.args, skipParams...)
...
func buildURLParamsProductfeed_get_home_listings(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
