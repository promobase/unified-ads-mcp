...
// ToolProductfeed_get_hotels returns the MCP tool definition for productfeed_get_hotels
func ToolProductfeed_get_hotels() mcp.Tool {
	...
	return mcp.NewTool("productfeed_get_hotels",
...
func HandleProductfeed_get_hotels(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productfeed_get_hotels(accessToken, args)
	if err != nil {
...
func Productfeed_get_hotels(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
