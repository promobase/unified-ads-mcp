...
// ToolFavoritecatalog_get_ returns the MCP tool definition for favoritecatalog_get_
func ToolFavoritecatalog_get_() mcp.Tool {
	// Available fields for FavoriteCatalog: catalog, id

	return mcp.NewTool("favoritecatalog_get_",
...
func HandleFavoritecatalog_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Favoritecatalog_get_(accessToken, args)
	if err != nil {
...
// Favoritecatalog_get_ performs GET  for FavoriteCatalog
func Favoritecatalog_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
