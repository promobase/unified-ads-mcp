...
// ToolMediacopyrightupdaterecord_get_ returns the MCP tool definition for mediacopyrightupdaterecord_get_
func ToolMediacopyrightupdaterecord_get_() mcp.Tool {
	...
	return mcp.NewTool("mediacopyrightupdaterecord_get_",
...
func HandleMediacopyrightupdaterecord_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Mediacopyrightupdaterecord_get_(accessToken, args)
	if err != nil {
...
func Mediacopyrightupdaterecord_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
