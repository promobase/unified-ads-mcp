...
// ToolHotelroom_get_ returns the MCP tool definition for hotelroom_get_
func ToolHotelroom_get_() mcp.Tool {
	...
	return mcp.NewTool("hotelroom_get_",
...
func HandleHotelroom_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Hotelroom_get_(accessToken, args)
	if err != nil {
...
func Hotelroom_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
