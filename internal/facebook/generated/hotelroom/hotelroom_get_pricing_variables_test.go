...
func TestHotelroom_get_pricing_variables_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/pricing_variables",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsHotelroom_get_pricing_variables(accessToken, tt.args, skipParams...)
...
func buildURLParamsHotelroom_get_pricing_variables(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
