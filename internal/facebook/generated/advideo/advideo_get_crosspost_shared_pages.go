...
// ToolAdvideo_get_crosspost_shared_pages returns the MCP tool definition for advideo_get_crosspost_shared_pages
func ToolAdvideo_get_crosspost_shared_pages() mcp.Tool {
	...
	return mcp.NewTool("advideo_get_crosspost_shared_pages",
...
func HandleAdvideo_get_crosspost_shared_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Advideo_get_crosspost_shared_pages(accessToken, args)
	if err != nil {
