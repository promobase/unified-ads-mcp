...
// ToolAdvideo_get_comments returns the MCP tool definition for advideo_get_comments
func ToolAdvideo_get_comments() mcp.Tool {
	...
	return mcp.NewTool("advideo_get_comments",
...
func HandleAdvideo_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Advideo_get_comments(accessToken, args)
	if err != nil {
