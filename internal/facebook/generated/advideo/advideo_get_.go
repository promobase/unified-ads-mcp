...
// ToolAdvideo_get_ returns the MCP tool definition for advideo_get_
func ToolAdvideo_get_() mcp.Tool {
	...
	return mcp.NewTool("advideo_get_",
...
func HandleAdvideo_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Advideo_get_(accessToken, args)
	if err != nil {
...
func Advideo_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
