...
// ToolAdvideo_post_comments returns the MCP tool definition for advideo_post_comments
func ToolAdvideo_post_comments() mcp.Tool {
	...
	return mcp.NewTool("advideo_post_comments",
...
func HandleAdvideo_post_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Advideo_post_comments(accessToken, args)
	if err != nil {
...
func Advideo_post_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
