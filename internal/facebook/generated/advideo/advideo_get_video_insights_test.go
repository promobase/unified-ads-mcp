...
func TestAdvideo_get_video_insights_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdvideo_get_video_insights(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdvideo_get_video_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
