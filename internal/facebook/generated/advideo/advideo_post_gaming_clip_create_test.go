...
func TestAdvideo_post_gaming_clip_create_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/gaming_clip_create",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdvideo_post_gaming_clip_create(accessToken, tt.args, skipParams...)
...
func TestAdvideo_post_gaming_clip_create_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdvideo_post_gaming_clip_create(tt.args, skipParams...)
...
func buildBodyParamsAdvideo_post_gaming_clip_create(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdvideo_post_gaming_clip_create(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
