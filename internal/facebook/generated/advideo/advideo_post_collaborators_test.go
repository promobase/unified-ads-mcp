...
func TestAdvideo_post_collaborators_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/collaborators",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdvideo_post_collaborators(accessToken, tt.args, skipParams...)
...
func TestAdvideo_post_collaborators_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdvideo_post_collaborators(tt.args, skipParams...)
...
func buildBodyParamsAdvideo_post_collaborators(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdvideo_post_collaborators(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
