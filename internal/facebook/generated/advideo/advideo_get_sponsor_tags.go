...
// ToolAdvideo_get_sponsor_tags returns the MCP tool definition for advideo_get_sponsor_tags
func ToolAdvideo_get_sponsor_tags() mcp.Tool {
	...
	return mcp.NewTool("advideo_get_sponsor_tags",
...
func HandleAdvideo_get_sponsor_tags(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Advideo_get_sponsor_tags(accessToken, args)
	if err != nil {
...
func Advideo_get_sponsor_tags(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
