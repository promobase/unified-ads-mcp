...
// ToolPlayablecontent_get_ returns the MCP tool definition for playablecontent_get_
func ToolPlayablecontent_get_() mcp.Tool {
	// Available fields for PlayableContent: id, name, owner

	return mcp.NewTool("playablecontent_get_",
...
func HandlePlayablecontent_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Playablecontent_get_(accessToken, args)
	if err != nil {
...
func Playablecontent_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
