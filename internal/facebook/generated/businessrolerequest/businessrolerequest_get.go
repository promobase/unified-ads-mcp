...
// ToolBusinessrolerequest_get returns the MCP tool definition for businessrolerequest_get
func ToolBusinessrolerequest_get() mcp.Tool {
	...
	return mcp.NewTool("businessrolerequest_get",
...
// HandleBusinessrolerequest_get handles the businessrolerequest_get tool with context-based auth
func HandleBusinessrolerequest_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessrolerequest_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute businessrolerequest_get: %v", err)), nil
	}
...
// Businessrolerequest_get performs GET  for BusinessRoleRequest
func Businessrolerequest_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
