...
// ToolBusiness_get_owned_ad_accounts returns the MCP tool definition for business_get_owned_ad_accounts
func ToolBusiness_get_owned_ad_accounts() mcp.Tool {
	...
	return mcp.NewTool("business_get_owned_ad_accounts",
...
func HandleBusiness_get_owned_ad_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_owned_ad_accounts(accessToken, args)
	if err != nil {
...
func Business_get_owned_ad_accounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
