...
// ToolBusiness_get_owned_pages returns the MCP tool definition for business_get_owned_pages
func ToolBusiness_get_owned_pages() mcp.Tool {
	...
	return mcp.NewTool("business_get_owned_pages",
...
func HandleBusiness_get_owned_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_owned_pages(accessToken, args)
	if err != nil {
...
func Business_get_owned_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
