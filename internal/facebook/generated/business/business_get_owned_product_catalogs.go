...
// ToolBusiness_get_owned_product_catalogs returns the MCP tool definition for business_get_owned_product_catalogs
func ToolBusiness_get_owned_product_catalogs() mcp.Tool {
	...
	return mcp.NewTool("business_get_owned_product_catalogs",
...
func HandleBusiness_get_owned_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_owned_product_catalogs(accessToken, args)
	if err != nil {
