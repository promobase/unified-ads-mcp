...
// ToolBusiness_get_ad_studies returns the MCP tool definition for business_get_ad_studies
func ToolBusiness_get_ad_studies() mcp.Tool {
	...
	return mcp.NewTool("business_get_ad_studies",
...
func HandleBusiness_get_ad_studies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_ad_studies(accessToken, args)
	if err != nil {
...
func Business_get_ad_studies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
