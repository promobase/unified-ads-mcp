...
func TestBusiness_get_agencies_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_agencies(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_agencies(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
