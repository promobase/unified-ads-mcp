...
// ToolBusiness_get_business_users returns the MCP tool definition for business_get_business_users
func ToolBusiness_get_business_users() mcp.Tool {
	...
	return mcp.NewTool("business_get_business_users",
...
func HandleBusiness_get_business_users(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_business_users(accessToken, args)
	if err != nil {
...
func Business_get_business_users(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
