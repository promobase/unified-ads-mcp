...
func TestBusiness_get_passback_attribution_metadata_configs_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/passback_attribution_metadata_configs",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_passback_attribution_metadata_configs(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_passback_attribution_metadata_configs(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
