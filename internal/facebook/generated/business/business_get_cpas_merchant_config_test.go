...
func TestBusiness_get_cpas_merchant_config_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/cpas_merchant_config",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_cpas_merchant_config(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_cpas_merchant_config(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
