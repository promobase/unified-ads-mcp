...
// ToolBusiness_post_owned_businesses returns the MCP tool definition for business_post_owned_businesses
func ToolBusiness_post_owned_businesses() mcp.Tool {
	...
	return mcp.NewTool("business_post_owned_businesses",
...
func HandleBusiness_post_owned_businesses(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_post_owned_businesses(accessToken, args)
	if err != nil {
...
func Business_post_owned_businesses(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
