...
// ToolBusiness_get_pending_client_pages returns the MCP tool definition for business_get_pending_client_pages
func ToolBusiness_get_pending_client_pages() mcp.Tool {
	// Available fields for BusinessPageRequest: id, page

	return mcp.NewTool("business_get_pending_client_pages",
...
func HandleBusiness_get_pending_client_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_pending_client_pages(accessToken, args)
	if err != nil {
...
func Business_get_pending_client_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
