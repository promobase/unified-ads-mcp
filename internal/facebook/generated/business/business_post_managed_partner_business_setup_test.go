...
func TestBusiness_post_managed_partner_business_setup_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/managed_partner_business_setup",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = FacebookGraphAPIBaseURL + "/managed_partner_business_setup"
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_post_managed_partner_business_setup(accessToken, tt.args, skipParams...)
...
func TestBusiness_post_managed_partner_business_setup_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsBusiness_post_managed_partner_business_setup(tt.args, skipParams...)
...
func buildBodyParamsBusiness_post_managed_partner_business_setup(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsBusiness_post_managed_partner_business_setup(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
