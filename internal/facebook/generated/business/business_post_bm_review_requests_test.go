...
func TestBusiness_post_bm_review_requests_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/bm_review_requests",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = FacebookGraphAPIBaseURL + "/bm_review_requests"
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_post_bm_review_requests(accessToken, tt.args, skipParams...)
...
func TestBusiness_post_bm_review_requests_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsBusiness_post_bm_review_requests(tt.args, skipParams...)
...
func buildBodyParamsBusiness_post_bm_review_requests(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsBusiness_post_bm_review_requests(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
