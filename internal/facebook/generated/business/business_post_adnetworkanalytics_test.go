...
func TestBusiness_post_adnetworkanalytics_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_post_adnetworkanalytics(accessToken, tt.args, skipParams...)
...
func TestBusiness_post_adnetworkanalytics_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsBusiness_post_adnetworkanalytics(tt.args, skipParams...)
...
func buildBodyParamsBusiness_post_adnetworkanalytics(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsBusiness_post_adnetworkanalytics(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
