...
// ToolBusiness_get_ads_reporting_mmm_schedulers returns the MCP tool definition for business_get_ads_reporting_mmm_schedulers
func ToolBusiness_get_ads_reporting_mmm_schedulers() mcp.Tool {
	// Available fields for AdsReportBuilderMMMReportScheduler: ad_account_ids, filtering, id, report_name, schedule_frequency

	return mcp.NewTool("business_get_ads_reporting_mmm_schedulers",
...
func HandleBusiness_get_ads_reporting_mmm_schedulers(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_ads_reporting_mmm_schedulers(accessToken, args)
	if err != nil {
