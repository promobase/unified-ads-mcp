...
func TestBusiness_get_business_asset_groups_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/business_asset_groups",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_business_asset_groups(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_business_asset_groups(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
