...
func TestBusiness_get_owned_offsite_signal_container_business_objects_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/owned_offsite_signal_container_business_objects",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_owned_offsite_signal_container_business_objects(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_owned_offsite_signal_container_business_objects(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
