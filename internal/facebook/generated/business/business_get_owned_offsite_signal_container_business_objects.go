...
// ToolBusiness_get_owned_offsite_signal_container_business_objects returns the MCP tool definition for business_get_owned_offsite_signal_container_business_objects
func ToolBusiness_get_owned_offsite_signal_container_business_objects() mcp.Tool {
	...
	return mcp.NewTool("business_get_owned_offsite_signal_container_business_objects",
...
func HandleBusiness_get_owned_offsite_signal_container_business_objects(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_owned_offsite_signal_container_business_objects(accessToken, args)
	if err != nil {
