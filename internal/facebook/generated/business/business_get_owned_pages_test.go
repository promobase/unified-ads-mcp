...
func TestBusiness_get_owned_pages_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_owned_pages(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_owned_pages(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
