...
// ToolBusiness_get_owned_businesses returns the MCP tool definition for business_get_owned_businesses
func ToolBusiness_get_owned_businesses() mcp.Tool {
	...
	return mcp.NewTool("business_get_owned_businesses",
