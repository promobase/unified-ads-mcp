...
func TestBusiness_post_owned_businesses_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/owned_businesses",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_post_owned_businesses(accessToken, tt.args, skipParams...)
...
func TestBusiness_post_owned_businesses_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsBusiness_post_owned_businesses(tt.args, skipParams...)
...
func buildBodyParamsBusiness_post_owned_businesses(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsBusiness_post_owned_businesses(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
