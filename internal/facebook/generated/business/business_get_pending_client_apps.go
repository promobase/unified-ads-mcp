...
// ToolBusiness_get_pending_client_apps returns the MCP tool definition for business_get_pending_client_apps
func ToolBusiness_get_pending_client_apps() mcp.Tool {
	// Available fields for BusinessApplicationRequest: application, id

	return mcp.NewTool("business_get_pending_client_apps",
...
func HandleBusiness_get_pending_client_apps(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_pending_client_apps(accessToken, args)
	if err != nil {
