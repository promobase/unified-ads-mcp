...
func TestBusiness_delete_managed_partner_businesses_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_delete_managed_partner_businesses(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_delete_managed_partner_businesses(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
