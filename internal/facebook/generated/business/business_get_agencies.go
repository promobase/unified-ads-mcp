...
// ToolBusiness_get_agencies returns the MCP tool definition for business_get_agencies
func ToolBusiness_get_agencies() mcp.Tool {
	...
	return mcp.NewTool("business_get_agencies",
...
func HandleBusiness_get_agencies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_agencies(accessToken, args)
	if err != nil {
