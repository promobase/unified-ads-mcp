...
func TestBusiness_get_managed_partner_ads_funding_source_details_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/managed_partner_ads_funding_source_details",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_managed_partner_ads_funding_source_details(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_managed_partner_ads_funding_source_details(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
