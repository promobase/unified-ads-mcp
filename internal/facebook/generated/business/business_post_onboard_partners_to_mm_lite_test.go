...
func TestBusiness_post_onboard_partners_to_mm_lite_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/onboard_partners_to_mm_lite",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_post_onboard_partners_to_mm_lite(accessToken, tt.args, skipParams...)
...
func TestBusiness_post_onboard_partners_to_mm_lite_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsBusiness_post_onboard_partners_to_mm_lite(tt.args, skipParams...)
...
func buildBodyParamsBusiness_post_onboard_partners_to_mm_lite(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsBusiness_post_onboard_partners_to_mm_lite(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
