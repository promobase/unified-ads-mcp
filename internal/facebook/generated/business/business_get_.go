...
// ToolBusiness_get_ returns the MCP tool definition for business_get_
func ToolBusiness_get_() mcp.Tool {
	...
	return mcp.NewTool("business_get_",
...
func HandleBusiness_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_(accessToken, args)
	if err != nil {
...
func Business_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
