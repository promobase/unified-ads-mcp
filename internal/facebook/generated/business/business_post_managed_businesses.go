...
// ToolBusiness_post_managed_businesses returns the MCP tool definition for business_post_managed_businesses
func ToolBusiness_post_managed_businesses() mcp.Tool {
	...
	return mcp.NewTool("business_post_managed_businesses",
...
func HandleBusiness_post_managed_businesses(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_post_managed_businesses(accessToken, args)
	if err != nil {
