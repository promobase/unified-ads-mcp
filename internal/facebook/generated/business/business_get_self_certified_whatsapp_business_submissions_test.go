...
func TestBusiness_get_self_certified_whatsapp_business_submissions_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/self_certified_whatsapp_business_submissions",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_get_self_certified_whatsapp_business_submissions(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusiness_get_self_certified_whatsapp_business_submissions(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
