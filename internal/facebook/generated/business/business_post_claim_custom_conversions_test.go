...
func TestBusiness_post_claim_custom_conversions_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/claim_custom_conversions",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_post_claim_custom_conversions(accessToken, tt.args, skipParams...)
...
func TestBusiness_post_claim_custom_conversions_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsBusiness_post_claim_custom_conversions(tt.args, skipParams...)
...
func buildBodyParamsBusiness_post_claim_custom_conversions(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsBusiness_post_claim_custom_conversions(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
