...
// ToolBusiness_get_owned_pixels returns the MCP tool definition for business_get_owned_pixels
func ToolBusiness_get_owned_pixels() mcp.Tool {
	...
	return mcp.NewTool("business_get_owned_pixels",
...
func HandleBusiness_get_owned_pixels(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_owned_pixels(accessToken, args)
	if err != nil {
