...
// ToolBusiness_post_adnetwork_applications returns the MCP tool definition for business_post_adnetwork_applications
func ToolBusiness_post_adnetwork_applications() mcp.Tool {
	
	// Params object accepts: name (string)
	return mcp.NewTool("business_post_adnetwork_applications",
...
func HandleBusiness_post_adnetwork_applications(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_post_adnetwork_applications(accessToken, args)
	if err != nil {
