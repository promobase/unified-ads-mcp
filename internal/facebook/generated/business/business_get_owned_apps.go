...
// ToolBusiness_get_owned_apps returns the MCP tool definition for business_get_owned_apps
func ToolBusiness_get_owned_apps() mcp.Tool {
	...
	return mcp.NewTool("business_get_owned_apps",
...
func HandleBusiness_get_owned_apps(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Business_get_owned_apps(accessToken, args)
	if err != nil {
