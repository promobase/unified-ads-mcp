...
func TestBusiness_post_self_certify_whatsapp_business_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/self_certify_whatsapp_business",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusiness_post_self_certify_whatsapp_business(accessToken, tt.args, skipParams...)
...
func TestBusiness_post_self_certify_whatsapp_business_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsBusiness_post_self_certify_whatsapp_business(tt.args, skipParams...)
...
func buildBodyParamsBusiness_post_self_certify_whatsapp_business(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsBusiness_post_self_certify_whatsapp_business(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
