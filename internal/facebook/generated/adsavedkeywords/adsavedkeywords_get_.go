...
// ToolAdsavedkeywords_get_ returns the MCP tool definition for adsavedkeywords_get_
func ToolAdsavedkeywords_get_() mcp.Tool {
	// Available fields for AdSavedKeywords: account, id, keywords, name, run_status, time_created, time_updated

	return mcp.NewTool("adsavedkeywords_get_",
...
func HandleAdsavedkeywords_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adsavedkeywords_get_(accessToken, args)
	if err != nil {
...
// Adsavedkeywords_get_ performs GET  for AdSavedKeywords
func Adsavedkeywords_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
