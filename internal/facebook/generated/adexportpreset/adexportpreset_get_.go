...
// ToolAdexportpreset_get_ returns the MCP tool definition for adexportpreset_get_
func ToolAdexportpreset_get_() mcp.Tool {
	// Available fields for AdExportPreset: created_time, fields, id, name, owner, updated_time

	return mcp.NewTool("adexportpreset_get_",
...
func HandleAdexportpreset_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adexportpreset_get_(accessToken, args)
	if err != nil {
...
// Adexportpreset_get_ performs GET  for AdExportPreset
func Adexportpreset_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
