...
// ToolProductitemlocalinfo_get_ returns the MCP tool definition for productitemlocalinfo_get_
func ToolProductitemlocalinfo_get_() mcp.Tool {
	...
	return mcp.NewTool("productitemlocalinfo_get_",
...
func HandleProductitemlocalinfo_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productitemlocalinfo_get_(accessToken, args)
	if err != nil {
...
// Productitemlocalinfo_get_ performs GET  for ProductItemLocalInfo
func Productitemlocalinfo_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
