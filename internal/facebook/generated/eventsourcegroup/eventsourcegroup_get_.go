...
// ToolEventsourcegroup_get_ returns the MCP tool definition for eventsourcegroup_get_
func ToolEventsourcegroup_get_() mcp.Tool {
	// Available fields for EventSourceGroup: business, event_sources, id, name, owner_business
	
	return mcp.NewTool("eventsourcegroup_get_",
...
func HandleEventsourcegroup_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Eventsourcegroup_get_(accessToken, args)
	if err != nil {
...
func Eventsourcegroup_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
