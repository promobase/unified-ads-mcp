...
// ToolExtendedcreditallocationconfig_get_ returns the MCP tool definition for extendedcreditallocationconfig_get_
func ToolExtendedcreditallocationconfig_get_() mcp.Tool {
	...
	return mcp.NewTool("extendedcreditallocationconfig_get_",
...
func HandleExtendedcreditallocationconfig_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Extendedcreditallocationconfig_get_(accessToken, args)
	if err != nil {
...
// Extendedcreditallocationconfig_get_ performs GET  for ExtendedCreditAllocationConfig
func Extendedcreditallocationconfig_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
