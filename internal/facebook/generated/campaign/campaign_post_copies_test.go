...
func TestCampaign_post_copies_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsCampaign_post_copies(accessToken, tt.args, skipParams...)
...
func TestCampaign_post_copies_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCampaign_post_copies(tt.args, skipParams...)
...
func buildBodyParamsCampaign_post_copies(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCampaign_post_copies(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
