...
func TestCampaign_get_ads_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/ads",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/ads", FacebookGraphAPIBaseURL, campaignId)
			...
			urlParams := buildURLParamsCampaign_get_ads(accessToken, tt.args, skipParams...)
...
func buildURLParamsCampaign_get_ads(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
