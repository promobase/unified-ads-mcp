...
// ToolCampaign_get_ returns the MCP tool definition for campaign_get_
func ToolCampaign_get_() mcp.Tool {
	...
	return mcp.NewTool("campaign_get_",
...
func HandleCampaign_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Campaign_get_(accessToken, args)
	if err != nil {
...
func Campaign_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
