...
// ToolCampaign_get_insights returns the MCP tool definition for campaign_get_insights
func ToolCampaign_get_insights() mcp.Tool {
	...
	return mcp.NewTool("campaign_get_insights",
...
func HandleCampaign_get_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Campaign_get_insights(accessToken, args)
	if err != nil {
...
func Campaign_get_insights(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
