...
func TestToolCampaign_get_ads_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolCampaign_get_ads()
	if tool.Name != "campaign_get_ads" {
		t.Errorf("expected tool name campaign_get_ads, got %s", tool.Name)
	}
}

func TestToolCampaign_get_ads_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleCampaign_get_ads(ctx, request)
