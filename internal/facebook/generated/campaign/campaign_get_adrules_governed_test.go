...
func TestCampaign_get_adrules_governed_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/adrules_governed",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsCampaign_get_adrules_governed(accessToken, tt.args, skipParams...)
...
func buildURLParamsCampaign_get_adrules_governed(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
