...
func TestToolCampaign_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolCampaign_get()
	if tool.Name != "campaign_get" {
		t.Errorf("expected tool name campaign_get, got %s", tool.Name)
	}
}

func TestToolCampaign_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleCampaign_get(ctx, request)
