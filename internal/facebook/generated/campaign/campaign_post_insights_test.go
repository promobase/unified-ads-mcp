...
func TestCampaign_post_insights_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsCampaign_post_insights(accessToken, tt.args, skipParams...)
...
func TestCampaign_post_insights_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCampaign_post_insights(tt.args, skipParams...)
...
func buildBodyParamsCampaign_post_insights(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCampaign_post_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
