...
// RegisterCampaignListAdStudiesHandler registers the campaign_list_ad_studies tool
func RegisterCampaignListAdStudiesHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CampaignListAdStudiesHandler)
	return nil
}

// CampaignListAdStudiesHandler handles the campaign_list_ad_studies tool
func CampaignListAdStudiesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
