...
// RegisterCampaignListAdsetsHandler registers the campaign_list_adsets tool
func RegisterCampaignListAdsetsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CampaignListAdsetsHandler)
	return nil
}

// CampaignListAdsetsHandler handles the campaign_list_adsets tool
func CampaignListAdsetsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
