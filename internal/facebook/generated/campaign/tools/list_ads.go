...
// RegisterCampaignListAdsHandler registers the campaign_list_ads tool
func RegisterCampaignListAdsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CampaignListAdsHandler)
	return nil
}

// CampaignListAdsHandler handles the campaign_list_ads tool
func CampaignListAdsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
