...
// RegisterCampaignGetInsightsHandler registers the campaign_get_insights tool
func RegisterCampaignGetInsightsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CampaignGetInsightsHandler)
	return nil
}

// CampaignGetInsightsHandler handles the campaign_get_insights tool
func CampaignGetInsightsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
