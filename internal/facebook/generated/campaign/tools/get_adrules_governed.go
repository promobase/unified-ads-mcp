...
// RegisterCampaignGetAdrulesGovernedHandler registers the campaign_get_adrules_governed tool
func RegisterCampaignGetAdrulesGovernedHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CampaignGetAdrulesGovernedHandler)
	return nil
}

// CampaignGetAdrulesGovernedHandler handles the campaign_get_adrules_governed tool
func CampaignGetAdrulesGovernedHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
