...
// RegisterCampaignListCopiesHandler registers the campaign_list_copies tool
func RegisterCampaignListCopiesHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, CampaignListCopiesHandler)
	return nil
}

// CampaignListCopiesHandler handles the campaign_list_copies tool
func CampaignListCopiesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
