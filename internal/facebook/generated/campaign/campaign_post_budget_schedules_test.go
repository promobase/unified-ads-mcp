...
func TestCampaign_post_budget_schedules_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/budget_schedules",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/budget_schedules", FacebookGraphAPIBaseURL, campaignId)
			...
			urlParams := buildURLParamsCampaign_post_budget_schedules(accessToken, tt.args, skipParams...)
...
func TestCampaign_post_budget_schedules_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCampaign_post_budget_schedules(tt.args, skipParams...)
...
func buildBodyParamsCampaign_post_budget_schedules(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCampaign_post_budget_schedules(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
