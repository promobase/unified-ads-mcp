...
func TestToolCampaign_post_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolCampaign_post()
	if tool.Name != "campaign_post" {
		t.Errorf("expected tool name campaign_post, got %s", tool.Name)
	}
}

func TestToolCampaign_post_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleCampaign_post(ctx, request)
