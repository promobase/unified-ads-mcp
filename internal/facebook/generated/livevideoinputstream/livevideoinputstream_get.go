...
// ToolLivevideoinputstream_get returns the MCP tool definition for livevideoinputstream_get
func ToolLivevideoinputstream_get() mcp.Tool {
	...
	return mcp.NewTool("livevideoinputstream_get",
...
// HandleLivevideoinputstream_get handles the livevideoinputstream_get tool with context-based auth
func HandleLivevideoinputstream_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Livevideoinputstream_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute livevideoinputstream_get: %v", err)), nil
	}
...
// Livevideoinputstream_get performs GET  for LiveVideoInputStream
func Livevideoinputstream_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
