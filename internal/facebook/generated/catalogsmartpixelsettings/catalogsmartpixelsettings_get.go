...
// ToolCatalogsmartpixelsettings_get returns the MCP tool definition for catalogsmartpixelsettings_get
func ToolCatalogsmartpixelsettings_get() mcp.Tool {
	...
	return mcp.NewTool("catalogsmartpixelsettings_get",
...
// HandleCatalogsmartpixelsettings_get handles the catalogsmartpixelsettings_get tool with context-based auth
func HandleCatalogsmartpixelsettings_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Catalogsmartpixelsettings_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute catalogsmartpixelsettings_get: %v", err)), nil
	}
...
// Catalogsmartpixelsettings_get performs GET  for CatalogSmartPixelSettings
func Catalogsmartpixelsettings_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
