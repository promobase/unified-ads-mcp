...
// ToolHighdemandperiod_get returns the MCP tool definition for highdemandperiod_get
func ToolHighdemandperiod_get() mcp.Tool {
	...
	return mcp.NewTool("highdemandperiod_get",
...
// HandleHighdemandperiod_get handles the highdemandperiod_get tool with context-based auth
func HandleHighdemandperiod_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Highdemandperiod_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute highdemandperiod_get: %v", err)), nil
	}
...
// Highdemandperiod_get performs GET  for HighDemandPeriod
func Highdemandperiod_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
