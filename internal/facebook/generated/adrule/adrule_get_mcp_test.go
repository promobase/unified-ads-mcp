...
func TestToolAdrule_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdrule_get()
	if tool.Name != "adrule_get" {
		t.Errorf("expected tool name adrule_get, got %s", tool.Name)
	}
}

func TestToolAdrule_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdrule_get(ctx, request)
