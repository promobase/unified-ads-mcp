...
// ToolAdrule_get_ returns the MCP tool definition for adrule_get_
func ToolAdrule_get_() mcp.Tool {
	...
	return mcp.NewTool("adrule_get_",
...
func HandleAdrule_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adrule_get_(accessToken, args)
	if err != nil {
...
func Adrule_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
