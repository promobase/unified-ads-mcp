...
// ToolAlbum_get_comments returns the MCP tool definition for album_get_comments
func ToolAlbum_get_comments() mcp.Tool {
	...
	return mcp.NewTool("album_get_comments",
