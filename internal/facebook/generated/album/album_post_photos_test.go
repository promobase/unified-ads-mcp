...
func TestAlbum_post_photos_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAlbum_post_photos(accessToken, tt.args, skipParams...)
...
func TestAlbum_post_photos_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAlbum_post_photos(tt.args, skipParams...)
...
func buildBodyParamsAlbum_post_photos(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAlbum_post_photos(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
