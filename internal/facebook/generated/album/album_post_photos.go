...
// ToolAlbum_post_photos returns the MCP tool definition for album_post_photos
func ToolAlbum_post_photos() mcp.Tool {
	...
	return mcp.NewTool("album_post_photos",
...
func HandleAlbum_post_photos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Album_post_photos(accessToken, args)
	if err != nil {
