...
func TestToolAlbum_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAlbum_get()
	if tool.Name != "album_get" {
		t.Errorf("expected tool name album_get, got %s", tool.Name)
	}
}

func TestToolAlbum_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAlbum_get(ctx, request)
