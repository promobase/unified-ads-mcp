...
func TestAlbum_get_photos_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAlbum_get_photos(accessToken, tt.args, skipParams...)
...
func buildURLParamsAlbum_get_photos(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
