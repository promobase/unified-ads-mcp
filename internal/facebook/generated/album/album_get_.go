...
// ToolAlbum_get_ returns the MCP tool definition for album_get_
func ToolAlbum_get_() mcp.Tool {
...
func HandleAlbum_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Album_get_(accessToken, args)
	if err != nil {
...
func Album_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
