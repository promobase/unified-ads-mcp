...
// ToolAudiorelease_get_ returns the MCP tool definition for audiorelease_get_
func ToolAudiorelease_get_() mcp.Tool {
	...
	return mcp.NewTool("audiorelease_get_",
...
func HandleAudiorelease_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Audiorelease_get_(accessToken, args)
	if err != nil {
...
func Audiorelease_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
