...
// ToolBusinessuser_get_assigned_ad_accounts returns the MCP tool definition for businessuser_get_assigned_ad_accounts
func ToolBusinessuser_get_assigned_ad_accounts() mcp.Tool {
	...
	return mcp.NewTool("businessuser_get_assigned_ad_accounts",
...
func HandleBusinessuser_get_assigned_ad_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessuser_get_assigned_ad_accounts(accessToken, args)
	if err != nil {
...
func Businessuser_get_assigned_ad_accounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
