...
// ToolBusinessuser_get_ returns the MCP tool definition for businessuser_get_
func ToolBusinessuser_get_() mcp.Tool {
	...
	return mcp.NewTool("businessuser_get_",
...
func HandleBusinessuser_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessuser_get_(accessToken, args)
	if err != nil {
...
func Businessuser_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
