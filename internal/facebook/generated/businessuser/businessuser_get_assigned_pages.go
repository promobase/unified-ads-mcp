...
// ToolBusinessuser_get_assigned_pages returns the MCP tool definition for businessuser_get_assigned_pages
func ToolBusinessuser_get_assigned_pages() mcp.Tool {
	...
	return mcp.NewTool("businessuser_get_assigned_pages",
...
func HandleBusinessuser_get_assigned_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessuser_get_assigned_pages(accessToken, args)
	if err != nil {
...
func Businessuser_get_assigned_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
