...
// ToolBusinessuser_get returns the MCP tool definition for businessuser_get
func ToolBusinessuser_get() mcp.Tool {
	...
	return mcp.NewTool("businessuser_get",
...
// HandleBusinessuser_get handles the businessuser_get tool with context-based auth
func HandleBusinessuser_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessuser_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute businessuser_get: %v", err)), nil
	}
...
// Businessuser_get performs GET  for BusinessUser
func Businessuser_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
