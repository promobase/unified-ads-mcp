...
// ToolBusinessuser_get_assigned_product_catalogs returns the MCP tool definition for businessuser_get_assigned_product_catalogs
func ToolBusinessuser_get_assigned_product_catalogs() mcp.Tool {
	...
	return mcp.NewTool("businessuser_get_assigned_product_catalogs",
...
func HandleBusinessuser_get_assigned_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessuser_get_assigned_product_catalogs(accessToken, args)
	if err != nil {
...
func Businessuser_get_assigned_product_catalogs(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
