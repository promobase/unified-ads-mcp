...
// ToolProductfeeduploaderrorsample_get_ returns the MCP tool definition for productfeeduploaderrorsample_get_
func ToolProductfeeduploaderrorsample_get_() mcp.Tool {
	// Available fields for ProductFeedUploadErrorSample: id, retailer_id, row_number

	return mcp.NewTool("productfeeduploaderrorsample_get_",
...
func HandleProductfeeduploaderrorsample_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productfeeduploaderrorsample_get_(accessToken, args)
	if err != nil {
...
func Productfeeduploaderrorsample_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
