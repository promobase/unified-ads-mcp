...
// ToolHotel_get_channels_to_integrity_status returns the MCP tool definition for hotel_get_channels_to_integrity_status
func ToolHotel_get_channels_to_integrity_status() mcp.Tool {
	// Available fields for CatalogItemChannelsToIntegrityStatus: channels, rejection_information

	return mcp.NewTool("hotel_get_channels_to_integrity_status",
...
func HandleHotel_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Hotel_get_channels_to_integrity_status(accessToken, args)
	if err != nil {
...
func Hotel_get_channels_to_integrity_status(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
