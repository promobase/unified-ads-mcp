...
// ToolHotel_get_override_details returns the MCP tool definition for hotel_get_override_details
func ToolHotel_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("hotel_get_override_details",
...
func HandleHotel_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Hotel_get_override_details(accessToken, args)
	if err != nil {
...
func Hotel_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
