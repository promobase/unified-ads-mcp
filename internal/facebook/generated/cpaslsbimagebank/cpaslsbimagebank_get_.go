...
// ToolCpaslsbimagebank_get_ returns the MCP tool definition for cpaslsbimagebank_get_
func ToolCpaslsbimagebank_get_() mcp.Tool {
	// Available fields for CPASLsbImageBank: ad_group_id, catalog_segment_proxy_id, id

	return mcp.NewTool("cpaslsbimagebank_get_",
...
func HandleCpaslsbimagebank_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Cpaslsbimagebank_get_(accessToken, args)
	if err != nil {
...
func Cpaslsbimagebank_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
