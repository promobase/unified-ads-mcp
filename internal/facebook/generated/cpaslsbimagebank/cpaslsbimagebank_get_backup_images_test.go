...
func TestCpaslsbimagebank_get_backup_images_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/backup_images",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCpaslsbimagebank_get_backup_images(accessToken, tt.args, skipParams...)
...
func buildURLParamsCpaslsbimagebank_get_backup_images(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
