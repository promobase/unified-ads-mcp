...
func TestIgmedia_get_collaborators_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_get_collaborators(accessToken, tt.args, skipParams...)
...
func buildURLParamsIgmedia_get_collaborators(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
