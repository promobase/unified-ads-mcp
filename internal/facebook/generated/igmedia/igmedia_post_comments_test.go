...
func TestIgmedia_post_comments_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_post_comments(accessToken, tt.args, skipParams...)
...
func TestIgmedia_post_comments_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIgmedia_post_comments(tt.args, skipParams...)
...
func buildBodyParamsIgmedia_post_comments(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIgmedia_post_comments(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
