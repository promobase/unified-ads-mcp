...
func TestIgmedia_delete_partnership_ad_code_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_delete_partnership_ad_code(accessToken, tt.args, skipParams...)
...
func buildURLParamsIgmedia_delete_partnership_ad_code(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
