...
func TestIgmedia_post_branded_content_partner_promote_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/branded_content_partner_promote",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_post_branded_content_partner_promote(accessToken, tt.args, skipParams...)
...
func TestIgmedia_post_branded_content_partner_promote_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIgmedia_post_branded_content_partner_promote(tt.args, skipParams...)
...
func buildBodyParamsIgmedia_post_branded_content_partner_promote(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIgmedia_post_branded_content_partner_promote(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
