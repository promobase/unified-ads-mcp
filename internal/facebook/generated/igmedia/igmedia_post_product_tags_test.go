...
func TestIgmedia_post_product_tags_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/product_tags",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_post_product_tags(accessToken, tt.args, skipParams...)
...
func TestIgmedia_post_product_tags_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIgmedia_post_product_tags(tt.args, skipParams...)
...
func buildBodyParamsIgmedia_post_product_tags(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIgmedia_post_product_tags(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
