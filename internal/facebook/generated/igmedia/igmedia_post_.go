...
// ToolIgmedia_post_ returns the MCP tool definition for igmedia_post_
func ToolIgmedia_post_() mcp.Tool {

	// Params object accepts: comment_enabled (bool)
	return mcp.NewTool("igmedia_post_",
...
func HandleIgmedia_post_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igmedia_post_(accessToken, args)
	if err != nil {
...
func Igmedia_post_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
