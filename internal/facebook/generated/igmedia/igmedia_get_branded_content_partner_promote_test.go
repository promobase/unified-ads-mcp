...
func TestIgmedia_get_branded_content_partner_promote_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_get_branded_content_partner_promote(accessToken, tt.args, skipParams...)
...
func buildURLParamsIgmedia_get_branded_content_partner_promote(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
