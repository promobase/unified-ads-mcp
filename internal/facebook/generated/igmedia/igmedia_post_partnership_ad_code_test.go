...
func TestIgmedia_post_partnership_ad_code_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/partnership_ad_code",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_post_partnership_ad_code(accessToken, tt.args, skipParams...)
...
func TestIgmedia_post_partnership_ad_code_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIgmedia_post_partnership_ad_code(tt.args, skipParams...)
...
func buildBodyParamsIgmedia_post_partnership_ad_code(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIgmedia_post_partnership_ad_code(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
