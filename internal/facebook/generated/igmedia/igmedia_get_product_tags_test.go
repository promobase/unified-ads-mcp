...
func TestIgmedia_get_product_tags_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmedia_get_product_tags(accessToken, tt.args, skipParams...)
...
func buildURLParamsIgmedia_get_product_tags(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
