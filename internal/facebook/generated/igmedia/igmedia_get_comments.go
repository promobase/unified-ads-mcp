...
// ToolIgmedia_get_comments returns the MCP tool definition for igmedia_get_comments
func ToolIgmedia_get_comments() mcp.Tool {
	...
	return mcp.NewTool("igmedia_get_comments",
...
func HandleIgmedia_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igmedia_get_comments(accessToken, args)
	if err != nil {
...
func Igmedia_get_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
