...
// ToolProductsetusage_get_ returns the MCP tool definition for productsetusage_get_
func ToolProductsetusage_get_() mcp.Tool {
	// Available fields for ProductSetUsage: id, product_set, usage_type

	return mcp.NewTool("productsetusage_get_",
...
func HandleProductsetusage_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productsetusage_get_(accessToken, args)
	if err != nil {
...
// Productsetusage_get_ performs GET  for ProductSetUsage
func Productsetusage_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
