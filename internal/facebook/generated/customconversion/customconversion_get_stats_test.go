...
func TestCustomconversion_get_stats_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCustomconversion_get_stats(accessToken, tt.args, skipParams...)
...
func buildURLParamsCustomconversion_get_stats(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
