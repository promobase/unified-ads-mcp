...
// ToolCustomconversion_get returns the MCP tool definition for customconversion_get
func ToolCustomconversion_get() mcp.Tool {
	...
	return mcp.NewTool("customconversion_get",
...
// HandleCustomconversion_get handles the customconversion_get tool with context-based auth
func HandleCustomconversion_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Customconversion_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute customconversion_get: %v", err)), nil
	}
...
// Customconversion_get performs GET  for CustomConversion
func Customconversion_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
