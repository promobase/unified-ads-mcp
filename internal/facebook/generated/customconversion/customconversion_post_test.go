...
func TestCustomconversion_post_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCustomconversion_post(accessToken, tt.args, skipParams...)
...
func TestCustomconversion_post_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCustomconversion_post(tt.args, skipParams...)
...
func buildBodyParamsCustomconversion_post(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCustomconversion_post(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
