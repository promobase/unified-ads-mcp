...
// ToolGroup_get_live_videos returns the MCP tool definition for group_get_live_videos
func ToolGroup_get_live_videos() mcp.Tool {
	...
	return mcp.NewTool("group_get_live_videos",
...
func HandleGroup_get_live_videos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Group_get_live_videos(accessToken, args)
	if err != nil {
...
func Group_get_live_videos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
