...
// ToolGroup_get_opted_in_members returns the MCP tool definition for group_get_opted_in_members
func ToolGroup_get_opted_in_members() mcp.Tool {
	...
	return mcp.NewTool("group_get_opted_in_members",
...
func HandleGroup_get_opted_in_members(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Group_get_opted_in_members(accessToken, args)
	if err != nil {
