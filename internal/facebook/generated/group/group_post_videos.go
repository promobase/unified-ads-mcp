...
// ToolGroup_post_videos returns the MCP tool definition for group_post_videos
func ToolGroup_post_videos() mcp.Tool {
	...
	return mcp.NewTool("group_post_videos",
...
func HandleGroup_post_videos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Group_post_videos(accessToken, args)
	if err != nil {
...
func Group_post_videos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
