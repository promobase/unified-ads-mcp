...
func TestGroup_delete_members_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsGroup_delete_members(accessToken, tt.args, skipParams...)
...
func buildURLParamsGroup_delete_members(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
