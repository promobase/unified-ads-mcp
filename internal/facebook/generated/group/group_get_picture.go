...
// ToolGroup_get_picture returns the MCP tool definition for group_get_picture
func ToolGroup_get_picture() mcp.Tool {
	...
	return mcp.NewTool("group_get_picture",
...
func HandleGroup_get_picture(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Group_get_picture(accessToken, args)
	if err != nil {
...
func Group_get_picture(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
