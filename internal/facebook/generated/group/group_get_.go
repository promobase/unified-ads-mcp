...
// ToolGroup_get_ returns the MCP tool definition for group_get_
func ToolGroup_get_() mcp.Tool {
...
func HandleGroup_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Group_get_(accessToken, args)
	if err != nil {
...
func Group_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
