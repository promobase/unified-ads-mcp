...
// ToolGroup_post_feed returns the MCP tool definition for group_post_feed
func ToolGroup_post_feed() mcp.Tool {
	...
	return mcp.NewTool("group_post_feed",
...
func HandleGroup_post_feed(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Group_post_feed(accessToken, args)
	if err != nil {
...
func Group_post_feed(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
