...
// ToolPlacetopic_get_ returns the MCP tool definition for placetopic_get_
func ToolPlacetopic_get_() mcp.Tool {
	...
	return mcp.NewTool("placetopic_get_",
...
func HandlePlacetopic_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Placetopic_get_(accessToken, args)
	if err != nil {
...
func Placetopic_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
