...
// ToolApprequest_get_ returns the MCP tool definition for apprequest_get_
func ToolApprequest_get_() mcp.Tool {
	// Available fields for AppRequest: action_type, application, created_time, data, from, id, message, object, to
	
	return mcp.NewTool("apprequest_get_",
...
func HandleApprequest_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Apprequest_get_(accessToken, args)
	if err != nil {
...
// Apprequest_get_ performs GET  for AppRequest
func Apprequest_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
