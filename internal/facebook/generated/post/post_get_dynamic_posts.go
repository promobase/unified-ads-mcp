...
// ToolPost_get_dynamic_posts returns the MCP tool definition for post_get_dynamic_posts
func ToolPost_get_dynamic_posts() mcp.Tool {
	...
	return mcp.NewTool("post_get_dynamic_posts",
...
func HandlePost_get_dynamic_posts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Post_get_dynamic_posts(accessToken, args)
	if err != nil {
