...
// ToolPost_get_reactions returns the MCP tool definition for post_get_reactions
func ToolPost_get_reactions() mcp.Tool {
	...
	return mcp.NewTool("post_get_reactions",
...
func HandlePost_get_reactions(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Post_get_reactions(accessToken, args)
	if err != nil {
