...
func TestToolPost_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolPost_get()
	if tool.Name != "post_get" {
		t.Errorf("expected tool name post_get, got %s", tool.Name)
	}
}

func TestToolPost_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandlePost_get(ctx, request)
