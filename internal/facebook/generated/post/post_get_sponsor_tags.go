...
// ToolPost_get_sponsor_tags returns the MCP tool definition for post_get_sponsor_tags
func ToolPost_get_sponsor_tags() mcp.Tool {
	...
	return mcp.NewTool("post_get_sponsor_tags",
...
func HandlePost_get_sponsor_tags(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Post_get_sponsor_tags(accessToken, args)
	if err != nil {
