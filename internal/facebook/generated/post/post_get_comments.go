...
// ToolPost_get_comments returns the MCP tool definition for post_get_comments
func ToolPost_get_comments() mcp.Tool {
	...
	return mcp.NewTool("post_get_comments",
...
func HandlePost_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Post_get_comments(accessToken, args)
	if err != nil {
...
func Post_get_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
