...
func TestPost_get_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPost_get(accessToken, tt.args, skipParams...)
...
func buildURLParamsPost_get(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
