...
// ToolProductset_get_automotive_models returns the MCP tool definition for productset_get_automotive_models
func ToolProductset_get_automotive_models() mcp.Tool {
	...
	return mcp.NewTool("productset_get_automotive_models",
...
func HandleProductset_get_automotive_models(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productset_get_automotive_models(accessToken, args)
	if err != nil {
...
func Productset_get_automotive_models(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
