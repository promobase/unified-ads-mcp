...
// ToolProductset_get_vehicles returns the MCP tool definition for productset_get_vehicles
func ToolProductset_get_vehicles() mcp.Tool {
	...
	return mcp.NewTool("productset_get_vehicles",
...
func HandleProductset_get_vehicles(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productset_get_vehicles(accessToken, args)
	if err != nil {
...
func Productset_get_vehicles(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
