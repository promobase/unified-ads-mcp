...
func TestProductset_get_hotels_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductset_get_hotels(accessToken, tt.args, skipParams...)
...
func buildURLParamsProductset_get_hotels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
