...
// ToolProductset_get_destinations returns the MCP tool definition for productset_get_destinations
func ToolProductset_get_destinations() mcp.Tool {
	...
	return mcp.NewTool("productset_get_destinations",
...
func HandleProductset_get_destinations(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productset_get_destinations(accessToken, args)
	if err != nil {
...
func Productset_get_destinations(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
