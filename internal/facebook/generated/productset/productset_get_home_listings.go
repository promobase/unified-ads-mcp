...
// ToolProductset_get_home_listings returns the MCP tool definition for productset_get_home_listings
func ToolProductset_get_home_listings() mcp.Tool {
	...
	return mcp.NewTool("productset_get_home_listings",
...
func HandleProductset_get_home_listings(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productset_get_home_listings(accessToken, args)
	if err != nil {
...
func Productset_get_home_listings(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
