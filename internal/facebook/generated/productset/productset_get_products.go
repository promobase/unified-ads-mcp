...
// ToolProductset_get_products returns the MCP tool definition for productset_get_products
func ToolProductset_get_products() mcp.Tool {
	...
	return mcp.NewTool("productset_get_products",
...
func HandleProductset_get_products(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productset_get_products(accessToken, args)
	if err != nil {
...
func Productset_get_products(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
