...
func TestPaymentenginepayment_post_dispute_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/dispute",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPaymentenginepayment_post_dispute(accessToken, tt.args, skipParams...)
...
func TestPaymentenginepayment_post_dispute_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPaymentenginepayment_post_dispute(tt.args, skipParams...)
...
func buildBodyParamsPaymentenginepayment_post_dispute(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPaymentenginepayment_post_dispute(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
