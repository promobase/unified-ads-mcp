...
func TestPaymentenginepayment_post_refunds_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/refunds",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPaymentenginepayment_post_refunds(accessToken, tt.args, skipParams...)
...
func TestPaymentenginepayment_post_refunds_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPaymentenginepayment_post_refunds(tt.args, skipParams...)
...
func buildBodyParamsPaymentenginepayment_post_refunds(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPaymentenginepayment_post_refunds(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
