...
// ToolPaymentenginepayment_get returns the MCP tool definition for paymentenginepayment_get
func ToolPaymentenginepayment_get() mcp.Tool {
	...
	return mcp.NewTool("paymentenginepayment_get",
...
// HandlePaymentenginepayment_get handles the paymentenginepayment_get tool with context-based auth
func HandlePaymentenginepayment_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Paymentenginepayment_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute paymentenginepayment_get: %v", err)), nil
	}
...
// Paymentenginepayment_get performs GET  for PaymentEnginePayment
func Paymentenginepayment_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
