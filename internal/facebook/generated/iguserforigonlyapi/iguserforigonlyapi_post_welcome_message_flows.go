...
// ToolIguserforigonlyapi_post_welcome_message_flows returns the MCP tool definition for iguserforigonlyapi_post_welcome_message_flows
func ToolIguserforigonlyapi_post_welcome_message_flows() mcp.Tool {
	...
	return mcp.NewTool("iguserforigonlyapi_post_welcome_message_flows",
...
func HandleIguserforigonlyapi_post_welcome_message_flows(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguserforigonlyapi_post_welcome_message_flows(accessToken, args)
	if err != nil {
...
func Iguserforigonlyapi_post_welcome_message_flows(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
