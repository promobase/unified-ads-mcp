...
// ToolIguserforigonlyapi_get_stories returns the MCP tool definition for iguserforigonlyapi_get_stories
func ToolIguserforigonlyapi_get_stories() mcp.Tool {

	return mcp.NewTool("iguserforigonlyapi_get_stories",
...
func HandleIguserforigonlyapi_get_stories(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguserforigonlyapi_get_stories(accessToken, args)
	if err != nil {
