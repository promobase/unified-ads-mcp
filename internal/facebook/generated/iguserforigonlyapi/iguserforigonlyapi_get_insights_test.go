...
func TestIguserforigonlyapi_get_insights_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguserforigonlyapi_get_insights(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguserforigonlyapi_get_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
