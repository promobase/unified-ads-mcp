...
// ToolIguserforigonlyapi_get_conversations returns the MCP tool definition for iguserforigonlyapi_get_conversations
func ToolIguserforigonlyapi_get_conversations() mcp.Tool {
	...
	return mcp.NewTool("iguserforigonlyapi_get_conversations",
...
func HandleIguserforigonlyapi_get_conversations(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguserforigonlyapi_get_conversations(accessToken, args)
	if err != nil {
...
func Iguserforigonlyapi_get_conversations(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
