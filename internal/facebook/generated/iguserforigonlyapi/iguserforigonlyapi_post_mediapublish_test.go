...
func TestIguserforigonlyapi_post_mediapublish_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/mediapublish",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguserforigonlyapi_post_mediapublish(accessToken, tt.args, skipParams...)
...
func TestIguserforigonlyapi_post_mediapublish_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIguserforigonlyapi_post_mediapublish(tt.args, skipParams...)
...
func buildBodyParamsIguserforigonlyapi_post_mediapublish(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIguserforigonlyapi_post_mediapublish(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
