...
func TestIguserforigonlyapi_post_subscribed_apps_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguserforigonlyapi_post_subscribed_apps(accessToken, tt.args, skipParams...)
...
func TestIguserforigonlyapi_post_subscribed_apps_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIguserforigonlyapi_post_subscribed_apps(tt.args, skipParams...)
...
func buildBodyParamsIguserforigonlyapi_post_subscribed_apps(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIguserforigonlyapi_post_subscribed_apps(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
