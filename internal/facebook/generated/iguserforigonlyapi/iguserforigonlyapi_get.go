...
// ToolIguserforigonlyapi_get returns the MCP tool definition for iguserforigonlyapi_get
func ToolIguserforigonlyapi_get() mcp.Tool {
	...
	return mcp.NewTool("iguserforigonlyapi_get",
...
// HandleIguserforigonlyapi_get handles the iguserforigonlyapi_get tool with context-based auth
func HandleIguserforigonlyapi_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguserforigonlyapi_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute iguserforigonlyapi_get: %v", err)), nil
	}
...
// Iguserforigonlyapi_get performs GET  for IGUserForIGOnlyAPI
func Iguserforigonlyapi_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
