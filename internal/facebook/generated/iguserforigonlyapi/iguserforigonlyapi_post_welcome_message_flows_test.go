...
func TestIguserforigonlyapi_post_welcome_message_flows_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/welcome_message_flows",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguserforigonlyapi_post_welcome_message_flows(accessToken, tt.args, skipParams...)
...
func TestIguserforigonlyapi_post_welcome_message_flows_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsIguserforigonlyapi_post_welcome_message_flows(tt.args, skipParams...)
...
func buildBodyParamsIguserforigonlyapi_post_welcome_message_flows(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsIguserforigonlyapi_post_welcome_message_flows(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
