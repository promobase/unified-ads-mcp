...
func TestIguserforigonlyapi_delete_messenger_profile_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIguserforigonlyapi_delete_messenger_profile(accessToken, tt.args, skipParams...)
...
func buildURLParamsIguserforigonlyapi_delete_messenger_profile(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
