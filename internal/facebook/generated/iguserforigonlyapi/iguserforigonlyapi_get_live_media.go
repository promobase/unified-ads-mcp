...
// ToolIguserforigonlyapi_get_live_media returns the MCP tool definition for iguserforigonlyapi_get_live_media
func ToolIguserforigonlyapi_get_live_media() mcp.Tool {

	return mcp.NewTool("iguserforigonlyapi_get_live_media",
...
func HandleIguserforigonlyapi_get_live_media(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Iguserforigonlyapi_get_live_media(accessToken, args)
	if err != nil {
