...
// ToolBusinessproject_get_ returns the MCP tool definition for businessproject_get_
func ToolBusinessproject_get_() mcp.Tool {
	// Available fields for BusinessProject: business, created_time, creator, id, name

	return mcp.NewTool("businessproject_get_",
...
func HandleBusinessproject_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessproject_get_(accessToken, args)
	if err != nil {
...
func Businessproject_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
