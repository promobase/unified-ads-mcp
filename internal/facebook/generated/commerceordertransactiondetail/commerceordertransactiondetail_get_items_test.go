...
func TestCommerceordertransactiondetail_get_items_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/items",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommerceordertransactiondetail_get_items(accessToken, tt.args, skipParams...)
...
func buildURLParamsCommerceordertransactiondetail_get_items(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
