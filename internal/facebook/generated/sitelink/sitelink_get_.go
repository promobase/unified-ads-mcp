...
// ToolSitelink_get_ returns the MCP tool definition for sitelink_get_
func ToolSitelink_get_() mcp.Tool {
	// Available fields for SiteLink: id, link_image_hash, link_title, link_type, link_url

	return mcp.NewTool("sitelink_get_",
...
func HandleSitelink_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Sitelink_get_(accessToken, args)
	if err != nil {
...
// Sitelink_get_ performs GET  for SiteLink
func Sitelink_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
