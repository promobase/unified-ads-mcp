...
func TestPublisherblocklist_post_append_publisher_urls_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/append_publisher_urls",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPublisherblocklist_post_append_publisher_urls(accessToken, tt.args, skipParams...)
...
func TestPublisherblocklist_post_append_publisher_urls_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPublisherblocklist_post_append_publisher_urls(tt.args, skipParams...)
...
func buildBodyParamsPublisherblocklist_post_append_publisher_urls(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPublisherblocklist_post_append_publisher_urls(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
