...
func TestPublisherblocklist_get_paged_web_publishers_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/paged_web_publishers",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPublisherblocklist_get_paged_web_publishers(accessToken, tt.args, skipParams...)
...
func buildURLParamsPublisherblocklist_get_paged_web_publishers(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
