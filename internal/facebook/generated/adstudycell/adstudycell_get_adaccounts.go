...
// ToolAdstudycell_get_adaccounts returns the MCP tool definition for adstudycell_get_adaccounts
func ToolAdstudycell_get_adaccounts() mcp.Tool {
	...
	return mcp.NewTool("adstudycell_get_adaccounts",
...
func HandleAdstudycell_get_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adstudycell_get_adaccounts(accessToken, args)
	if err != nil {
...
func Adstudycell_get_adaccounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
