...
// ToolAdstudycell_get_ returns the MCP tool definition for adstudycell_get_
func ToolAdstudycell_get_() mcp.Tool {
	// Available fields for AdStudyCell: ad_entities_count, control_percentage, id, name, treatment_percentage

	return mcp.NewTool("adstudycell_get_",
...
func HandleAdstudycell_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adstudycell_get_(accessToken, args)
	if err != nil {
...
func Adstudycell_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
