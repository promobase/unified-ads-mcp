...
func TestAdstudycell_get_campaigns_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdstudycell_get_campaigns(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdstudycell_get_campaigns(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
