...
func TestToolHours_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolHours_get()
	if tool.Name != "hours_get" {
		t.Errorf("expected tool name hours_get, got %s", tool.Name)
	}
}

func TestToolHours_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleHours_get(ctx, request)
