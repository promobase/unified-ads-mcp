...
func TestAdset_post_insights_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/insights",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/insights", FacebookGraphAPIBaseURL, adSetId)
			...
			urlParams := buildURLParamsAdset_post_insights(accessToken, tt.args, skipParams...)
...
func TestAdset_post_insights_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdset_post_insights(tt.args, skipParams...)
...
func buildBodyParamsAdset_post_insights(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdset_post_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
