...
// RegisterAdSetListAdStudiesHandler registers the ad_set_list_ad_studies tool
func RegisterAdSetListAdStudiesHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, AdSetListAdStudiesHandler)
	return nil
}

// AdSetListAdStudiesHandler handles the ad_set_list_ad_studies tool
func AdSetListAdStudiesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
