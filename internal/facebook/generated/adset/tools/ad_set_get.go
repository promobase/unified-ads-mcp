...
// RegisterAdSetGetHandler registers the ad_set_get tool
func RegisterAdSetGetHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, AdSetGetHandler)
	return nil
}

// AdSetGetHandler handles the ad_set_get tool
func AdSetGetHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
