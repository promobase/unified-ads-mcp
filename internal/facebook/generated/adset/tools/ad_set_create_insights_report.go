...
// RegisterAdSetCreateInsightsReportHandler registers the ad_set_create_insights_report tool
func RegisterAdSetCreateInsightsReportHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, AdSetCreateInsightsReportHandler)
	return nil
}

// AdSetCreateInsightsReportHandler handles the ad_set_create_insights_report tool
func AdSetCreateInsightsReportHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
