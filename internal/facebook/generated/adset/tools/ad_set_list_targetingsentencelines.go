...
// RegisterAdSetListTargetingsentencelinesHandler registers the ad_set_list_targetingsentencelines tool
func RegisterAdSetListTargetingsentencelinesHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, AdSetListTargetingsentencelinesHandler)
	return nil
}

// AdSetListTargetingsentencelinesHandler handles the ad_set_list_targetingsentencelines tool
func AdSetListTargetingsentencelinesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
