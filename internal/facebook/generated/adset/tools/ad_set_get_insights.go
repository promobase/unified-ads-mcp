...
// RegisterAdSetGetInsightsHandler registers the ad_set_get_insights tool
func RegisterAdSetGetInsightsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, AdSetGetInsightsHandler)
	return nil
}

// AdSetGetInsightsHandler handles the ad_set_get_insights tool
func AdSetGetInsightsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
