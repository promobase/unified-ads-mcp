...
func TestAdset_get_adcreatives_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/adcreatives",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/adcreatives", FacebookGraphAPIBaseURL, adSetId)
			...
			urlParams := buildURLParamsAdset_get_adcreatives(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdset_get_adcreatives(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
