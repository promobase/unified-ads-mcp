...
func TestToolAdset_get_delivery_estimate_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_get_delivery_estimate()
	if tool.Name != "adset_get_delivery_estimate" {
		t.Errorf("expected tool name adset_get_delivery_estimate, got %s", tool.Name)
	}
}

func TestToolAdset_get_delivery_estimate_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adset_get_delivery_estimate",
			...
			// Call handler
			result, err := HandleAdset_get_delivery_estimate(ctx, request)
