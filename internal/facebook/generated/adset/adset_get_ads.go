...
// ToolAdset_get_ads returns the MCP tool definition for adset_get_ads
func ToolAdset_get_ads() mcp.Tool {
	...
	return mcp.NewTool("adset_get_ads",
...
func HandleAdset_get_ads(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adset_get_ads(accessToken, args)
	if err != nil {
...
func Adset_get_ads(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/%sads", adSetId)
