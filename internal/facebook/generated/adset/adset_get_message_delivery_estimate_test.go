...
func TestAdset_get_message_delivery_estimate_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/message_delivery_estimate",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdset_get_message_delivery_estimate(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdset_get_message_delivery_estimate(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
