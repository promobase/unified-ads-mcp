...
func TestToolAdset_delete_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_delete()
	if tool.Name != "adset_delete" {
		t.Errorf("expected tool name adset_delete, got %s", tool.Name)
	}
}

func TestToolAdset_delete_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_delete(ctx, request)
