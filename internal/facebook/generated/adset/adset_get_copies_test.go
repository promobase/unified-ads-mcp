...
func TestAdset_get_copies_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdset_get_copies(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdset_get_copies(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
