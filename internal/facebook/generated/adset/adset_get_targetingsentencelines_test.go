...
func TestAdset_get_targetingsentencelines_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBaseURL: "https://graph.facebook.com/v23.0/123456789/targetingsentencelines",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdset_get_targetingsentencelines(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdset_get_targetingsentencelines(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
