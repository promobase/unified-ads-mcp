...
func TestAdset_post_adlabels_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdset_post_adlabels(accessToken, tt.args, skipParams...)
...
func TestAdset_post_adlabels_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdset_post_adlabels(tt.args, skipParams...)
...
func buildBodyParamsAdset_post_adlabels(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdset_post_adlabels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
