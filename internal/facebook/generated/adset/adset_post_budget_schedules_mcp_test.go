...
func TestToolAdset_post_budget_schedules_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_post_budget_schedules()
	if tool.Name != "adset_post_budget_schedules" {
		t.Errorf("expected tool name adset_post_budget_schedules, got %s", tool.Name)
	}
}

func TestToolAdset_post_budget_schedules_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			params := mcp.CallToolParams{
				Name:      "adset_post_budget_schedules",
			...
			// Call handler
			result, err := HandleAdset_post_budget_schedules(ctx, request)
