...
func TestToolAdset_get_ads_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_get_ads()
	if tool.Name != "adset_get_ads" {
		t.Errorf("expected tool name adset_get_ads, got %s", tool.Name)
	}
}

func TestToolAdset_get_ads_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_get_ads(ctx, request)
