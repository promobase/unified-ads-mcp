...
func TestToolAdset_post_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_post()
	if tool.Name != "adset_post" {
		t.Errorf("expected tool name adset_post, got %s", tool.Name)
	}
}

func TestToolAdset_post_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_post(ctx, request)
