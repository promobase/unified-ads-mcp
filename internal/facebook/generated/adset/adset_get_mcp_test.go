...
func TestToolAdset_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_get()
	if tool.Name != "adset_get" {
		t.Errorf("expected tool name adset_get, got %s", tool.Name)
	}
}

func TestToolAdset_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_get(ctx, request)
