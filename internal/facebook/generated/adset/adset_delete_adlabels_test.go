...
func TestAdset_delete_adlabels_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdset_delete_adlabels(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdset_delete_adlabels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
