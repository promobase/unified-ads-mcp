...
// ToolAdset_post_insights returns the MCP tool definition for adset_post_insights
func ToolAdset_post_insights() mcp.Tool {
	...
	return mcp.NewTool("adset_post_insights",
...
func HandleAdset_post_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adset_post_insights(accessToken, args)
	if err != nil {
...
func Adset_post_insights(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
