...
func TestToolAdset_post_insights_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_post_insights()
	if tool.Name != "adset_post_insights" {
		t.Errorf("expected tool name adset_post_insights, got %s", tool.Name)
	}
}

func TestToolAdset_post_insights_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_post_insights(ctx, request)
