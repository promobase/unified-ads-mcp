...
func TestToolAdset_get_adcreatives_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_get_adcreatives()
	if tool.Name != "adset_get_adcreatives" {
		t.Errorf("expected tool name adset_get_adcreatives, got %s", tool.Name)
	}
}

func TestToolAdset_get_adcreatives_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_get_adcreatives(ctx, request)
