...
func TestToolAdset_post_adlabels_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_post_adlabels()
	if tool.Name != "adset_post_adlabels" {
		t.Errorf("expected tool name adset_post_adlabels, got %s", tool.Name)
	}
}

func TestToolAdset_post_adlabels_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_post_adlabels(ctx, request)
