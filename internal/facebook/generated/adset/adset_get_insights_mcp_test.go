...
func TestToolAdset_get_insights_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAdset_get_insights()
	if tool.Name != "adset_get_insights" {
		t.Errorf("expected tool name adset_get_insights, got %s", tool.Name)
	}
}

func TestToolAdset_get_insights_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAdset_get_insights(ctx, request)
