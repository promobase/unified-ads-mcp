...
func TestAdset_post_budget_schedules_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAdset_post_budget_schedules(accessToken, tt.args, skipParams...)
...
func TestAdset_post_budget_schedules_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdset_post_budget_schedules(tt.args, skipParams...)
...
func buildBodyParamsAdset_post_budget_schedules(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdset_post_budget_schedules(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
