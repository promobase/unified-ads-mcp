...
func TestAdmonetizationproperty_get_adnetworkanalytics_results_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/adnetworkanalytics_results",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdmonetizationproperty_get_adnetworkanalytics_results(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdmonetizationproperty_get_adnetworkanalytics_results(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
