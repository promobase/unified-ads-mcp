...
// ToolAdmonetizationproperty_get_adnetworkanalytics returns the MCP tool definition for admonetizationproperty_get_adnetworkanalytics
func ToolAdmonetizationproperty_get_adnetworkanalytics() mcp.Tool {
	...
	return mcp.NewTool("admonetizationproperty_get_adnetworkanalytics",
...
func HandleAdmonetizationproperty_get_adnetworkanalytics(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Admonetizationproperty_get_adnetworkanalytics(accessToken, args)
	if err != nil {
