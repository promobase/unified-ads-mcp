...
// ToolAdmonetizationproperty_get_ returns the MCP tool definition for admonetizationproperty_get_
func ToolAdmonetizationproperty_get_() mcp.Tool {
	// Available fields for AdMonetizationProperty: owner_business

	return mcp.NewTool("admonetizationproperty_get_",
...
func HandleAdmonetizationproperty_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Admonetizationproperty_get_(accessToken, args)
	if err != nil {
...
func Admonetizationproperty_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
