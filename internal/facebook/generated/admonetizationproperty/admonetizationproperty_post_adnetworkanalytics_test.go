...
func TestAdmonetizationproperty_post_adnetworkanalytics_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/adnetworkanalytics",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdmonetizationproperty_post_adnetworkanalytics(accessToken, tt.args, skipParams...)
...
func TestAdmonetizationproperty_post_adnetworkanalytics_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAdmonetizationproperty_post_adnetworkanalytics(tt.args, skipParams...)
...
func buildBodyParamsAdmonetizationproperty_post_adnetworkanalytics(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAdmonetizationproperty_post_adnetworkanalytics(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
