...
func TestAdmonetizationproperty_get_adnetworkanalytics_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAdmonetizationproperty_get_adnetworkanalytics(accessToken, tt.args, skipParams...)
...
func buildURLParamsAdmonetizationproperty_get_adnetworkanalytics(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
