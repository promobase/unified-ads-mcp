...
// ToolIgbcadspermission_get_ returns the MCP tool definition for igbcadspermission_get_
func ToolIgbcadspermission_get_() mcp.Tool {
	// Available fields for IGBCAdsPermission: id, permission_type, status

	return mcp.NewTool("igbcadspermission_get_",
...
func HandleIgbcadspermission_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igbcadspermission_get_(accessToken, args)
	if err != nil {
...
func Igbcadspermission_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
