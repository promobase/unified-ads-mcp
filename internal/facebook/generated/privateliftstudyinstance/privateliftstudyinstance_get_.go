...
// ToolPrivateliftstudyinstance_get_ returns the MCP tool definition for privateliftstudyinstance_get_
func ToolPrivateliftstudyinstance_get_() mcp.Tool {
	...
	return mcp.NewTool("privateliftstudyinstance_get_",
...
func HandlePrivateliftstudyinstance_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Privateliftstudyinstance_get_(accessToken, args)
	if err != nil {
...
// Privateliftstudyinstance_get_ performs GET  for PrivateLiftStudyInstance
func Privateliftstudyinstance_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
