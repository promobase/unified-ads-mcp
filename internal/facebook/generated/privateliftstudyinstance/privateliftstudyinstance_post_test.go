...
func TestPrivateliftstudyinstance_post_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPrivateliftstudyinstance_post(accessToken, tt.args, skipParams...)
...
func TestPrivateliftstudyinstance_post_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPrivateliftstudyinstance_post(tt.args, skipParams...)
...
func buildBodyParamsPrivateliftstudyinstance_post(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPrivateliftstudyinstance_post(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
