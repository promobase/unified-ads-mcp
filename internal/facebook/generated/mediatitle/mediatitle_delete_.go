...
// ToolMediatitle_delete_ returns the MCP tool definition for mediatitle_delete_
func ToolMediatitle_delete_() mcp.Tool {
	
	
	return mcp.NewTool("mediatitle_delete_",
...
func HandleMediatitle_delete_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Mediatitle_delete_(accessToken, args)
	if err != nil {
...
func Mediatitle_delete_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
