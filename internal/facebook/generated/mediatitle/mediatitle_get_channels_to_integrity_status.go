...
// ToolMediatitle_get_channels_to_integrity_status returns the MCP tool definition for mediatitle_get_channels_to_integrity_status
func ToolMediatitle_get_channels_to_integrity_status() mcp.Tool {
	// Available fields for CatalogItemChannelsToIntegrityStatus: channels, rejection_information

	return mcp.NewTool("mediatitle_get_channels_to_integrity_status",
...
func HandleMediatitle_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Mediatitle_get_channels_to_integrity_status(accessToken, args)
	if err != nil {
...
func Mediatitle_get_channels_to_integrity_status(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
