...
// ToolMediatitle_get_override_details returns the MCP tool definition for mediatitle_get_override_details
func ToolMediatitle_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("mediatitle_get_override_details",
...
func HandleMediatitle_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Mediatitle_get_override_details(accessToken, args)
	if err != nil {
...
func Mediatitle_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
