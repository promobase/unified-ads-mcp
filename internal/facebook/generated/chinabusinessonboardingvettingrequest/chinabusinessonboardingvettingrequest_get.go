...
// ToolChinabusinessonboardingvettingrequest_get returns the MCP tool definition for chinabusinessonboardingvettingrequest_get
func ToolChinabusinessonboardingvettingrequest_get() mcp.Tool {
	...
	return mcp.NewTool("chinabusinessonboardingvettingrequest_get",
...
// HandleChinabusinessonboardingvettingrequest_get handles the chinabusinessonboardingvettingrequest_get tool with context-based auth
func HandleChinabusinessonboardingvettingrequest_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Chinabusinessonboardingvettingrequest_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute chinabusinessonboardingvettingrequest_get: %v", err)), nil
	}
...
// Chinabusinessonboardingvettingrequest_get performs GET  for ChinaBusinessOnboardingVettingRequest
func Chinabusinessonboardingvettingrequest_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
