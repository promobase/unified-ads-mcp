...
func TestLink_get_likes_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsLink_get_likes(accessToken, tt.args, skipParams...)
...
func buildURLParamsLink_get_likes(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
