...
// ToolLink_get_ returns the MCP tool definition for link_get_
func ToolLink_get_() mcp.Tool {
...
func HandleLink_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Link_get_(accessToken, args)
	if err != nil {
...
// Link_get_ performs GET  for Link
func Link_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
