...
// ToolAdlightadgroup_get_ returns the MCP tool definition for adlightadgroup_get_
func ToolAdlightadgroup_get_() mcp.Tool {
	// Available fields for AdLightAdgroup: adset_id, id

	return mcp.NewTool("adlightadgroup_get_",
...
func HandleAdlightadgroup_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adlightadgroup_get_(accessToken, args)
	if err != nil {
...
// Adlightadgroup_get_ performs GET  for AdLightAdgroup
func Adlightadgroup_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
