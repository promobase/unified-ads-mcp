...
// ToolUser_get_adaccounts returns the MCP tool definition for user_get_adaccounts
func ToolUser_get_adaccounts() mcp.Tool {
	...
	return mcp.NewTool("user_get_adaccounts",
...
func HandleUser_get_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_adaccounts(accessToken, args)
	if err != nil {
...
func User_get_adaccounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
