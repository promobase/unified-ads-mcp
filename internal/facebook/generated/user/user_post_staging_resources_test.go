...
func TestUser_post_staging_resources_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/staging_resources",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsUser_post_staging_resources(accessToken, tt.args, skipParams...)
...
func TestUser_post_staging_resources_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsUser_post_staging_resources(tt.args, skipParams...)
...
func buildBodyParamsUser_post_staging_resources(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsUser_post_staging_resources(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
