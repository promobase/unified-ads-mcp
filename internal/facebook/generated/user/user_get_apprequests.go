...
// ToolUser_get_apprequests returns the MCP tool definition for user_get_apprequests
func ToolUser_get_apprequests() mcp.Tool {
	// Available fields for AppRequest: action_type, application, created_time, data, from, id, message, object, to
	
	return mcp.NewTool("user_get_apprequests",
...
func HandleUser_get_apprequests(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_apprequests(accessToken, args)
	if err != nil {
...
func User_get_apprequests(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
