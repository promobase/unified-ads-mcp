...
func TestUser_get_personal_ad_accounts_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/personal_ad_accounts",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsUser_get_personal_ad_accounts(accessToken, tt.args, skipParams...)
...
func buildURLParamsUser_get_personal_ad_accounts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
