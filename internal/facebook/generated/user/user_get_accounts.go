...
// ToolUser_get_accounts returns the MCP tool definition for user_get_accounts
func ToolUser_get_accounts() mcp.Tool {
	...
	return mcp.NewTool("user_get_accounts",
...
func HandleUser_get_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_accounts(accessToken, args)
	if err != nil {
...
func User_get_accounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
