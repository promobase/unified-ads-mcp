...
func TestToolUser_post_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolUser_post()
	if tool.Name != "user_post" {
		t.Errorf("expected tool name user_post, got %s", tool.Name)
	}
}

func TestToolUser_post_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleUser_post(ctx, request)
