...
// ToolUser_get_ids_for_apps returns the MCP tool definition for user_get_ids_for_apps
func ToolUser_get_ids_for_apps() mcp.Tool {
	// Available fields for UserIDForApp: app, id
	// Params object accepts: app (int)
	return mcp.NewTool("user_get_ids_for_apps",
...
func HandleUser_get_ids_for_apps(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_ids_for_apps(accessToken, args)
	if err != nil {
...
func User_get_ids_for_apps(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
