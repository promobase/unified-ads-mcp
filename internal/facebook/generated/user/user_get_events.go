...
// ToolUser_get_events returns the MCP tool definition for user_get_events
func ToolUser_get_events() mcp.Tool {
	...
	return mcp.NewTool("user_get_events",
...
func HandleUser_get_events(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_events(accessToken, args)
	if err != nil {
...
func User_get_events(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
