...
// ToolUser_post_videos returns the MCP tool definition for user_post_videos
func ToolUser_post_videos() mcp.Tool {
	...
	return mcp.NewTool("user_post_videos",
...
func HandleUser_post_videos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_post_videos(accessToken, args)
	if err != nil {
...
func User_post_videos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
