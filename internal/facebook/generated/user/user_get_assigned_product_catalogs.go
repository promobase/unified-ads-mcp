...
// ToolUser_get_assigned_product_catalogs returns the MCP tool definition for user_get_assigned_product_catalogs
func ToolUser_get_assigned_product_catalogs() mcp.Tool {
	...
	return mcp.NewTool("user_get_assigned_product_catalogs",
...
func HandleUser_get_assigned_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_assigned_product_catalogs(accessToken, args)
	if err != nil {
