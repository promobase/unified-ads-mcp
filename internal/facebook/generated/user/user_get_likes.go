...
// ToolUser_get_likes returns the MCP tool definition for user_get_likes
func ToolUser_get_likes() mcp.Tool {
	...
	return mcp.NewTool("user_get_likes",
...
func HandleUser_get_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_likes(accessToken, args)
	if err != nil {
...
func User_get_likes(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
