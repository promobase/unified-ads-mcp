...
// ToolUser_get_ids_for_pages returns the MCP tool definition for user_get_ids_for_pages
func ToolUser_get_ids_for_pages() mcp.Tool {
	// Available fields for UserIDForPage: id, page
	// Params object accepts: page (int)
	return mcp.NewTool("user_get_ids_for_pages",
...
func HandleUser_get_ids_for_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_ids_for_pages(accessToken, args)
	if err != nil {
...
func User_get_ids_for_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
