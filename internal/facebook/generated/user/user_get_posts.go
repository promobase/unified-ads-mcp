...
// ToolUser_get_posts returns the MCP tool definition for user_get_posts
func ToolUser_get_posts() mcp.Tool {
	...
	return mcp.NewTool("user_get_posts",
...
func HandleUser_get_posts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_posts(accessToken, args)
	if err != nil {
...
func User_get_posts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
