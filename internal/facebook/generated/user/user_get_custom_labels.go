...
// ToolUser_get_custom_labels returns the MCP tool definition for user_get_custom_labels
func ToolUser_get_custom_labels() mcp.Tool {
	// Available fields for PageUserMessageThreadLabel: id, page_label_name

	return mcp.NewTool("user_get_custom_labels",
...
func HandleUser_get_custom_labels(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_custom_labels(accessToken, args)
	if err != nil {
