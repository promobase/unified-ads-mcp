...
// ToolUser_get_videos returns the MCP tool definition for user_get_videos
func ToolUser_get_videos() mcp.Tool {
	...
	return mcp.NewTool("user_get_videos",
...
func HandleUser_get_videos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_videos(accessToken, args)
	if err != nil {
