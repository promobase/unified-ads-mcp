...
// ToolUser_get_music returns the MCP tool definition for user_get_music
func ToolUser_get_music() mcp.Tool {
	...
	return mcp.NewTool("user_get_music",
...
func HandleUser_get_music(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_music(accessToken, args)
	if err != nil {
