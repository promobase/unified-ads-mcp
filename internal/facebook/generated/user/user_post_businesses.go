...
// ToolUser_post_businesses returns the MCP tool definition for user_post_businesses
func ToolUser_post_businesses() mcp.Tool {
	...
	return mcp.NewTool("user_post_businesses",
...
func HandleUser_post_businesses(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_post_businesses(accessToken, args)
	if err != nil {
