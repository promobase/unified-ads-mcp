...
// ToolUser_get_assigned_ad_accounts returns the MCP tool definition for user_get_assigned_ad_accounts
func ToolUser_get_assigned_ad_accounts() mcp.Tool {
	...
	return mcp.NewTool("user_get_assigned_ad_accounts",
...
func HandleUser_get_assigned_ad_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_assigned_ad_accounts(accessToken, args)
	if err != nil {
