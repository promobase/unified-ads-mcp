...
func TestUser_post_messenger_kids_accounts_unread_badge_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/messenger_kids_accounts_unread_badge",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsUser_post_messenger_kids_accounts_unread_badge(accessToken, tt.args, skipParams...)
...
func TestUser_post_messenger_kids_accounts_unread_badge_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsUser_post_messenger_kids_accounts_unread_badge(tt.args, skipParams...)
...
func buildBodyParamsUser_post_messenger_kids_accounts_unread_badge(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsUser_post_messenger_kids_accounts_unread_badge(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
