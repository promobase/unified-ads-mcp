...
func TestUser_delete_access_tokens_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsUser_delete_access_tokens(accessToken, tt.args, skipParams...)
...
func buildURLParamsUser_delete_access_tokens(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
