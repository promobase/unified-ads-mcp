...
// ToolUser_get_ returns the MCP tool definition for user_get_
func ToolUser_get_() mcp.Tool {
...
func HandleUser_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_(accessToken, args)
	if err != nil {
...
func User_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
