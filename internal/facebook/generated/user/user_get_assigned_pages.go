...
// ToolUser_get_assigned_pages returns the MCP tool definition for user_get_assigned_pages
func ToolUser_get_assigned_pages() mcp.Tool {
	...
	return mcp.NewTool("user_get_assigned_pages",
...
func HandleUser_get_assigned_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_assigned_pages(accessToken, args)
	if err != nil {
...
func User_get_assigned_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
