...
// RegisterUserListAdStudiesHandler registers the user_list_ad_studies tool
func RegisterUserListAdStudiesHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListAdStudiesHandler)
	return nil
}

// UserListAdStudiesHandler handles the user_list_ad_studies tool
func UserListAdStudiesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
