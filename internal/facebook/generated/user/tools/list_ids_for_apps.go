...
// RegisterUserListIdsForAppsHandler registers the user_list_ids_for_apps tool
func RegisterUserListIdsForAppsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListIdsForAppsHandler)
	return nil
}

// UserListIdsForAppsHandler handles the user_list_ids_for_apps tool
func UserListIdsForAppsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args user_list_ids_for_appsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/ids_for_apps", args.ID)
