...
// RegisterUserGetHandler registers the user_get tool
func RegisterUserGetHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserGetHandler)
	return nil
}

// UserGetHandler handles the user_get tool
func UserGetHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
