...
// RegisterUserListFundraisersHandler registers the user_list_fundraisers tool
func RegisterUserListFundraisersHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListFundraisersHandler)
	return nil
}

// UserListFundraisersHandler handles the user_list_fundraisers tool
func UserListFundraisersHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
