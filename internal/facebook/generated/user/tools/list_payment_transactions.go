...
// RegisterUserListPaymentTransactionsHandler registers the user_list_payment_transactions tool
func RegisterUserListPaymentTransactionsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListPaymentTransactionsHandler)
	return nil
}

// UserListPaymentTransactionsHandler handles the user_list_payment_transactions tool
func UserListPaymentTransactionsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
