...
// RegisterUserListBusinessesHandler registers the user_list_businesses tool
func RegisterUserListBusinessesHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListBusinessesHandler)
	return nil
}

// UserListBusinessesHandler handles the user_list_businesses tool
func UserListBusinessesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
