...
// RegisterUserListApprequestsHandler registers the user_list_apprequests tool
func RegisterUserListApprequestsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListApprequestsHandler)
	return nil
}

// UserListApprequestsHandler handles the user_list_apprequests tool
func UserListApprequestsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args user_list_apprequestsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/apprequests", args.ID)
