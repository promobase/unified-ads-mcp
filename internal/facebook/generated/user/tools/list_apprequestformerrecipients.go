...
// RegisterUserListApprequestformerrecipientsHandler registers the user_list_apprequestformerrecipients tool
func RegisterUserListApprequestformerrecipientsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListApprequestformerrecipientsHandler)
	return nil
}

// UserListApprequestformerrecipientsHandler handles the user_list_apprequestformerrecipients tool
func UserListApprequestformerrecipientsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
