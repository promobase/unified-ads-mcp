...
// RegisterUserListAssignedAdAccountsHandler registers the user_list_assigned_ad_accounts tool
func RegisterUserListAssignedAdAccountsHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListAssignedAdAccountsHandler)
	return nil
}

// UserListAssignedAdAccountsHandler handles the user_list_assigned_ad_accounts tool
func UserListAssignedAdAccountsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	var args user_list_assigned_ad_accountsArgs
	if err := request.BindArguments(&args); err != nil {
		return common.HandleBindError(err)
	}
	endpoint := fmt.Sprintf("/%s/assigned_ad_accounts", args.ID)
