...
// RegisterUserListVideosHandler registers the user_list_videos tool
func RegisterUserListVideosHandler(s *server.MCPServer) error {
	...
	s.AddTool(tool, UserListVideosHandler)
	return nil
}

// UserListVideosHandler handles the user_list_videos tool
func UserListVideosHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
