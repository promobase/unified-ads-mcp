...
// ToolUser_get_photos returns the MCP tool definition for user_get_photos
func ToolUser_get_photos() mcp.Tool {
	...
	return mcp.NewTool("user_get_photos",
...
func HandleUser_get_photos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_photos(accessToken, args)
	if err != nil {
...
func User_get_photos(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
