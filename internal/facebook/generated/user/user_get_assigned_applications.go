...
// ToolUser_get_assigned_applications returns the MCP tool definition for user_get_assigned_applications
func ToolUser_get_assigned_applications() mcp.Tool {
	...
	return mcp.NewTool("user_get_assigned_applications",
...
func HandleUser_get_assigned_applications(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_assigned_applications(accessToken, args)
	if err != nil {
