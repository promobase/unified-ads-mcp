...
func TestToolUser_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolUser_get()
	if tool.Name != "user_get" {
		t.Errorf("expected tool name user_get, got %s", tool.Name)
	}
}

func TestToolUser_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleUser_get(ctx, request)
