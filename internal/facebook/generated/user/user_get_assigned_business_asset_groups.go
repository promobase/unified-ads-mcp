...
// ToolUser_get_assigned_business_asset_groups returns the MCP tool definition for user_get_assigned_business_asset_groups
func ToolUser_get_assigned_business_asset_groups() mcp.Tool {
	// Available fields for BusinessAssetGroup: id, name, owner_business
	// Params object accepts: contained_asset_id (string)
	return mcp.NewTool("user_get_assigned_business_asset_groups",
...
func HandleUser_get_assigned_business_asset_groups(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_get_assigned_business_asset_groups(accessToken, args)
	if err != nil {
...
func User_get_assigned_business_asset_groups(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
