...
// ToolUser_post_live_videos returns the MCP tool definition for user_post_live_videos
func ToolUser_post_live_videos() mcp.Tool {
	...
	return mcp.NewTool("user_post_live_videos",
...
func HandleUser_post_live_videos(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := User_post_live_videos(accessToken, args)
	if err != nil {
