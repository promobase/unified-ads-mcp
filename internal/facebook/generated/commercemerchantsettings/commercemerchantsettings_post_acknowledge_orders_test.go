...
func TestCommercemerchantsettings_post_acknowledge_orders_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/acknowledge_orders",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommercemerchantsettings_post_acknowledge_orders(accessToken, tt.args, skipParams...)
...
func TestCommercemerchantsettings_post_acknowledge_orders_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCommercemerchantsettings_post_acknowledge_orders(tt.args, skipParams...)
...
func buildBodyParamsCommercemerchantsettings_post_acknowledge_orders(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCommercemerchantsettings_post_acknowledge_orders(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
