...
func TestCommercemerchantsettings_get_tax_settings_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/tax_settings",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommercemerchantsettings_get_tax_settings(accessToken, tt.args, skipParams...)
...
func buildURLParamsCommercemerchantsettings_get_tax_settings(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
