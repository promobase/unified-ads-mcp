...
// ToolCommercemerchantsettings_get_commerce_orders returns the MCP tool definition for commercemerchantsettings_get_commerce_orders
func ToolCommercemerchantsettings_get_commerce_orders() mcp.Tool {
	...
	return mcp.NewTool("commercemerchantsettings_get_commerce_orders",
