...
func TestCommercemerchantsettings_post_order_management_apps_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/order_management_apps",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommercemerchantsettings_post_order_management_apps(accessToken, tt.args, skipParams...)
...
func TestCommercemerchantsettings_post_order_management_apps_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCommercemerchantsettings_post_order_management_apps(tt.args, skipParams...)
...
func buildBodyParamsCommercemerchantsettings_post_order_management_apps(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCommercemerchantsettings_post_order_management_apps(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
