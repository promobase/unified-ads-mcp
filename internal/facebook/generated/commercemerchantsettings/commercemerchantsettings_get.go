...
// ToolCommercemerchantsettings_get returns the MCP tool definition for commercemerchantsettings_get
func ToolCommercemerchantsettings_get() mcp.Tool {
	...
	return mcp.NewTool("commercemerchantsettings_get",
...
// HandleCommercemerchantsettings_get handles the commercemerchantsettings_get tool with context-based auth
func HandleCommercemerchantsettings_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Commercemerchantsettings_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute commercemerchantsettings_get: %v", err)), nil
	}
...
// Commercemerchantsettings_get performs GET  for CommerceMerchantSettings
func Commercemerchantsettings_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
