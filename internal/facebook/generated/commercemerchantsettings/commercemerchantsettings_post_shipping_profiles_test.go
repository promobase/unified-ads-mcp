...
func TestCommercemerchantsettings_post_shipping_profiles_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/shipping_profiles",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommercemerchantsettings_post_shipping_profiles(accessToken, tt.args, skipParams...)
...
func TestCommercemerchantsettings_post_shipping_profiles_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsCommercemerchantsettings_post_shipping_profiles(tt.args, skipParams...)
...
func buildBodyParamsCommercemerchantsettings_post_shipping_profiles(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsCommercemerchantsettings_post_shipping_profiles(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
