...
// ToolCommercemerchantsettings_get_product_catalogs returns the MCP tool definition for commercemerchantsettings_get_product_catalogs
func ToolCommercemerchantsettings_get_product_catalogs() mcp.Tool {
	...
	return mcp.NewTool("commercemerchantsettings_get_product_catalogs",
...
func HandleCommercemerchantsettings_get_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Commercemerchantsettings_get_product_catalogs(accessToken, args)
	if err != nil {
...
func Commercemerchantsettings_get_product_catalogs(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
