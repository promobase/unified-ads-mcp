...
func TestCommercemerchantsettings_get_returns_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsCommercemerchantsettings_get_returns(accessToken, tt.args, skipParams...)
...
func buildURLParamsCommercemerchantsettings_get_returns(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
