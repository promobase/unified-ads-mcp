...
// ToolWhatsappbusinessaccount_get_audiences returns the MCP tool definition for whatsappbusinessaccount_get_audiences
func ToolWhatsappbusinessaccount_get_audiences() mcp.Tool {
	
	
	return mcp.NewTool("whatsappbusinessaccount_get_audiences",
...
func HandleWhatsappbusinessaccount_get_audiences(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_audiences(accessToken, args)
	if err != nil {
...
func Whatsappbusinessaccount_get_audiences(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
