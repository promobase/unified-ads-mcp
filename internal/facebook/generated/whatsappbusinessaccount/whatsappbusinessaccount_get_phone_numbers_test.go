...
func TestWhatsappbusinessaccount_get_phone_numbers_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinessaccount_get_phone_numbers(accessToken, tt.args, skipParams...)
...
func buildURLParamsWhatsappbusinessaccount_get_phone_numbers(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
