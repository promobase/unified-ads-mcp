...
func TestWhatsappbusinessaccount_get_message_campaigns_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/message_campaigns",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinessaccount_get_message_campaigns(accessToken, tt.args, skipParams...)
...
func buildURLParamsWhatsappbusinessaccount_get_message_campaigns(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
