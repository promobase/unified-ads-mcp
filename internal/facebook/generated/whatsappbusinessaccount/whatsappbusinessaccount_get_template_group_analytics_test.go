...
func TestWhatsappbusinessaccount_get_template_group_analytics_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/template_group_analytics",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = FacebookGraphAPIBaseURL + "/template_group_analytics"
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinessaccount_get_template_group_analytics(accessToken, tt.args, skipParams...)
...
func buildURLParamsWhatsappbusinessaccount_get_template_group_analytics(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
