...
// ToolWhatsappbusinessaccount_get_solutions returns the MCP tool definition for whatsappbusinessaccount_get_solutions
func ToolWhatsappbusinessaccount_get_solutions() mcp.Tool {

	return mcp.NewTool("whatsappbusinessaccount_get_solutions",
...
func HandleWhatsappbusinessaccount_get_solutions(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_solutions(accessToken, args)
	if err != nil {
