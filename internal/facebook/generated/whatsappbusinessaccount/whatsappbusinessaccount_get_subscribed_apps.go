...
// ToolWhatsappbusinessaccount_get_subscribed_apps returns the MCP tool definition for whatsappbusinessaccount_get_subscribed_apps
func ToolWhatsappbusinessaccount_get_subscribed_apps() mcp.Tool {

	return mcp.NewTool("whatsappbusinessaccount_get_subscribed_apps",
...
func HandleWhatsappbusinessaccount_get_subscribed_apps(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_subscribed_apps(accessToken, args)
	if err != nil {
...
func Whatsappbusinessaccount_get_subscribed_apps(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
