...
func TestWhatsappbusinessaccount_post_flows_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/flows",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinessaccount_post_flows(accessToken, tt.args, skipParams...)
...
func TestWhatsappbusinessaccount_post_flows_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsWhatsappbusinessaccount_post_flows(tt.args, skipParams...)
...
func buildBodyParamsWhatsappbusinessaccount_post_flows(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsWhatsappbusinessaccount_post_flows(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
