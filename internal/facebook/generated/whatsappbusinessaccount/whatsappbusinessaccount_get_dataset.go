...
// ToolWhatsappbusinessaccount_get_dataset returns the MCP tool definition for whatsappbusinessaccount_get_dataset
func ToolWhatsappbusinessaccount_get_dataset() mcp.Tool {
	// Available fields for Dataset: id, name
	
	return mcp.NewTool("whatsappbusinessaccount_get_dataset",
...
func HandleWhatsappbusinessaccount_get_dataset(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_dataset(accessToken, args)
	if err != nil {
...
func Whatsappbusinessaccount_get_dataset(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
