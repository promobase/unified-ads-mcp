...
// ToolWhatsappbusinessaccount_get_template_groups returns the MCP tool definition for whatsappbusinessaccount_get_template_groups
func ToolWhatsappbusinessaccount_get_template_groups() mcp.Tool {

	return mcp.NewTool("whatsappbusinessaccount_get_template_groups",
...
func HandleWhatsappbusinessaccount_get_template_groups(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_template_groups(accessToken, args)
	if err != nil {
