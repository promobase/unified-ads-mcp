...
// ToolWhatsappbusinessaccount_get_ returns the MCP tool definition for whatsappbusinessaccount_get_
func ToolWhatsappbusinessaccount_get_() mcp.Tool {
	...
	return mcp.NewTool("whatsappbusinessaccount_get_",
...
func HandleWhatsappbusinessaccount_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_(accessToken, args)
	if err != nil {
...
func Whatsappbusinessaccount_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
