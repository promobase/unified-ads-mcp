...
func TestWhatsappbusinessaccount_get_flows_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinessaccount_get_flows(accessToken, tt.args, skipParams...)
...
func buildURLParamsWhatsappbusinessaccount_get_flows(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
