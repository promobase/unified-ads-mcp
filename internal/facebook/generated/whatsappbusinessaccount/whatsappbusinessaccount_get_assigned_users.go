...
// ToolWhatsappbusinessaccount_get_assigned_users returns the MCP tool definition for whatsappbusinessaccount_get_assigned_users
func ToolWhatsappbusinessaccount_get_assigned_users() mcp.Tool {
	// Available fields for AssignedUser: business, id, name, user_type
	// Params object accepts: business (string)
	return mcp.NewTool("whatsappbusinessaccount_get_assigned_users",
...
func HandleWhatsappbusinessaccount_get_assigned_users(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_assigned_users(accessToken, args)
	if err != nil {
