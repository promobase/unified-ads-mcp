...
func TestWhatsappbusinessaccount_post_product_catalogs_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/product_catalogs",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinessaccount_post_product_catalogs(accessToken, tt.args, skipParams...)
...
func TestWhatsappbusinessaccount_post_product_catalogs_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsWhatsappbusinessaccount_post_product_catalogs(tt.args, skipParams...)
...
func buildBodyParamsWhatsappbusinessaccount_post_product_catalogs(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsWhatsappbusinessaccount_post_product_catalogs(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
