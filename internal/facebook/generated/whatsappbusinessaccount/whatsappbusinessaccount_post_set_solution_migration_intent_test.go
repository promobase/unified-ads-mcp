...
func TestWhatsappbusinessaccount_post_set_solution_migration_intent_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/set_solution_migration_intent",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsWhatsappbusinessaccount_post_set_solution_migration_intent(accessToken, tt.args, skipParams...)
...
func TestWhatsappbusinessaccount_post_set_solution_migration_intent_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsWhatsappbusinessaccount_post_set_solution_migration_intent(tt.args, skipParams...)
...
func buildBodyParamsWhatsappbusinessaccount_post_set_solution_migration_intent(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsWhatsappbusinessaccount_post_set_solution_migration_intent(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
