...
// ToolWhatsappbusinessaccount_get_product_catalogs returns the MCP tool definition for whatsappbusinessaccount_get_product_catalogs
func ToolWhatsappbusinessaccount_get_product_catalogs() mcp.Tool {
	...
	return mcp.NewTool("whatsappbusinessaccount_get_product_catalogs",
...
func HandleWhatsappbusinessaccount_get_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_product_catalogs(accessToken, args)
	if err != nil {
...
func Whatsappbusinessaccount_get_product_catalogs(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
