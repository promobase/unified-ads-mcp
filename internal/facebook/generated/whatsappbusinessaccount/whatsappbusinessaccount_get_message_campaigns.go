...
// ToolWhatsappbusinessaccount_get_message_campaigns returns the MCP tool definition for whatsappbusinessaccount_get_message_campaigns
func ToolWhatsappbusinessaccount_get_message_campaigns() mcp.Tool {
	
	
	return mcp.NewTool("whatsappbusinessaccount_get_message_campaigns",
...
func HandleWhatsappbusinessaccount_get_message_campaigns(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Whatsappbusinessaccount_get_message_campaigns(accessToken, args)
	if err != nil {
