...
// ToolUserpageonetimeoptintokensettings_get_ returns the MCP tool definition for userpageonetimeoptintokensettings_get_
func ToolUserpageonetimeoptintokensettings_get_() mcp.Tool {
	...
	return mcp.NewTool("userpageonetimeoptintokensettings_get_",
...
func HandleUserpageonetimeoptintokensettings_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Userpageonetimeoptintokensettings_get_(accessToken, args)
	if err != nil {
...
func Userpageonetimeoptintokensettings_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
