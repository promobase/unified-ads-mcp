...
// ToolOpenbridgeconfiguration_get returns the MCP tool definition for openbridgeconfiguration_get
func ToolOpenbridgeconfiguration_get() mcp.Tool {
	...
	return mcp.NewTool("openbridgeconfiguration_get",
...
// HandleOpenbridgeconfiguration_get handles the openbridgeconfiguration_get tool with context-based auth
func HandleOpenbridgeconfiguration_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Openbridgeconfiguration_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute openbridgeconfiguration_get: %v", err)), nil
	}
...
// Openbridgeconfiguration_get performs GET  for OpenBridgeConfiguration
func Openbridgeconfiguration_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
