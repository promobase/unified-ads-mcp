...
// ToolOpenbridgeconfiguration_post returns the MCP tool definition for openbridgeconfiguration_post
func ToolOpenbridgeconfiguration_post() mcp.Tool {
	...
	return mcp.NewTool("openbridgeconfiguration_post",
...
// HandleOpenbridgeconfiguration_post handles the openbridgeconfiguration_post tool with context-based auth
func HandleOpenbridgeconfiguration_post(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Openbridgeconfiguration_post(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute openbridgeconfiguration_post: %v", err)), nil
	}
...
// Openbridgeconfiguration_post performs POST  for OpenBridgeConfiguration
