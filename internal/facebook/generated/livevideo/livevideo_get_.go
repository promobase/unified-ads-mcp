...
// ToolLivevideo_get_ returns the MCP tool definition for livevideo_get_
func ToolLivevideo_get_() mcp.Tool {
	...
	return mcp.NewTool("livevideo_get_",
...
func HandleLivevideo_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Livevideo_get_(accessToken, args)
	if err != nil {
...
func Livevideo_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
