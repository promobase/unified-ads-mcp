...
func TestLivevideo_post_input_streams_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/input_streams",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsLivevideo_post_input_streams(accessToken, tt.args, skipParams...)
...
func TestLivevideo_post_input_streams_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsLivevideo_post_input_streams(tt.args, skipParams...)
...
func buildBodyParamsLivevideo_post_input_streams(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsLivevideo_post_input_streams(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
