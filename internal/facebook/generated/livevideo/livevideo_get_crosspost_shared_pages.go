...
// ToolLivevideo_get_crosspost_shared_pages returns the MCP tool definition for livevideo_get_crosspost_shared_pages
func ToolLivevideo_get_crosspost_shared_pages() mcp.Tool {
	...
	return mcp.NewTool("livevideo_get_crosspost_shared_pages",
...
func HandleLivevideo_get_crosspost_shared_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Livevideo_get_crosspost_shared_pages(accessToken, args)
	if err != nil {
...
func Livevideo_get_crosspost_shared_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
