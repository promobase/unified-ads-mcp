...
// ToolLivevideo_get_polls returns the MCP tool definition for livevideo_get_polls
func ToolLivevideo_get_polls() mcp.Tool {
	// Available fields for VideoPoll: close_after_voting, default_open, id, question, show_gradient, show_results, status

	return mcp.NewTool("livevideo_get_polls",
...
func HandleLivevideo_get_polls(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Livevideo_get_polls(accessToken, args)
	if err != nil {
...
func Livevideo_get_polls(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
