...
func TestLivevideo_get_crosspost_shared_pages_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/crosspost_shared_pages",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsLivevideo_get_crosspost_shared_pages(accessToken, tt.args, skipParams...)
...
func buildURLParamsLivevideo_get_crosspost_shared_pages(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
