...
// ToolLivevideo_get_comments returns the MCP tool definition for livevideo_get_comments
func ToolLivevideo_get_comments() mcp.Tool {
	...
	return mcp.NewTool("livevideo_get_comments",
...
func HandleLivevideo_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Livevideo_get_comments(accessToken, args)
	if err != nil {
...
func Livevideo_get_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
