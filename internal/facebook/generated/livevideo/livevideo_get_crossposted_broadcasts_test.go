...
func TestLivevideo_get_crossposted_broadcasts_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/crossposted_broadcasts",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsLivevideo_get_crossposted_broadcasts(accessToken, tt.args, skipParams...)
...
func buildURLParamsLivevideo_get_crossposted_broadcasts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
