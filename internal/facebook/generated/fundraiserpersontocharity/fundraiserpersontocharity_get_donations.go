...
// ToolFundraiserpersontocharity_get_donations returns the MCP tool definition for fundraiserpersontocharity_get_donations
func ToolFundraiserpersontocharity_get_donations() mcp.Tool {

	return mcp.NewTool("fundraiserpersontocharity_get_donations",
...
func HandleFundraiserpersontocharity_get_donations(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Fundraiserpersontocharity_get_donations(accessToken, args)
	if err != nil {
