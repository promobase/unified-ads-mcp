...
func TestFundraiserpersontocharity_post_end_fundraiser_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/end_fundraiser",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsFundraiserpersontocharity_post_end_fundraiser(accessToken, tt.args, skipParams...)
...
func TestFundraiserpersontocharity_post_end_fundraiser_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsFundraiserpersontocharity_post_end_fundraiser(tt.args, skipParams...)
...
func buildBodyParamsFundraiserpersontocharity_post_end_fundraiser(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsFundraiserpersontocharity_post_end_fundraiser(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
