...
func TestFundraiserpersontocharity_get_donations_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/donations",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsFundraiserpersontocharity_get_donations(accessToken, tt.args, skipParams...)
...
func buildURLParamsFundraiserpersontocharity_get_donations(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
