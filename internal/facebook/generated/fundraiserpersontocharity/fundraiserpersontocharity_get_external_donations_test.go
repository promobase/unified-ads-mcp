...
func TestFundraiserpersontocharity_get_external_donations_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsFundraiserpersontocharity_get_external_donations(accessToken, tt.args, skipParams...)
...
func buildURLParamsFundraiserpersontocharity_get_external_donations(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
