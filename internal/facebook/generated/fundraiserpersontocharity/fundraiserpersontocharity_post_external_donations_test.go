...
func TestFundraiserpersontocharity_post_external_donations_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/external_donations",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsFundraiserpersontocharity_post_external_donations(accessToken, tt.args, skipParams...)
...
func TestFundraiserpersontocharity_post_external_donations_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsFundraiserpersontocharity_post_external_donations(tt.args, skipParams...)
...
func buildBodyParamsFundraiserpersontocharity_post_external_donations(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsFundraiserpersontocharity_post_external_donations(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
