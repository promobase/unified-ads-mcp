...
func TestToolAvatar_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAvatar_get()
	if tool.Name != "avatar_get" {
		t.Errorf("expected tool name avatar_get, got %s", tool.Name)
	}
}

func TestToolAvatar_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAvatar_get(ctx, request)
