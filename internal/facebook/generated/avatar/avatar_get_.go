...
// ToolAvatar_get_ returns the MCP tool definition for avatar_get_
func ToolAvatar_get_() mcp.Tool {
	// Available fields for Avatar: id

	return mcp.NewTool("avatar_get_",
...
func HandleAvatar_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Avatar_get_(accessToken, args)
	if err != nil {
...
func Avatar_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
