...
// ToolAdaccountcreationrequest_get returns the MCP tool definition for adaccountcreationrequest_get
func ToolAdaccountcreationrequest_get() mcp.Tool {
	...
	return mcp.NewTool("adaccountcreationrequest_get",
...
// HandleAdaccountcreationrequest_get handles the adaccountcreationrequest_get tool with context-based auth
func HandleAdaccountcreationrequest_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adaccountcreationrequest_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute adaccountcreationrequest_get: %v", err)), nil
	}
...
// Adaccountcreationrequest_get performs GET  for AdAccountCreationRequest
func Adaccountcreationrequest_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
