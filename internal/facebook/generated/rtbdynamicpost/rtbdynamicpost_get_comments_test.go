...
func TestRtbdynamicpost_get_comments_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsRtbdynamicpost_get_comments(accessToken, tt.args, skipParams...)
...
func buildURLParamsRtbdynamicpost_get_comments(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
