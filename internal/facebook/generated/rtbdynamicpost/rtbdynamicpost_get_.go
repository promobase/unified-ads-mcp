...
// ToolRtbdynamicpost_get_ returns the MCP tool definition for rtbdynamicpost_get_
func ToolRtbdynamicpost_get_() mcp.Tool {
	...
	return mcp.NewTool("rtbdynamicpost_get_",
...
func HandleRtbdynamicpost_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Rtbdynamicpost_get_(accessToken, args)
	if err != nil {
...
func Rtbdynamicpost_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
