...
// ToolRtbdynamicpost_get_comments returns the MCP tool definition for rtbdynamicpost_get_comments
func ToolRtbdynamicpost_get_comments() mcp.Tool {
	...
	return mcp.NewTool("rtbdynamicpost_get_comments",
...
func HandleRtbdynamicpost_get_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Rtbdynamicpost_get_comments(accessToken, args)
	if err != nil {
