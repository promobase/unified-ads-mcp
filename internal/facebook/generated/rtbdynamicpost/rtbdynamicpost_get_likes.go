...
// ToolRtbdynamicpost_get_likes returns the MCP tool definition for rtbdynamicpost_get_likes
func ToolRtbdynamicpost_get_likes() mcp.Tool {
	// Available fields for Profile: can_post, id, link, name, pic, pic_crop, pic_large, pic_small, pic_square, profile_type, username
	
	return mcp.NewTool("rtbdynamicpost_get_likes",
...
func HandleRtbdynamicpost_get_likes(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Rtbdynamicpost_get_likes(accessToken, args)
	if err != nil {
...
func Rtbdynamicpost_get_likes(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
