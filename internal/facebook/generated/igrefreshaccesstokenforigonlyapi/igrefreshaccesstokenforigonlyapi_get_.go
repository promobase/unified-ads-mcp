...
// ToolIgrefreshaccesstokenforigonlyapi_get_ returns the MCP tool definition for igrefreshaccesstokenforigonlyapi_get_
func ToolIgrefreshaccesstokenforigonlyapi_get_() mcp.Tool {

	// Params object accepts: access_token (string), grant_type (string)
	return mcp.NewTool("igrefreshaccesstokenforigonlyapi_get_",
...
func HandleIgrefreshaccesstokenforigonlyapi_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igrefreshaccesstokenforigonlyapi_get_(accessToken, args)
	if err != nil {
...
// Igrefreshaccesstokenforigonlyapi_get_ performs GET  for IGRefreshAccessTokenForIGOnlyAPI
func Igrefreshaccesstokenforigonlyapi_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
