...
func TestAutomotivemodel_get_videos_metadata_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsAutomotivemodel_get_videos_metadata(accessToken, tt.args, skipParams...)
...
func buildURLParamsAutomotivemodel_get_videos_metadata(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
