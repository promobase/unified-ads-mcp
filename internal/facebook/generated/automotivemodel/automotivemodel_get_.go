...
// ToolAutomotivemodel_get_ returns the MCP tool definition for automotivemodel_get_
func ToolAutomotivemodel_get_() mcp.Tool {
	...
	return mcp.NewTool("automotivemodel_get_",
...
func HandleAutomotivemodel_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Automotivemodel_get_(accessToken, args)
	if err != nil {
...
func Automotivemodel_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
