...
// ToolAutomotivemodel_get_override_details returns the MCP tool definition for automotivemodel_get_override_details
func ToolAutomotivemodel_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("automotivemodel_get_override_details",
...
func HandleAutomotivemodel_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Automotivemodel_get_override_details(accessToken, args)
	if err != nil {
...
func Automotivemodel_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
