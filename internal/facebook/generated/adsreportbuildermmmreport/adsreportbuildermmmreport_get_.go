...
// ToolAdsreportbuildermmmreport_get_ returns the MCP tool definition for adsreportbuildermmmreport_get_
func ToolAdsreportbuildermmmreport_get_() mcp.Tool {
	...
	return mcp.NewTool("adsreportbuildermmmreport_get_",
...
func HandleAdsreportbuildermmmreport_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adsreportbuildermmmreport_get_(accessToken, args)
	if err != nil {
...
// Adsreportbuildermmmreport_get_ performs GET  for AdsReportBuilderMMMReport
func Adsreportbuildermmmreport_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
