...
func TestPhoto_get_sponsor_tags_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPhoto_get_sponsor_tags(accessToken, tt.args, skipParams...)
...
func buildURLParamsPhoto_get_sponsor_tags(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
