...
// ToolPhoto_get_sponsor_tags returns the MCP tool definition for photo_get_sponsor_tags
func ToolPhoto_get_sponsor_tags() mcp.Tool {
	...
	return mcp.NewTool("photo_get_sponsor_tags",
...
func HandlePhoto_get_sponsor_tags(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Photo_get_sponsor_tags(accessToken, args)
	if err != nil {
...
func Photo_get_sponsor_tags(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
