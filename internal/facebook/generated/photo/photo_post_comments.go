...
// ToolPhoto_post_comments returns the MCP tool definition for photo_post_comments
func ToolPhoto_post_comments() mcp.Tool {
	...
	return mcp.NewTool("photo_post_comments",
...
func HandlePhoto_post_comments(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Photo_post_comments(accessToken, args)
	if err != nil {
...
func Photo_post_comments(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
