...
// ToolPhoto_get_insights returns the MCP tool definition for photo_get_insights
func ToolPhoto_get_insights() mcp.Tool {
	...
	return mcp.NewTool("photo_get_insights",
...
func HandlePhoto_get_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Photo_get_insights(accessToken, args)
	if err != nil {
