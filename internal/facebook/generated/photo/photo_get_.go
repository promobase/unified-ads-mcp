...
// ToolPhoto_get_ returns the MCP tool definition for photo_get_
func ToolPhoto_get_() mcp.Tool {
...
func HandlePhoto_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Photo_get_(accessToken, args)
	if err != nil {
...
func Photo_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
