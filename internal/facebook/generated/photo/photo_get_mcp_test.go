...
func TestToolPhoto_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolPhoto_get()
	if tool.Name != "photo_get" {
		t.Errorf("expected tool name photo_get, got %s", tool.Name)
	}
}

func TestToolPhoto_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandlePhoto_get(ctx, request)
