...
// ToolCpasbusinesssetupconfig_get_ad_accounts returns the MCP tool definition for cpasbusinesssetupconfig_get_ad_accounts
func ToolCpasbusinesssetupconfig_get_ad_accounts() mcp.Tool {
	...
	return mcp.NewTool("cpasbusinesssetupconfig_get_ad_accounts",
...
func HandleCpasbusinesssetupconfig_get_ad_accounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Cpasbusinesssetupconfig_get_ad_accounts(accessToken, args)
	if err != nil {
...
// Cpasbusinesssetupconfig_get_ad_accounts performs GET ad_accounts for CPASBusinessSetupConfig
func Cpasbusinesssetupconfig_get_ad_accounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
