...
// ToolLifeevent_get_ returns the MCP tool definition for lifeevent_get_
func ToolLifeevent_get_() mcp.Tool {
	// Available fields for LifeEvent: description, end_time, from, id, is_hidden, start_time, title, updated_time
	
	return mcp.NewTool("lifeevent_get_",
...
func Lifeevent_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
