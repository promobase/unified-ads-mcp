...
// ToolBizinboxoffsiteemailaccount_get_ returns the MCP tool definition for bizinboxoffsiteemailaccount_get_
func ToolBizinboxoffsiteemailaccount_get_() mcp.Tool {
	// Available fields for BizInboxOffsiteEmailAccount: email_address, id

	return mcp.NewTool("bizinboxoffsiteemailaccount_get_",
...
func HandleBizinboxoffsiteemailaccount_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Bizinboxoffsiteemailaccount_get_(accessToken, args)
	if err != nil {
...
func Bizinboxoffsiteemailaccount_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
