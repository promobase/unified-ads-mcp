...
// ToolCtxpartnerappwelcomemessageflow_get_ returns the MCP tool definition for ctxpartnerappwelcomemessageflow_get_
func ToolCtxpartnerappwelcomemessageflow_get_() mcp.Tool {
	...
	return mcp.NewTool("ctxpartnerappwelcomemessageflow_get_",
...
func HandleCtxpartnerappwelcomemessageflow_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Ctxpartnerappwelcomemessageflow_get_(accessToken, args)
	if err != nil {
...
func Ctxpartnerappwelcomemessageflow_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
