...
func TestVideopoll_get_poll_options_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/poll_options",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsVideopoll_get_poll_options(accessToken, tt.args, skipParams...)
...
func buildURLParamsVideopoll_get_poll_options(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
