...
// ToolVideopoll_get_ returns the MCP tool definition for videopoll_get_
func ToolVideopoll_get_() mcp.Tool {
	// Available fields for VideoPoll: close_after_voting, default_open, id, question, show_gradient, show_results, status
	
	return mcp.NewTool("videopoll_get_",
...
func HandleVideopoll_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Videopoll_get_(accessToken, args)
	if err != nil {
...
func Videopoll_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
