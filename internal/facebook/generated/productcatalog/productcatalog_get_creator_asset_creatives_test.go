...
func TestProductcatalog_get_creator_asset_creatives_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/creator_asset_creatives",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductcatalog_get_creator_asset_creatives(accessToken, tt.args, skipParams...)
...
func buildURLParamsProductcatalog_get_creator_asset_creatives(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
