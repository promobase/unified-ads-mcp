...
// ToolProductcatalog_get_pricing_variables_batch returns the MCP tool definition for productcatalog_get_pricing_variables_batch
func ToolProductcatalog_get_pricing_variables_batch() mcp.Tool {
	...
	return mcp.NewTool("productcatalog_get_pricing_variables_batch",
...
func HandleProductcatalog_get_pricing_variables_batch(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productcatalog_get_pricing_variables_batch(accessToken, args)
	if err != nil {
