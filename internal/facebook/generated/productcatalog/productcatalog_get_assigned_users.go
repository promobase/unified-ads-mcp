...
// ToolProductcatalog_get_assigned_users returns the MCP tool definition for productcatalog_get_assigned_users
func ToolProductcatalog_get_assigned_users() mcp.Tool {
	// Available fields for AssignedUser: business, id, name, user_type
	// Params object accepts: business (string)
	return mcp.NewTool("productcatalog_get_assigned_users",
...
func HandleProductcatalog_get_assigned_users(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productcatalog_get_assigned_users(accessToken, args)
	if err != nil {
...
func Productcatalog_get_assigned_users(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
