...
func TestProductcatalog_post_marketplace_partner_sellers_details_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/marketplace_partner_sellers_details",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductcatalog_post_marketplace_partner_sellers_details(accessToken, tt.args, skipParams...)
...
func TestProductcatalog_post_marketplace_partner_sellers_details_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsProductcatalog_post_marketplace_partner_sellers_details(tt.args, skipParams...)
...
func buildBodyParamsProductcatalog_post_marketplace_partner_sellers_details(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsProductcatalog_post_marketplace_partner_sellers_details(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
