...
func TestProductcatalog_get_diagnostics_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/diagnostics",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductcatalog_get_diagnostics(accessToken, tt.args, skipParams...)
...
func buildURLParamsProductcatalog_get_diagnostics(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
