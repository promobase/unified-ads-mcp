...
func TestProductcatalog_get_categories_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductcatalog_get_categories(accessToken, tt.args, skipParams...)
...
func buildURLParamsProductcatalog_get_categories(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
