...
// ToolProductcatalog_post_version_items_batch returns the MCP tool definition for productcatalog_post_version_items_batch
func ToolProductcatalog_post_version_items_batch() mcp.Tool {
	
	// Params object accepts: allow_upsert (bool), item_type (string), item_version (string), requests (map), version (unsigned int)
	return mcp.NewTool("productcatalog_post_version_items_batch",
...
func HandleProductcatalog_post_version_items_batch(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productcatalog_post_version_items_batch(accessToken, args)
	if err != nil {
...
func Productcatalog_post_version_items_batch(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
