...
func TestProductcatalog_post_update_generated_image_config_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/update_generated_image_config",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductcatalog_post_update_generated_image_config(accessToken, tt.args, skipParams...)
...
func TestProductcatalog_post_update_generated_image_config_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsProductcatalog_post_update_generated_image_config(tt.args, skipParams...)
...
func buildBodyParamsProductcatalog_post_update_generated_image_config(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsProductcatalog_post_update_generated_image_config(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
