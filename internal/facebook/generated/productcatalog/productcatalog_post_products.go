...
// ToolProductcatalog_post_products returns the MCP tool definition for productcatalog_post_products
func ToolProductcatalog_post_products() mcp.Tool {
	...
	return mcp.NewTool("productcatalog_post_products",
...
func HandleProductcatalog_post_products(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Productcatalog_post_products(accessToken, args)
	if err != nil {
...
func Productcatalog_post_products(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
