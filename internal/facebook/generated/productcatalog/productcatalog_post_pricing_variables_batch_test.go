...
func TestProductcatalog_post_pricing_variables_batch_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/pricing_variables_batch",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsProductcatalog_post_pricing_variables_batch(accessToken, tt.args, skipParams...)
...
func TestProductcatalog_post_pricing_variables_batch_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsProductcatalog_post_pricing_variables_batch(tt.args, skipParams...)
...
func buildBodyParamsProductcatalog_post_pricing_variables_batch(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsProductcatalog_post_pricing_variables_batch(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
