...
// ToolFlight_get_override_details returns the MCP tool definition for flight_get_override_details
func ToolFlight_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("flight_get_override_details",
...
func HandleFlight_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Flight_get_override_details(accessToken, args)
	if err != nil {
...
// Flight_get_override_details performs GET override_details for Flight
func Flight_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
