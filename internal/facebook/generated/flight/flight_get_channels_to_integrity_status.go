...
// ToolFlight_get_channels_to_integrity_status returns the MCP tool definition for flight_get_channels_to_integrity_status
func ToolFlight_get_channels_to_integrity_status() mcp.Tool {
	// Available fields for CatalogItemChannelsToIntegrityStatus: channels, rejection_information

	return mcp.NewTool("flight_get_channels_to_integrity_status",
...
func HandleFlight_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Flight_get_channels_to_integrity_status(accessToken, args)
	if err != nil {
...
// Flight_get_channels_to_integrity_status performs GET channels_to_integrity_status for Flight
func Flight_get_channels_to_integrity_status(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
