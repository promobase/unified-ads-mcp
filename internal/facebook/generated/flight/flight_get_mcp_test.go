...
func TestToolFlight_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolFlight_get()
	if tool.Name != "flight_get" {
		t.Errorf("expected tool name flight_get, got %s", tool.Name)
	}
}

func TestToolFlight_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleFlight_get(ctx, request)
