...
// ToolFlight_get_videos_metadata returns the MCP tool definition for flight_get_videos_metadata
func ToolFlight_get_videos_metadata() mcp.Tool {
	// Available fields for DynamicVideoMetadata: id, tags, url, video

	return mcp.NewTool("flight_get_videos_metadata",
...
func HandleFlight_get_videos_metadata(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Flight_get_videos_metadata(accessToken, args)
	if err != nil {
...
// Flight_get_videos_metadata performs GET videos_metadata for Flight
func Flight_get_videos_metadata(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
