...
// ToolCollaborativeadssharesettings_get_ returns the MCP tool definition for collaborativeadssharesettings_get_
func ToolCollaborativeadssharesettings_get_() mcp.Tool {
	...
	return mcp.NewTool("collaborativeadssharesettings_get_",
...
func HandleCollaborativeadssharesettings_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Collaborativeadssharesettings_get_(accessToken, args)
	if err != nil {
...
func Collaborativeadssharesettings_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
