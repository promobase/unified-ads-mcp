...
// ToolAd_post_insights returns the MCP tool definition for ad_post_insights
func ToolAd_post_insights() mcp.Tool {
	...
	return mcp.NewTool("ad_post_insights",
...
func HandleAd_post_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Ad_post_insights(accessToken, args)
	if err != nil {
...
func Ad_post_insights(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/%sinsights", adId)
