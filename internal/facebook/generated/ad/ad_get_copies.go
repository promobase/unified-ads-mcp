...
// ToolAd_get_copies returns the MCP tool definition for ad_get_copies
func ToolAd_get_copies() mcp.Tool {
	...
	return mcp.NewTool("ad_get_copies",
...
func HandleAd_get_copies(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Ad_get_copies(accessToken, args)
	if err != nil {
...
func Ad_get_copies(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
