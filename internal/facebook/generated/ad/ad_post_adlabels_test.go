...
func TestAd_post_adlabels_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/adlabels", FacebookGraphAPIBaseURL, adId)
			...
			urlParams := buildURLParamsAd_post_adlabels(accessToken, tt.args, skipParams...)
...
func TestAd_post_adlabels_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAd_post_adlabels(tt.args, skipParams...)
...
func buildBodyParamsAd_post_adlabels(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAd_post_adlabels(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
