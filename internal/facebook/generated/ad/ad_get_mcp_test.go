...
func TestToolAd_get_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAd_get()
	if tool.Name != "ad_get" {
		t.Errorf("expected tool name ad_get, got %s", tool.Name)
	}
}

func TestToolAd_get_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAd_get(ctx, request)
