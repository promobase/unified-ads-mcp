...
func TestToolAd_get_leads_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAd_get_leads()
	if tool.Name != "ad_get_leads" {
		t.Errorf("expected tool name ad_get_leads, got %s", tool.Name)
	}
}

func TestToolAd_get_leads_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAd_get_leads(ctx, request)
