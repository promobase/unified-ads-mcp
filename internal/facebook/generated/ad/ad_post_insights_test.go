...
func TestAd_post_insights_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/insights", FacebookGraphAPIBaseURL, adId)
			...
			urlParams := buildURLParamsAd_post_insights(accessToken, tt.args, skipParams...)
...
func TestAd_post_insights_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAd_post_insights(tt.args, skipParams...)
...
func buildBodyParamsAd_post_insights(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAd_post_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
