...
func TestAd_post_copies_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/copies", FacebookGraphAPIBaseURL, adId)
			...
			urlParams := buildURLParamsAd_post_copies(accessToken, tt.args, skipParams...)
...
func TestAd_post_copies_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsAd_post_copies(tt.args, skipParams...)
...
func buildBodyParamsAd_post_copies(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsAd_post_copies(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
