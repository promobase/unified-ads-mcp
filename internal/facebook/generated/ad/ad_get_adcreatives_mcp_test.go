...
func TestToolAd_get_adcreatives_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAd_get_adcreatives()
	if tool.Name != "ad_get_adcreatives" {
		t.Errorf("expected tool name ad_get_adcreatives, got %s", tool.Name)
	}
}

func TestToolAd_get_adcreatives_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAd_get_adcreatives(ctx, request)
