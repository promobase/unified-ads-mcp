...
func TestToolAd_post_adlabels_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAd_post_adlabels()
	if tool.Name != "ad_post_adlabels" {
		t.Errorf("expected tool name ad_post_adlabels, got %s", tool.Name)
	}
}

func TestToolAd_post_adlabels_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAd_post_adlabels(ctx, request)
