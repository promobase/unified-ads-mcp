...
func TestAd_get_adcreatives_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			urlParams := buildURLParamsAd_get_adcreatives(accessToken, tt.args, skipParams...)
...
func buildURLParamsAd_get_adcreatives(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
