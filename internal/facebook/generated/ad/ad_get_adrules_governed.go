...
// ToolAd_get_adrules_governed returns the MCP tool definition for ad_get_adrules_governed
func ToolAd_get_adrules_governed() mcp.Tool {
	...
	return mcp.NewTool("ad_get_adrules_governed",
...
func HandleAd_get_adrules_governed(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Ad_get_adrules_governed(accessToken, args)
	if err != nil {
...
func Ad_get_adrules_governed(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
	...
	baseURL = fmt.Sprintf("https://graph.facebook.com/v23.0/%sadrules_governed", adId)
