...
// ToolAd_get_insights returns the MCP tool definition for ad_get_insights
func ToolAd_get_insights() mcp.Tool {
	...
	return mcp.NewTool("ad_get_insights",
...
func HandleAd_get_insights(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Ad_get_insights(accessToken, args)
	if err != nil {
...
func Ad_get_insights(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
