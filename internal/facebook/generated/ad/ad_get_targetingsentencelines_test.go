...
func TestAd_get_targetingsentencelines_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/targetingsentencelines", FacebookGraphAPIBaseURL, adId)
			...
			urlParams := buildURLParamsAd_get_targetingsentencelines(accessToken, tt.args, skipParams...)
...
func buildURLParamsAd_get_targetingsentencelines(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
