...
func TestAd_get_previews_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseURL = fmt.Sprintf("%s/%s/previews", FacebookGraphAPIBaseURL, adId)
			...
			urlParams := buildURLParamsAd_get_previews(accessToken, tt.args, skipParams...)
...
func buildURLParamsAd_get_previews(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
