...
func TestToolAd_delete_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAd_delete()
	if tool.Name != "ad_delete" {
		t.Errorf("expected tool name ad_delete, got %s", tool.Name)
	}
}

func TestToolAd_delete_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAd_delete(ctx, request)
