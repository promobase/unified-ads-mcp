...
func TestToolAd_post_Definition(t *testing.T) {
	// Test tool definition
	tool := ToolAd_post()
	if tool.Name != "ad_post" {
		t.Errorf("expected tool name ad_post, got %s", tool.Name)
	}
}

func TestToolAd_post_ValidationErrors(t *testing.T) {
	tests := []struct {
		name          string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Call handler
			result, err := HandleAd_post(ctx, request)
