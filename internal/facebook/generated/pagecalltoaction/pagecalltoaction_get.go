...
// ToolPagecalltoaction_get returns the MCP tool definition for pagecalltoaction_get
func ToolPagecalltoaction_get() mcp.Tool {
	...
	return mcp.NewTool("pagecalltoaction_get",
...
// HandlePagecalltoaction_get handles the pagecalltoaction_get tool with context-based auth
func HandlePagecalltoaction_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Pagecalltoaction_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute pagecalltoaction_get: %v", err)), nil
	}
...
// Pagecalltoaction_get performs GET  for PageCallToAction
func Pagecalltoaction_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
