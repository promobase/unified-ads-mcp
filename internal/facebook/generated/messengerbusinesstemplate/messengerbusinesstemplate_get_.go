...
// ToolMessengerbusinesstemplate_get_ returns the MCP tool definition for messengerbusinesstemplate_get_
func ToolMessengerbusinesstemplate_get_() mcp.Tool {
	...
	return mcp.NewTool("messengerbusinesstemplate_get_",
...
func HandleMessengerbusinesstemplate_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Messengerbusinesstemplate_get_(accessToken, args)
	if err != nil {
...
// Messengerbusinesstemplate_get_ performs GET  for MessengerBusinessTemplate
func Messengerbusinesstemplate_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
