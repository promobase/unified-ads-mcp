...
// ToolLocalservicebusiness_get_override_details returns the MCP tool definition for localservicebusiness_get_override_details
func ToolLocalservicebusiness_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("localservicebusiness_get_override_details",
