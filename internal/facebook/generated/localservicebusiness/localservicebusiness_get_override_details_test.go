...
func TestLocalservicebusiness_get_override_details_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/override_details",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsLocalservicebusiness_get_override_details(accessToken, tt.args, skipParams...)
...
func buildURLParamsLocalservicebusiness_get_override_details(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
