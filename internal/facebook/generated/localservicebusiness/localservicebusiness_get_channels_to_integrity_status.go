...
// ToolLocalservicebusiness_get_channels_to_integrity_status returns the MCP tool definition for localservicebusiness_get_channels_to_integrity_status
func ToolLocalservicebusiness_get_channels_to_integrity_status() mcp.Tool {
	// Available fields for CatalogItemChannelsToIntegrityStatus: channels, rejection_information

	return mcp.NewTool("localservicebusiness_get_channels_to_integrity_status",
...
func HandleLocalservicebusiness_get_channels_to_integrity_status(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Localservicebusiness_get_channels_to_integrity_status(accessToken, args)
	if err != nil {
...
func Localservicebusiness_get_channels_to_integrity_status(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
