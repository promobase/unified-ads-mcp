...
// ToolIgboostmediaad_get_ returns the MCP tool definition for igboostmediaad_get_
func ToolIgboostmediaad_get_() mcp.Tool {
	// Available fields for IGBoostMediaAd: ad_id, ad_status

	return mcp.NewTool("igboostmediaad_get_",
...
func HandleIgboostmediaad_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igboostmediaad_get_(accessToken, args)
	if err != nil {
...
// Igboostmediaad_get_ performs GET  for IGBoostMediaAd
func Igboostmediaad_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
