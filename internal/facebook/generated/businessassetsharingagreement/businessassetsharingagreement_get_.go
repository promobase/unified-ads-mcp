...
// ToolBusinessassetsharingagreement_get_ returns the MCP tool definition for businessassetsharingagreement_get_
func ToolBusinessassetsharingagreement_get_() mcp.Tool {
	// Available fields for BusinessAssetSharingAgreement: id, initiator, recipient, relationship_type, request_status, request_type

	return mcp.NewTool("businessassetsharingagreement_get_",
...
func HandleBusinessassetsharingagreement_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetsharingagreement_get_(accessToken, args)
	if err != nil {
...
func Businessassetsharingagreement_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
