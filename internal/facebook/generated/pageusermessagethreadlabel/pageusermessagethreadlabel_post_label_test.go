...
func TestPageusermessagethreadlabel_post_label_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/label",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsPageusermessagethreadlabel_post_label(accessToken, tt.args, skipParams...)
...
func TestPageusermessagethreadlabel_post_label_BodyConstruction(t *testing.T) {
	tests := []struct {
		name     string
		args     map[string]interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bodyParams := buildBodyParamsPageusermessagethreadlabel_post_label(tt.args, skipParams...)
...
func buildBodyParamsPageusermessagethreadlabel_post_label(args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
...
func buildURLParamsPageusermessagethreadlabel_post_label(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
