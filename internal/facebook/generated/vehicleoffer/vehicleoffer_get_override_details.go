...
// ToolVehicleoffer_get_override_details returns the MCP tool definition for vehicleoffer_get_override_details
func ToolVehicleoffer_get_override_details() mcp.Tool {
	...
	return mcp.NewTool("vehicleoffer_get_override_details",
...
func HandleVehicleoffer_get_override_details(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Vehicleoffer_get_override_details(accessToken, args)
	if err != nil {
...
func Vehicleoffer_get_override_details(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
