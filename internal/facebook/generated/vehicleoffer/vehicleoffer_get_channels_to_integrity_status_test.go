...
func TestVehicleoffer_get_channels_to_integrity_status_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsVehicleoffer_get_channels_to_integrity_status(accessToken, tt.args, skipParams...)
...
func buildURLParamsVehicleoffer_get_channels_to_integrity_status(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
