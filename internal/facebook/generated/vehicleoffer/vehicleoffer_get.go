...
// ToolVehicleoffer_get returns the MCP tool definition for vehicleoffer_get
func ToolVehicleoffer_get() mcp.Tool {
	...
	return mcp.NewTool("vehicleoffer_get",
...
// HandleVehicleoffer_get handles the vehicleoffer_get tool with context-based auth
func HandleVehicleoffer_get(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Vehicleoffer_get(accessToken, args)
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("failed to execute vehicleoffer_get: %v", err)), nil
	}
...
// Vehicleoffer_get performs GET  for VehicleOffer
func Vehicleoffer_get(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
