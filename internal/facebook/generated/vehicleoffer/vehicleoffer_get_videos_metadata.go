...
// ToolVehicleoffer_get_videos_metadata returns the MCP tool definition for vehicleoffer_get_videos_metadata
func ToolVehicleoffer_get_videos_metadata() mcp.Tool {
	// Available fields for DynamicVideoMetadata: id, tags, url, video

	return mcp.NewTool("vehicleoffer_get_videos_metadata",
...
func HandleVehicleoffer_get_videos_metadata(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Vehicleoffer_get_videos_metadata(accessToken, args)
	if err != nil {
