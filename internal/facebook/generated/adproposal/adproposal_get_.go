...
// ToolAdproposal_get_ returns the MCP tool definition for adproposal_get_
func ToolAdproposal_get_() mcp.Tool {
	...
	return mcp.NewTool("adproposal_get_",
...
func HandleAdproposal_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adproposal_get_(accessToken, args)
	if err != nil {
...
// Adproposal_get_ performs GET  for AdProposal
func Adproposal_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
