...
// ToolAdsusersettings_get_ returns the MCP tool definition for adsusersettings_get_
func ToolAdsusersettings_get_() mcp.Tool {
	...
	return mcp.NewTool("adsusersettings_get_",
...
func HandleAdsusersettings_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Adsusersettings_get_(accessToken, args)
	if err != nil {
...
func Adsusersettings_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
