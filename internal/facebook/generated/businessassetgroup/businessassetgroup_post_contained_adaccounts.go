...
// ToolBusinessassetgroup_post_contained_adaccounts returns the MCP tool definition for businessassetgroup_post_contained_adaccounts
func ToolBusinessassetgroup_post_contained_adaccounts() mcp.Tool {

	// Params object accepts: asset_id (string)
	return mcp.NewTool("businessassetgroup_post_contained_adaccounts",
...
func HandleBusinessassetgroup_post_contained_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_post_contained_adaccounts(accessToken, args)
	if err != nil {
...
func Businessassetgroup_post_contained_adaccounts(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
