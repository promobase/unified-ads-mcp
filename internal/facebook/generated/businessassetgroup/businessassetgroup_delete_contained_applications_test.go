...
func TestBusinessassetgroup_delete_contained_applications_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusinessassetgroup_delete_contained_applications(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusinessassetgroup_delete_contained_applications(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
