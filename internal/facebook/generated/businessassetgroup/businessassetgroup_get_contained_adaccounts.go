...
// ToolBusinessassetgroup_get_contained_adaccounts returns the MCP tool definition for businessassetgroup_get_contained_adaccounts
func ToolBusinessassetgroup_get_contained_adaccounts() mcp.Tool {
	...
	return mcp.NewTool("businessassetgroup_get_contained_adaccounts",
...
func HandleBusinessassetgroup_get_contained_adaccounts(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_get_contained_adaccounts(accessToken, args)
	if err != nil {
