...
// ToolBusinessassetgroup_post_contained_pages returns the MCP tool definition for businessassetgroup_post_contained_pages
func ToolBusinessassetgroup_post_contained_pages() mcp.Tool {

	// Params object accepts: asset_id (string)
	return mcp.NewTool("businessassetgroup_post_contained_pages",
...
func HandleBusinessassetgroup_post_contained_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_post_contained_pages(accessToken, args)
	if err != nil {
