...
// ToolBusinessassetgroup_get_contained_product_catalogs returns the MCP tool definition for businessassetgroup_get_contained_product_catalogs
func ToolBusinessassetgroup_get_contained_product_catalogs() mcp.Tool {
	...
	return mcp.NewTool("businessassetgroup_get_contained_product_catalogs",
...
func HandleBusinessassetgroup_get_contained_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_get_contained_product_catalogs(accessToken, args)
	if err != nil {
...
func Businessassetgroup_get_contained_product_catalogs(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
