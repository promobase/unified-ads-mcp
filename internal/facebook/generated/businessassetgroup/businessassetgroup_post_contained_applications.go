...
// ToolBusinessassetgroup_post_contained_applications returns the MCP tool definition for businessassetgroup_post_contained_applications
func ToolBusinessassetgroup_post_contained_applications() mcp.Tool {

	// Params object accepts: asset_id (string)
	return mcp.NewTool("businessassetgroup_post_contained_applications",
...
func HandleBusinessassetgroup_post_contained_applications(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_post_contained_applications(accessToken, args)
	if err != nil {
