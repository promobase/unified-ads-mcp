...
// ToolBusinessassetgroup_delete_contained_product_catalogs returns the MCP tool definition for businessassetgroup_delete_contained_product_catalogs
func ToolBusinessassetgroup_delete_contained_product_catalogs() mcp.Tool {

	// Params object accepts: asset_id (string)
	return mcp.NewTool("businessassetgroup_delete_contained_product_catalogs",
...
func HandleBusinessassetgroup_delete_contained_product_catalogs(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_delete_contained_product_catalogs(accessToken, args)
	if err != nil {
...
func Businessassetgroup_delete_contained_product_catalogs(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
