...
func TestBusinessassetgroup_get_contained_adaccounts_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusinessassetgroup_get_contained_adaccounts(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusinessassetgroup_get_contained_adaccounts(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
