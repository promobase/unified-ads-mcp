...
// ToolBusinessassetgroup_delete_assigned_users returns the MCP tool definition for businessassetgroup_delete_assigned_users
func ToolBusinessassetgroup_delete_assigned_users() mcp.Tool {

	// Params object accepts: user (int)
	return mcp.NewTool("businessassetgroup_delete_assigned_users",
...
func HandleBusinessassetgroup_delete_assigned_users(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_delete_assigned_users(accessToken, args)
	if err != nil {
...
func Businessassetgroup_delete_assigned_users(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
