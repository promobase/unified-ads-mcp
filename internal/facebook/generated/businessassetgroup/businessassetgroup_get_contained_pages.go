...
// ToolBusinessassetgroup_get_contained_pages returns the MCP tool definition for businessassetgroup_get_contained_pages
func ToolBusinessassetgroup_get_contained_pages() mcp.Tool {
	...
	return mcp.NewTool("businessassetgroup_get_contained_pages",
...
func HandleBusinessassetgroup_get_contained_pages(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_get_contained_pages(accessToken, args)
	if err != nil {
...
func Businessassetgroup_get_contained_pages(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
