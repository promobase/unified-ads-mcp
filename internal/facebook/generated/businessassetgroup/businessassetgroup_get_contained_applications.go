...
// ToolBusinessassetgroup_get_contained_applications returns the MCP tool definition for businessassetgroup_get_contained_applications
func ToolBusinessassetgroup_get_contained_applications() mcp.Tool {
	...
	return mcp.NewTool("businessassetgroup_get_contained_applications",
...
func HandleBusinessassetgroup_get_contained_applications(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_get_contained_applications(accessToken, args)
	if err != nil {
...
func Businessassetgroup_get_contained_applications(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
