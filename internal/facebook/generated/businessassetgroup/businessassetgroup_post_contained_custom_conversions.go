...
// ToolBusinessassetgroup_post_contained_custom_conversions returns the MCP tool definition for businessassetgroup_post_contained_custom_conversions
func ToolBusinessassetgroup_post_contained_custom_conversions() mcp.Tool {
	
	// Params object accepts: asset_id (string)
	return mcp.NewTool("businessassetgroup_post_contained_custom_conversions",
...
func HandleBusinessassetgroup_post_contained_custom_conversions(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Businessassetgroup_post_contained_custom_conversions(accessToken, args)
	if err != nil {
