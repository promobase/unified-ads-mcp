...
func TestBusinessassetgroup_delete_assigned_users_URLConstruction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsBusinessassetgroup_delete_assigned_users(accessToken, tt.args, skipParams...)
...
func buildURLParamsBusinessassetgroup_delete_assigned_users(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
