...
func TestIgmediaforigonlyapi_get_insights_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/insights",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmediaforigonlyapi_get_insights(accessToken, tt.args, skipParams...)
...
func buildURLParamsIgmediaforigonlyapi_get_insights(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
