...
// ToolIgmediaforigonlyapi_get_ returns the MCP tool definition for igmediaforigonlyapi_get_
func ToolIgmediaforigonlyapi_get_() mcp.Tool {

	return mcp.NewTool("igmediaforigonlyapi_get_",
...
func HandleIgmediaforigonlyapi_get_(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Call the API method
	result, err := Igmediaforigonlyapi_get_(accessToken, args)
	if err != nil {
...
func Igmediaforigonlyapi_get_(accessToken string, args map[string]interface{}) (interface{}, error) {
	var baseURL string
