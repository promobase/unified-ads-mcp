...
func TestIgmediaforigonlyapi_get_children_URLConstruction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:        map[string]interface{}{},
			wantBaseURL: "https://graph.facebook.com/v23.0/children",
			wantParams: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			skipParams := []string{}
			urlParams := buildURLParamsIgmediaforigonlyapi_get_children(accessToken, tt.args, skipParams...)
...
func buildURLParamsIgmediaforigonlyapi_get_children(accessToken string, args map[string]interface{}, skipParams ...string) url.Values {
	params := url.Values{}
